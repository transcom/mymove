...
Once that's done, you have go installed, and you've re-sourced your profile, you can checkout this repository by running `go get github.com/transcom/mymove` (This will emit an eror but will have cloned the source correctly) You will then find the code at `$GOPATH/src/github.com/transcom/mymove`
