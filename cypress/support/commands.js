...
Cypress.Commands.add('signInAsNewPrimeSimulatorUser', () => {
  cy.signInAsNewUser(PrimeSimulatorUserType);
});
...
Cypress.Commands.add('selectDutyLocation', (stationName, fieldName) => {
