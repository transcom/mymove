...
describe('Weight Tickets', function () {
  ...
  // TODO: update mobile user to a unique user
  const viewportType2 = [
  ...
  // TODO: update mobile user to a unique user
  const viewportType4 = [
    { viewport: 'desktop', isMobile: false, userId: '2a0146c4-ec9a-4efc-a94c-6c2849c3e167' }, // actualPPMDateZIPAdvanceDone3@ppm.approved
    { viewport: 'mobile', isMobile: true, userId: '88007896-6ae7-4600-866a-873d3bc67fd3' }, // actualPPMDateZIPAdvanceDone@ppm.approved
  ];
