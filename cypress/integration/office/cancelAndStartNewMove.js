...
//   cy.get('button').contains('Cancel Move').click();

//   // Enter cancel reason
//   cy.get('.cancel-panel textarea:first').type('Canceling this move as a test!');
//   cy.get('.cancel-panel button').contains('Cancel Move').click();
//   cy.get('.cancel-panel button').contains('Yes, Cancel Move').click();
