...
class Demo(object):
    ...
    def __init__(self, url, user_type="milmove", session_token_name="mil_session_token"):
...
if __name__ == "__main__":
    ...
    milmove_demo = Demo('http://milmovelocal:8080', user_type="milmove", session_token_name="mil_session_token")
    office_demo = Demo('http://officelocal:8080', user_type="office", session_token_name="office_session_token")
    tsp_demo = Demo('http://tsplocal:8080', user_type="tsp", session_token_name="tsp_session_token")
