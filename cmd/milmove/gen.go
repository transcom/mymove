...
func writeEmptyFile(migrationPath, filename string) error {
	...
	//RA: In this situation, we want to protect from any changes to migration files once they have been deployed, and changes to the db should happen only in a new migration file.
