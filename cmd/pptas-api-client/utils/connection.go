...
// #nosec G402
func CreatePrimeClientWithCACStoreParam(v *viper.Viper, store *pksigner.Store) (*pptasClient.Mymove, *pksigner.Store, error) {
...
func CreateSupportClient(v *viper.Viper) (*pptasClient.Mymove, *pksigner.Store, error) {
	...
	supportGateway := pptasClient.New(myRuntime, nil)
