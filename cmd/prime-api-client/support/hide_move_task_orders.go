...
// InitHideMoveTaskOrderFlags declares which flags are enabled
func InitHideMoveTaskOrderFlags(flag *pflag.FlagSet) {
...
// HideMoveTaskOrder creates a gateway and sends the request to the endpoint
func HideMoveTaskOrder(cmd *cobra.Command, args []string) error {
	v := viper.New()
	...
	var params mto.HideMoveTaskOrderParams
	params.SetTimeout(time.Second * 30)

	resp, err := supportGateway.MoveTaskOrder.HideMoveTaskOrder(&params)
	if err != nil {
