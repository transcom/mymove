...
('8c0c57e2-0acc-4319-9757-59608936a154','NumberDaysSIT', 'Number of days in SIT', 'INTEGER', 'PRIME', now(), now()),
...
('07e3ff12-0717-4661-a4e1-dca325da0fcc','PriceAreaDest', 'Dest orice area', 'STRING', 'SYSTEM', now(), now()),
...
('0f564bdd-153c-44af-97ae-117b62339c02','RateAreaNonStdOrigin', 'Origin non std rate area', 'STRING', 'PRIME', now(), now()),
('73060cd4-15fd-4d6d-9d38-9f362c7da7af','RateAreaNonStdDest', 'Destination non std rate area', 'STRING', 'PRIME', now(), now()),
...
('c2813d4f-918a-450a-9b76-a1aa0a58b987','PSI_ShippingLinehaulIntlOCPrice', 'Intl OC shipping & linehaul price', 'DECIMAL', 'SYSTEM', now(), now()),
('afb75a59-8c88-4355-b55e-cc9eda672a55','PSI_ShippingLinehaulIntlOO', 'Intl OO shipping & linehaul', 'PaymentServiceItemUUID', 'SYSTEM', now(), now()),
('421a4330-accc-44f4-9418-86fd5fc6195a','PSI_ShippingLinehaulIntlOOPrice', 'Intl OO shipping & linehaul price', 'DECIMAL', 'SYSTEM', now(), now()),
