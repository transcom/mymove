...
UPDATE addresses SET street_address_2 = TRIM(street_address_2), updated_at = now() WHERE street_address_2 <> TRIM(street_address_2);
UPDATE addresses SET street_address_3 = TRIM(street_address_3), updated_at = now() WHERE street_address_3 <> TRIM(street_address_3);
