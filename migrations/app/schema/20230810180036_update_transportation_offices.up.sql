...
-- Insert the address
INSERT INTO addresses (id, street_address_1, street_address_2, city, state, postal_code, created_at, updated_at) VALUES ('75002be0-7a6a-4bb1-91f5-fff2cd489424', '1001 S. Seaside Ave', 'Bldg 25', 'San Pedro', 'CA', '90731', now(), now());

-- Insert the TO
INSERT INTO transportation_offices (id, address_id, gbloc, name, created_at, updated_at, latitude, longitude) VALUES ('2990da98-2c26-4fe4-88a0-76a01cbf8f75', '75002be0-7a6a-4bb1-91f5-fff2cd489424', 'KKFA', 'PPPO Base San Pedro - USCG', now(), now(), 0, 0);
...
-- Insert the address
INSERT INTO addresses (id, street_address_1, street_address_2, city, state, postal_code, created_at, updated_at) VALUES ('946c7e83-4406-40f4-97f1-928dc9469dfa', 'Vandergrift Blvd', 'Bldg 2263', 'Camp Pendleton', 'CA', '92055', now(), now());

-- Insert the TO
INSERT INTO transportation_offices (id, address_id, gbloc, name, created_at, updated_at, latitude, longitude) VALUES ('9d11c61d-55d3-480c-be20-414757f4651b', '946c7e83-4406-40f4-97f1-928dc9469dfa', 'USMC', 'PPPO DMO Camp Pendleton - USMC', now(), now(), 0, 0);
...
-- Insert the address
INSERT INTO addresses (id, street_address_1, street_address_2, city, state, postal_code, created_at, updated_at) VALUES ('2821ab7f-fc6b-4970-9b2c-9513f9a5ed07', '110 Vernon Ave', 'Bldg 386', 'Panama City', 'FL', '32407', now(), now());

-- Insert the TO
INSERT INTO transportation_offices (id, address_id, gbloc, name, created_at, updated_at, latitude, longitude) VALUES ('d70c5f4c-31c0-4e47-a53a-4cb3d5374b80', '2821ab7f-fc6b-4970-9b2c-9513f9a5ed07', 'HAFC', 'PPPO NSWC Panama City Division - USN', now(), now(), 0, 0);
