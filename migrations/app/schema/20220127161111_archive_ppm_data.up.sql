CREATE TABLE archived_personally_procured_moves (
    ...
    move_document_id uuid,
    move_document_move_id uuid,
    document_id uuid,
    ...
    title varchar(255),
    move_document_ppm_id uuid,
    signed_certificate_id uuid,
    submitting_user_id uuid,
    signed_certificate_move_id uuid,
    ...
    weight_ticket_set_document_id uuid,
    weight_ticket_set_type text,
    vehicle_nickname text,
    weight_ticket_set_document_move_document_id uuid,
    empty_weight INT,
    ...
    vehicle_make text,
    vehicle_model text,
    moving_expenses_document_id uuid,
