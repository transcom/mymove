...
VALUES
('739bbc23-cd08-4612-8e5d-da992202344e', 'Escalation', 'Escalation factor applied to final price', 'DECIMAL', 'PRICER', now(), now()),
...
('052c893f-e2a8-4efb-a92a-5cb216e7cca0', (SELECT id FROM re_services WHERE code='DBHF'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('0ade5dab-3950-42bf-8636-8201852704fa', (SELECT id FROM re_services WHERE code='DBTF'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('0a3ed39a-f0da-4b0e-94e6-f9900a0e376e', (SELECT id FROM re_services WHERE code='DCRT'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('f7dd592a-71b6-4838-b46a-2fd40ca8be71', (SELECT id FROM re_services WHERE code='DCRTSA'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('8afb1d00-0294-4dd4-8cf8-c3ff62107bad', (SELECT id FROM re_services WHERE code='DDASIT'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('07b3505b-2cd8-4ed0-981f-2a35924e1808', (SELECT id FROM re_services WHERE code='DDDSIT'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('24458e9c-1a45-4337-84e6-ab6584fbad1c', (SELECT id FROM re_services WHERE code='DDFSIT'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('d65a9e6e-d435-4929-abdc-7019e0a49ecc', (SELECT id FROM re_services WHERE code='DDP'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('478a5ed1-a46a-482c-a30b-742120f8f606', (SELECT id FROM re_services WHERE code='DDSHUT'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('849837bf-def6-44cb-8b27-f2ea601d3252', (SELECT id FROM re_services WHERE code='DLH'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('d8eb08fb-035d-4cb9-8f02-7acaa7958b29', (SELECT id FROM re_services WHERE code='DMHF'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('bf391a81-4220-4901-b36e-0a99e3cd71c3', (SELECT id FROM re_services WHERE code='DNPKF'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('5716c622-3eb2-4b5e-a7a8-010820a805bd', (SELECT id FROM re_services WHERE code='DOASIT'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('39de5ece-796e-4e15-aa10-b305dd096488', (SELECT id FROM re_services WHERE code='DOFSIT'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('579b4bbf-cfe6-46ed-b12c-5a67362cc196', (SELECT id FROM re_services WHERE code='DOP'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('442b77eb-141a-4bef-a505-a547526e5e1f', (SELECT id FROM re_services WHERE code='DOPSIT'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('0b5b044f-7d8b-480f-a1e4-dea1f0cdcd1d', (SELECT id FROM re_services WHERE code='DPK'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('55aa95a3-a236-445f-aebf-536a35056160', (SELECT id FROM re_services WHERE code='DSH'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('1cf0822b-c38a-4c62-91b1-aabaed015ca9', (SELECT id FROM re_services WHERE code='DUCRT'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
...
('56025cdd-83f0-4157-b553-5ef05a7f05af', (SELECT id FROM re_services WHERE code='DUPK'), (SELECT id FROM service_item_param_keys WHERE key='Escalation'), now(), now()),
