...
('6ba0aeca-19f8-4247-a317-fffa81c5d5c1', 'FSCPriceDifferenceInCents', 'Difference in price between the weekly national average EIA fuel price and the base GHC diesel fuel price of $2.50', 'INTEGER', 'PRICER', now(), now());
