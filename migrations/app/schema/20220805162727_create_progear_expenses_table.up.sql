...
COMMENT on COLUMN progear_weight_tickets.is_own IS 'Indicates if this information is for the customer''s own progear, otherwise, it''s the spouse''s.';
COMMENT on COLUMN progear_weight_tickets.description IS 'Stores a description of the pro-gear move.';
COMMENT on COLUMN progear_weight_tickets.has_weight_ticket IS 'Indicates if the user has a weight ticket for their pro-gear, otherwise they have a constructed weight.';
