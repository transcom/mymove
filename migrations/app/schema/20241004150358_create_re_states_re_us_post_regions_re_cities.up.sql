...
ALTER TABLE us_post_region_cities ADD CONSTRAINT fk_us_post_region_cities_upr_id REFERENCES re_us_post_regions (id);
...
ALTER TABLE us_post_region_cities ADD CONSTRAINT fk_us_post_region_cities_cities_id REFERENCES re_cities (id);
