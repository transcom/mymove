CREATE TABLE archived_personally_procured_move_data (
    ...
    moving_expense_document_move_docuement_id REFERENCES documents,
...
moving_expense_document_id, moving_expense_document_move_docuement_id, moving_expense_type,
...
moving_expense_documents.id AS moving_expense_document_id, moving_expense_documents.move_docuement_id AS moving_expense_document_move_docuement_id, moving_expense_documents.moving_expense_type,
