...
UPDATE office_users
SET user_id = associate_user.id
FROM associate_user
WHERE office_users.email = associate_user.login_gov_email;
...
SET user_id = associate_user.id
FROM associate_user
WHERE admin_users.email = associate_user.login_gov_email;