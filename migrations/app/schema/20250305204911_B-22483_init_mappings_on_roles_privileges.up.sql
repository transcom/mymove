...
INSERT INTO roles_privileges (id, role_id, privilege_id, created_at, updated_at) VALUES
    ('c261ca4c-185b-4a69-adfb-a8cce625d93e'::uuid,'92f779a7-8e77-42b0-8002-514304d63b9c'::uuid,'463c2034-d197-4d9a-897e-8bbe64893a31'::uuid, now(), now()); -- Customer
    -- ('e20c1e39-fea8-43ef-a56c-7e276bb33c87'::uuid,'1538be88-1351-4968-9ec1-7b4dc79c0d96'::uuid,'463c2034-d197-4d9a-897e-8bbe64893a31'::uuid, now(), now()), -- Task Ordering Officer
    -- ('2d32e971-1350-46e9-931c-1a53b2e3af3b'::uuid,'2032e756-7860-40d2-a8df-c0937136ae55'::uuid,'463c2034-d197-4d9a-897e-8bbe64893a31'::uuid, now(), now()), -- Task Invoicing Officer
    -- ('66eaee36-311c-4184-aeb9-178b1d407c0a'::uuid,'64af860c-261c-458b-b79f-5e7d37328e4e'::uuid,'463c2034-d197-4d9a-897e-8bbe64893a31'::uuid, now(), now()), -- Contracting Officer
