-- B-22968 Maria Traskowsky added fetch_moves_for_bulk_assignment, refactoring FetchMovesForBulkAssignmentTaskOrder() into db func
DROP FUNCTION IF EXISTS public.fetch_moves_for_bulk_assignment(
    v_gbloc
);
CREATE OR REPLACE FUNCTION public.fetch_moves_for_bulk_assignment(
    v_gbloc TEXT
)
RETURNS TABLE (
    id UUID,
