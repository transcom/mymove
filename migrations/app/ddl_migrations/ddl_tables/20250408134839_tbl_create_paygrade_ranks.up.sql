...
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	...
	('d84742d4-cbbc-48ce-af03-3eada00aa145','1d6e34c3-8c6c-4d4f-8b91-f46bed3f5e80'::uuid,'AIR_FORCE','LTG','Lieutenant General',2,now(),now()),
	('5db514e4-5808-4211-aea7-866ac6a74dc4','6e50b04a-52dc-45c9-91d9-4a7b4fa1ab20'::uuid,'AIR_FORCE','MG','Major General',3,now(),now()),
	('daae28b0-9b9d-45bf-9ba9-b33e079f6105','cf664124-9baf-4187-8f28-0908c0f0a5e0'::uuid,'AIR_FORCE','BG','Brigadier General',4,now(),now()),
	('f6157a08-c804-4d61-867d-806b4680a4de','455a112d-d1e0-4559-81e8-6df664638f70'::uuid,'AIR_FORCE','COL','Colonel',5,now(),now()),
	('78eb194c-e7c3-4a47-a6c6-913de1a689f8','3bc4b197-7897-4105-80a1-39a0378d7730'::uuid,'AIR_FORCE','LTC','Lieutenant Colonel',6,now(),now()),
	...
	('c98ba41b-3fcd-474f-98ac-51764cc1f0e5','d1b76a01-d8e4-4bd3-98ff-fa93ff7bc790'::uuid,'AIR_FORCE','1LT','First Lieutenant',9,now(),now()),
	('43b69e7b-99a3-488f-8cea-3abe63d6f20a','9a892c59-48d5-4eba-b5f9-193716da8827'::uuid,'AIR_FORCE','AVC','Aviation Cadet',10,now(),now())
		on conflict (id) do nothing;

INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	('914db640-0de5-494d-b917-b4a44e022f4b','9a892c59-48d5-4eba-b5f9-193716da8827'::uuid,'AIR_FORCE','2LT','Second Lieutenant',10,now(),now()),
	...
	('85578266-a86c-42ce-b740-e62614361114','a5fc8fd2-6f91-492b-abe2-2157d03ec990'::uuid,'AIR_FORCE','CMS','Chief Master Sergeant',11,now(),now()),
	('dda2b553-99be-439b-b088-b7608b48eff0','1d909db0-602f-4724-bd43-8f90a6660460'::uuid,'AIR_FORCE','SMS','Senior Master Sergeant',12,now(),now()),
	('43dd0d76-1f2f-45fb-a73e-404fe2ab93f0','523d57a1-529c-4dfd-8c33-9cb169fd29a0'::uuid,'AIR_FORCE','MSG','Master Sergeant',13,now(),now()),
	('0472a25d-b1a0-451c-9895-110dfe44496a','541aec36-bd9f-4ad2-abb4-d9b63e29dc80'::uuid,'AIR_FORCE','TSG','Technical Sergeant',14,now(),now()),
	('ae9f9d91-b049-4f60-bdc9-e441a7b3cb30','3f142461-dca5-4a77-9295-92ee93371330'::uuid,'AIR_FORCE','SSG','Staff Sergeant',15,now(),now()),
	('753f82f9-27e1-4ee7-9b57-bfef3c83656b','bb55f37c-3165-46ba-ad3f-9a477f699990'::uuid,'AIR_FORCE','SRA','Senior Airman',17,now(),now()),
	('3aca9ba8-3b84-42bf-8f2f-5ef02587ba89','862eb395-86d1-44af-ad47-dec44fbeda30'::uuid,'AIR_FORCE','A1C','Airman First Class',20,now(),now())
	 	on conflict (id) do nothing;
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	('cb0ee2b8-e852-40fe-b972-2730b53860c7','5f871c82-f259-43cc-9245-a6e18975dde0'::uuid,'AIR_FORCE','AMN','Airman',21,now(),now()),
	('f6dbd496-8f71-487b-a432-55b60967f474','6cb785d0-cabf-479a-a36d-a6aec294a4d0'::uuid,'AIR_FORCE','AB','Airman Basic',22,now(),now()),
...
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	...
	('87d7a277-ba7c-48a0-99ec-6da4bd321f3a','1d6e34c3-8c6c-4d4f-8b91-f46bed3f5e80'::uuid,'COAST_GUARD','VAD','Vice Admiral',2,now(),now()),
	('ff535837-7522-4096-b089-e58708401002','6e50b04a-52dc-45c9-91d9-4a7b4fa1ab20'::uuid,'COAST_GUARD','RADU','Rear Admiral (Upper Half)',3,now(),now()),
	('dfbbadcb-4075-4b4a-b62d-c2b6bbf91a7a','cf664124-9baf-4187-8f28-0908c0f0a5e0'::uuid,'COAST_GUARD','RADL','Rear Admiral (Lower Half)',4,now(),now()),
	...
	('786807ed-e002-4c04-8c0b-8332cfbab600','3bc4b197-7897-4105-80a1-39a0378d7730'::uuid,'COAST_GUARD','CDR','Commander',6,now(),now())
		on conflict (id) do nothing;
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	('685cfe77-a633-4a9a-8a17-adb9fa71e5f0','e83d8f8d-f70b-4db1-99cc-dd983d2fd250'::uuid,'COAST_GUARD','LCD','Lieutenant Commander',7,now(),now()),
...
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	...
	('e15498d9-0015-457b-8a10-fd42e6ed02b1','1d6e34c3-8c6c-4d4f-8b91-f46bed3f5e80'::uuid,'MARINES','LTG','Lieutenant General',2,now(),now())
		on conflict (id) do nothing;
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	('602a512b-fee8-41c6-a65f-042318a3924b','6e50b04a-52dc-45c9-91d9-4a7b4fa1ab20'::uuid,'MARINES','MG','Major General',3,now(),now()),
	('ac532793-77d8-40c0-b25e-a98249520bc7','cf664124-9baf-4187-8f28-0908c0f0a5e0'::uuid,'MARINES','BG','Brigadier General',4,now(),now()),
	('0fe1d0c4-a734-472d-8b16-7dfbe881aa5a','455a112d-d1e0-4559-81e8-6df664638f70'::uuid,'MARINES','COL','Colonel',5,now(),now()),
	('63080039-cf5c-4faf-9354-e0eff69b2133','3bc4b197-7897-4105-80a1-39a0378d7730'::uuid,'MARINES','LTC','Lieutenant Colonel',6,now(),now()),
	...
	('5a21a044-207c-4c4d-bfe2-7a73c717fed6','d1b76a01-d8e4-4bd3-98ff-fa93ff7bc790'::uuid,'MARINES','1LT','First Lieutenant',9,now(),now()),
	('d01f62c6-14d6-4f5d-8b42-f2319df6730d','9a892c59-48d5-4eba-b5f9-193716da8827'::uuid,'MARINES','2LT','Second Lieutenant',10,now(),now()),
	('deedacab-55f6-4a0a-8042-9a6b45d4f819','ea8cb0e9-15ff-43b4-9e41-7168d01e7553'::uuid,'MARINES','CW5','Chief Warrant Officer 5',11,now(),now()),
	('fd522412-7b6d-410b-9629-1acba8b63108','74db5649-cf66-4af8-939b-d3d7f1f6b7c6'::uuid,'MARINES','CW4','Chief Warrant Officer 4',12,now(),now())
	 	on conflict (id) do nothing;
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	('3821df00-1b7a-449d-b529-ac789e72f52c','5a65fb1f-4245-4178-b6a7-cc504c9cbb37'::uuid,'MARINES','CW3','Chief Warrant Officer 3',13,now(),now()),
	('62197a37-3b56-430d-a084-0b73170b3003','a687a2e1-488c-4943-b9d9-3d645a2712f4'::uuid,'MARINES','CW2','Chief Warrant Officer 2',14,now(),now()),
	('8df6c604-f085-4aa3-885b-6522b88125bd','6badf8a0-b0ef-4e42-b827-7f63a3987a4b'::uuid,'MARINES','WO1','Warrant Officer 1',15,now(),now()),
	('97c779cf-d554-4d5e-9b39-6d38fc382ef4','a5fc8fd2-6f91-492b-abe2-2157d03ec990'::uuid,'MARINES','SMG','Sergeant Major',16,now(),now()),
	('dcb640a6-c0ed-442a-b02e-e2f39105f3c6','a5fc8fd2-6f91-492b-abe2-2157d03ec990'::uuid,'MARINES','MGS','Master Gunnery Sergeant',17,now(),now()),
	('d6404c12-3e86-4db7-879b-89e6856142a5','1d909db0-602f-4724-bd43-8f90a6660460'::uuid,'MARINES','MSG','Master Sergeant',18,now(),now()),
	('3258e3ba-b151-42d4-9d2a-3f75fa4fd1e6','1d909db0-602f-4724-bd43-8f90a6660460'::uuid,'MARINES','1ST','1st Sergeant',19,now(),now()),
	('87570382-a2ed-447a-a3c6-cdfda1f8d753','523d57a1-529c-4dfd-8c33-9cb169fd29a0'::uuid,'MARINES','GYS','Gunnery Sergeant',20,now(),now()),
	('c2557065-3e79-4b4c-b0c7-5cc18243cb5a','541aec36-bd9f-4ad2-abb4-d9b63e29dc80'::uuid,'MARINES','SSG','Staff Sergeant',21,now(),now())
	 	on conflict (id) do nothing;
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	...
	('4b99e53c-d103-45bf-8c83-b15b456f8f29','862eb395-86d1-44af-ad47-dec44fbeda30'::uuid,'MARINES','LCP','Lance Corporal',25,now(),now()),
	...
	('4f111a4b-651c-4f96-ad8a-3ec65777e6c0','1d6e34c3-8c6c-4d4f-8b91-f46bed3f5e80'::uuid,'NAVY','VAD','Vice Admiral',2,now(),now()),
	('1b5913ef-6675-4e11-9871-077ee19eacaa','6e50b04a-52dc-45c9-91d9-4a7b4fa1ab20'::uuid,'NAVY','RADU','Rear Admiral (Upper Half)',3,now(),now()),
	('581d1318-29b0-4f11-933a-e716bc3fc8fd','cf664124-9baf-4187-8f28-0908c0f0a5e0'::uuid,'NAVY','RADL','Rear Admiral (Lower Half)',4,now(),now()),
...
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	...
	('4616c1c9-6794-4009-a8ff-e7d5b4a5f9e4','e83d8f8d-f70b-4db1-99cc-dd983d2fd250'::uuid,'NAVY','LCD','Lieutenant Commander',7,now(),now()),
	...
	('d5a88410-076d-42aa-9889-5e90b87f4821','ea8cb0e9-15ff-43b4-9e41-7168d01e7553'::uuid,'NAVY','WO5','Chief Warrant Officer 5',11,now(),now()),
	('9d40f511-123a-4e22-8fb9-f5107c3dc63e','74db5649-cf66-4af8-939b-d3d7f1f6b7c6'::uuid,'NAVY','WO4','Chief Warrant Officer 4',12,now(),now()),
	('0739d2e0-267c-4b11-abd9-0baec2b44cc7','5a65fb1f-4245-4178-b6a7-cc504c9cbb37'::uuid,'NAVY','WO3','Chief Warrant Officer 3',13,now(),now()),
	('772db820-df8e-471b-a77e-65704e701862','a687a2e1-488c-4943-b9d9-3d645a2712f4'::uuid,'NAVY','WO2','Chief Warrant Officer 2',14,now(),now())
		on conflict (id) do nothing;
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	('298a491b-24ba-48a7-9e1b-5593dbd7387c','6badf8a0-b0ef-4e42-b827-7f63a3987a4b'::uuid,'NAVY','WO1','Warrant Officer 1',15,now(),now()),
	('a56fec50-4639-426f-8abd-85eedf485723','a5fc8fd2-6f91-492b-abe2-2157d03ec990'::uuid,'NAVY','CPM','Master Chief Petty Officer',16,now(),now()),
	('e5d90322-b55d-4156-a9a7-a8331b2ff92f','1d909db0-602f-4724-bd43-8f90a6660460'::uuid,'NAVY','CPS','Senior Chief Petty Officer',18,now(),now()),
...
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	...
	('60163e2c-e822-4e85-ba0c-595e5b5a52df','1d6e34c3-8c6c-4d4f-8b91-f46bed3f5e80'::uuid,'SPACE_FORCE','LTG','Lieutenant General',2,now(),now()),
	('1c4feb55-5aa5-4057-aba2-8f4cdf0c2c2c','6e50b04a-52dc-45c9-91d9-4a7b4fa1ab20'::uuid,'SPACE_FORCE','MG','Major General',3,now(),now()),
	('90c2dce3-fc9a-407f-8868-5d8e45757826','cf664124-9baf-4187-8f28-0908c0f0a5e0'::uuid,'SPACE_FORCE','BG','Brigadier General',4,now(),now()),
	('9327cd6c-ebf1-44dc-98aa-ee6ed2604af8','455a112d-d1e0-4559-81e8-6df664638f70'::uuid,'SPACE_FORCE','COL','Colonel',5,now(),now()),
	('a907574a-0841-4e00-a08d-ccaa1cb43feb','3bc4b197-7897-4105-80a1-39a0378d7730'::uuid,'SPACE_FORCE','LTC','Lieutenant Colonel',6,now(),now()),
	...
	('103d519d-1b5d-4226-8c71-d34f366a0583','d1b76a01-d8e4-4bd3-98ff-fa93ff7bc790'::uuid,'SPACE_FORCE','1LT','First Lieutenant',9,now(),now())
	 	on conflict (id) do nothing;
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	('aa604956-fc8b-4f97-a66f-16d6d875c564','9a892c59-48d5-4eba-b5f9-193716da8827'::uuid,'SPACE_FORCE','2LT','Second Lieutenant',10,now(),now()),
	('903c8212-19b7-40e4-9f4b-150f6f76b8aa','a5fc8fd2-6f91-492b-abe2-2157d03ec990'::uuid,'SPACE_FORCE','CMS','Chief Master Sergeant',11,now(),now()),
	('0cb0fe2c-7d45-4167-bce7-2ae85b6debd8','1d909db0-602f-4724-bd43-8f90a6660460'::uuid,'SPACE_FORCE','SMS','Senior Master Sergeant',12,now(),now()),
	('0d35702e-5cd1-4051-a049-45e32a9116f0','523d57a1-529c-4dfd-8c33-9cb169fd29a0'::uuid,'SPACE_FORCE','MSG','Master Sergeant',13,now(),now()),
	('d5a09a55-ffa3-46fb-941e-7c37b762970e','541aec36-bd9f-4ad2-abb4-d9b63e29dc80'::uuid,'SPACE_FORCE','TSG','Technical Sergeant',14,now(),now()),
	('f3628803-59be-456d-87c3-fa0df971d04c','3f142461-dca5-4a77-9295-92ee93371330'::uuid,'SPACE_FORCE','SGT','Sergeant',15,now(),now()),
	('73b61e4b-54c4-435a-9a7b-f7d6e835c06e','bb55f37c-3165-46ba-ad3f-9a477f699990'::uuid,'SPACE_FORCE','SP4','Specialist 4',16,now(),now()),
	('dbd26213-fd1c-4078-9a4e-a321f4c3060a','862eb395-86d1-44af-ad47-dec44fbeda30'::uuid,'SPACE_FORCE','SP3','Specialist 3',20,now(),now()),
	('7a66c9db-5c87-4c15-b584-647dbfa5f6eb','5f871c82-f259-43cc-9245-a6e18975dde0'::uuid,'SPACE_FORCE','SP2','Specialist 2',21,now(),now())
		on conflict (id) do nothing;
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	 ('61c647fa-5325-45b9-8d6f-30a2aaa06308','6cb785d0-cabf-479a-a36d-a6aec294a4d0'::uuid,'SPACE_FORCE','SP1','Specialist 1',22,now(),now())
	 on conflict (id) do nothing;
...
INSERT INTO pay_grade_ranks (id,pay_grade_id,affiliation,rank_short_name,rank_name,rank_order,created_at,updated_at) VALUES
	('2e1b2c87-9861-4d00-6b1e-dd4e9d6844a3','911208cc-3d13-49d6-9478-b0a3943435c0'::uuid,'AIR_FORCE','CMA','Chief Master Sergeant of the Air Force',11,now(),now()),
