...
func (s ServiceMember) CreateBackupContact(db *pop.Connection, name string, firstName string, lastName string, email string, phone string, permission BackupContactPermission) (BackupContact, *validate.Errors, error) {
