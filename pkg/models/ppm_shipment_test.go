	...
	testCases := map[string]struct {
		...
		"Optional fields raise errors with invalid values": {
			ppmShipment: models.PPMShipment{
				...
				SecondaryDestinationAddressID: models.UUIDPointer(uuid.Nil),
			...
			expectedErrs: map[string][]string{
				...
				"secondary_pickup_postal_address_id": {"SecondaryPickupID can not be blank."},
				"secondary_destination_postal_address_id": {"SecondaryDestinationID can not be blank."},
