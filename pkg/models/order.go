...
type Order struct {
	...
	ShorttermDaysInStorage *int                              `json:"shortterm_days_in_storage" db:"shortterm_days_in_storage"`
	LongtermDaysInStorage  *int                              `json:"longterm_days_in_storage" db:"longterm_days_in_storage"`
}
