...
func (_m *SoapCaller) Call(m string, p gosoap.Params) (*gosoap.Response, error) {
	ret := _m.Called(m, p)

	var r0 *gosoap.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(string, gosoap.Params) (*gosoap.Response, error)); ok {
		return rf(m, p)
	}
	if rf, ok := ret.Get(0).(func(string, gosoap.Params) *gosoap.Response); ok {
		r0 = rf(m, p)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(string, gosoap.Params) error); ok {
		r1 = rf(m, p)
	} else {
		r1 = ret.Error(1)
	}
