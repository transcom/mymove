...
func FetchMovesByOrderID(db *pop.Connection, orderID uuid.UUID) (Moves, error) {
	...
	err := query.Eager(
		...
		"MTOShipments.PPMShipment.W2Address.State",
		...
		"MTOShipments.TertiaryDeliveryAddress.State",
		...
		"MTOShipments.TertiaryPickupAddress.State",
		"MTOShipments.TertiaryPickupAddress.Country",
		"MTOShipments.PPMShipment.PickupAddress.State",
		"MTOShipments.PPMShipment.PickupAddress.Country",
		"MTOShipments.PPMShipment.DestinationAddress.State",
		"MTOShipments.PPMShipment.DestinationAddress.Country",
		"MTOShipments.PPMShipment.SecondaryPickupAddress.State",
		"MTOShipments.PPMShipment.SecondaryPickupAddress.Country",
		"MTOShipments.PPMShipment.SecondaryDestinationAddress.State",
		"MTOShipments.PPMShipment.SecondaryDestinationAddress.Country",
		"MTOShipments.PPMShipment.TertiaryPickupAddress.State",
		"MTOShipments.PPMShipment.TertiaryPickupAddress.Country",
		"MTOShipments.PPMShipment.TertiaryDestinationAddress.State",
