...
type Move struct {
	...
	SCAssigned                   *OfficeUser           `belongs_to:"office_users" fk_id:"sc_assigned_id"`
	TOOAssignedID                *uuid.UUID            `json:"too_assigned_id" db:"too_assigned_id"`
	TOOAssigned                  *OfficeUser           `belongs_to:"office_users" fk_id:"too_assigned_id"`
	TIOAssignedID                *uuid.UUID            `json:"tio_assigned_id" db:"tio_assigned_id"`
	TIOAssigned                  *OfficeUser           `belongs_to:"office_users" fk_id:"tio_assigned_id"`
}
