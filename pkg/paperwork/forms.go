...
var rankDisplayValue = map[internalmessages.ServiceMemberRank]string{
	...
	internalmessages.ServiceMemberRankE9SPECIALSENIORENLISTED: "E-9 (Special Senior Enslisted",
	internalmessages.ServiceMemberRankO1ACADEMYGRADUATE:       "O-1 or Service Academy Graduate",
