...
var ShipmentSummaryPage1Layout = FormLayout{
	...
	FieldsLayout: map[string]FieldPos{
		...
		"MaxObligationGCC100":             FormField(40, 225.5, 22, floatPtr(10), nil, stringPtr("RM")),
		"TotalWeightAllotmentRepeat":      FormField(74, 225.5, 16, floatPtr(10), nil, stringPtr("RM")),
		"MaxObligationGCC95":              FormField(40, 233, 22, floatPtr(10), nil, stringPtr("RM")),
		"MaxObligationSIT":                FormField(40, 240, 22, floatPtr(10), nil, stringPtr("RM")),
		"MaxObligationGCCMaxAdvance":      FormField(40, 247, 22, floatPtr(10), nil, stringPtr("RM")),
...
var ShipmentSummaryPage3Layout = FormLayout{
	...
	FieldsLayout: map[string]FieldPos{
		"ServiceMemberSignature": FormField(10, 104, 200, floatPtr(10), nil, nil),
	},
}
