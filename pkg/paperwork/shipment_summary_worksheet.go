...
var ShipmentSummaryPage1Layout = FormLayout{
	...
	FieldsLayout: map[string]FieldPos{
		...
		"ShipmentNumberAndTypes":           FormField(10, 135, 41, floatPtr(10), nil),
		"Shipment1PickUpDates":             FormField(55, 135, 46, floatPtr(10), nil),
		"Shipment1Weights":                 FormField(104, 135, 41, floatPtr(10), nil),
		"Shipment1CurrentShipmentStatuses": FormField(154, 135, 41, floatPtr(10), nil),
	},
}
