...
var ShipmentSummaryPage1Layout = FormLayout{
	...
	FieldsLayout: map[string]FieldPos{
		"PreparationDate":                 FormField(155, 22, 46, floatPtr(10), nil),
		...
		"AuthorizedOrigin":                FormField(103, 103, 45, floatPtr(10), nil),
		"AuthorizedDestination":           FormField(153, 103, 45, floatPtr(10), nil),
		...
		"ShipmentNumberAndTypes":          FormField(9, 135, 41, floatPtr(10), nil),
		"ShipmentPickUpDates":             FormField(54, 135, 46, floatPtr(10), nil),
		"ShipmentWeights":                 FormField(103, 135, 41, floatPtr(10), nil),
		"ShipmentCurrentShipmentStatuses": FormField(153, 135, 41, floatPtr(10), nil),
	},
}
