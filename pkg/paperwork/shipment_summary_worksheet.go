...
var ShipmentSummaryPage1Layout = FormLayout{
	...
	FieldsLayout: map[string]FieldPos{
		...
		"SITNumberAndTypes":               FormField(9.5, 153, 41, floatPtr(10), nil, nil),
		"SITEntryDates":                   FormField(54, 153, 46, floatPtr(10), nil, nil),
		"SITEndDates":                     FormField(103, 153, 41, floatPtr(10), nil, nil),
		"SITDaysInStorage":                FormField(153.5, 153, 41, floatPtr(10), nil, nil),
...
var ShipmentSummaryPage2Layout = FormLayout{
	...
	FieldsLayout: map[string]FieldPos{
		...
		"TotalMemberPaidSIT":          FormField(74, 64, 30, floatPtr(10), nil, stringPtr("RM")),
		"TotalGTCCPaidSIT":            FormField(74, 75, 30, floatPtr(10), nil, stringPtr("RM")),
