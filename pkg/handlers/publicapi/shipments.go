...
func payloadForShipmentModel(s models.Shipment) *apimessages.Shipment {
	shipmentpayload := &apimessages.Shipment{
		...
		ActualWeightEstimate:                handlers.FmtPoundPtr(s.ActualWeightEstimate),
		ActualProgearWeightEstimate:         handlers.FmtPoundPtr(s.ActualProgearWeightEstimate),
		ActualSpouseProgearWeightEstimate:   handlers.FmtPoundPtr(s.ActualSpouseProgearWeightEstimate),
