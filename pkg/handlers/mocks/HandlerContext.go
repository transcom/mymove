...
func (_m *HandlerContext) LoggerFromContext(ctx context.Context) *zap.Logger {
	ret := _m.Called(ctx)

	var r0 *zap.Logger
	if rf, ok := ret.Get(0).(func(context.Context) *zap.Logger); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_m *HandlerContext) LoggerFromRequest(r *http.Request) *zap.Logger {
	ret := _m.Called(r)

	var r0 *zap.Logger
	if rf, ok := ret.Get(0).(func(*http.Request) *zap.Logger); ok {
		r0 = rf(r)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*zap.Logger)
...
func (_m *HandlerContext) SessionAndLoggerFromContext(ctx context.Context) (*auth.Session, *zap.Logger) {
	ret := _m.Called(ctx)
	...
	var r1 *zap.Logger
	if rf, ok := ret.Get(1).(func(context.Context) *zap.Logger); ok {
		r1 = rf(ctx)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*zap.Logger)
		}
	}
...
func (_m *HandlerContext) SessionAndLoggerFromRequest(r *http.Request) (*auth.Session, *zap.Logger) {
	ret := _m.Called(r)
	...
	var r1 *zap.Logger
	if rf, ok := ret.Get(1).(func(*http.Request) *zap.Logger); ok {
		r1 = rf(r)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*zap.Logger)
