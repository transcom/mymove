...
func (suite *HandlerSuite) TestShowServiceMemberHandler() {
	...
	req := suite.NewRequestWithContext("GET", "/service_members/some_id", nil)
	...
	showHandler := ShowServiceMemberHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
...
func (suite *HandlerSuite) TestShowServiceMemberWrongUser() {
	...
	req := suite.NewRequestWithContext("GET", fmt.Sprintf("/service_members/%s", notLoggedInUser.ID.String()), nil)
...
func (suite *HandlerSuite) TestSubmitServiceMemberHandlerNoValues() {
	...
	req := suite.NewRequestWithContext("POST", "/service_members", nil)
	...
	handler := CreateServiceMemberHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
...
func (suite *HandlerSuite) TestPatchServiceMemberHandler() {
	...
	req := suite.NewRequestWithContext("PATCH", "/service_members/some_id", nil)
	req = suite.AuthenticateRequest(req, newServiceMember)
...
func (suite *HandlerSuite) TestPatchServiceMemberHandlerWrongUser() {
	...
	handler := PatchServiceMemberHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
	response := handler.Handle(params)
...
func (suite *HandlerSuite) TestShowServiceMemberOrders() {
	...
	req := suite.NewRequestWithContext("GET", "/service_members/some_id/current_orders", nil)
