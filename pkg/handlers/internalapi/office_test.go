...
func (suite *HandlerSuite) TestApproveMoveHandler() {
	...
	req := suite.NewRequestWithContext("POST", "/moves/some_id/approve", nil)
...
func (suite *HandlerSuite) TestCancelMoveHandler() {
	...
	// And: the context contains the auth values
	req := suite.NewRequestWithContext("POST", "/moves/some_id/cancel", nil)
	req = suite.AuthenticateOfficeRequest(req, officeUser)
...
func (suite *HandlerSuite) TestApprovePPMHandler() {
	...
	// And: the context contains the auth values
	req := suite.NewRequestWithContext("POST", "/personally_procured_moves/some_id/approve", nil)
	req = suite.AuthenticateOfficeRequest(req, officeUser)
...
func (suite *HandlerSuite) TestApproveReimbursementHandler() {
	...
	// And: the context contains the auth values
	req := suite.NewRequestWithContext("POST", "/reimbursement/some_id/approve", nil)
	req = suite.AuthenticateOfficeRequest(req, officeUser)
	...
	handler := ApproveReimbursementHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
	response := handler.Handle(params)
