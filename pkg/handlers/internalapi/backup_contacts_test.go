...
func (suite *HandlerSuite) TestCreateBackupContactHandler() {
	...
	req := suite.NewRequestWithContext("POST", fmt.Sprintf("/service_member/%v/backup_contacts", serviceMember.ID.String()), nil)
	...
	handler := CreateBackupContactHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
...
func (suite *HandlerSuite) TestIndexBackupContactsHandler() {
	...
	req := suite.NewRequestWithContext("GET", indexPath, nil)
	...
	handler := IndexBackupContactsHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
	response := handler.Handle(params)
...
func (suite *HandlerSuite) TestShowBackupContactsHandler() {
	...
	req := suite.NewRequestWithContext("GET", showPath, nil)
	...
	handler := ShowBackupContactHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
	response := handler.Handle(params)
...
func (suite *HandlerSuite) TestUpdateBackupContactsHandler() {
	...
	req := suite.NewRequestWithContext("PUT", updatePath, nil)
	...
	handler := UpdateBackupContactHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
	response := handler.Handle(params)
