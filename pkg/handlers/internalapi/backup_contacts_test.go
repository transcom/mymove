...
func (suite *HandlerSuite) TestCreateBackupContactHandler() {
	...
	handler := CreateBackupContactHandler{suite.HandlerContextWithServices()}
...
func (suite *HandlerSuite) TestIndexBackupContactsHandler() {
	...
	handler := IndexBackupContactsHandler{suite.HandlerContextWithServices()}
	response := handler.Handle(params)
...
func (suite *HandlerSuite) TestShowBackupContactsHandler() {
	...
	handler := ShowBackupContactHandler{suite.HandlerContextWithServices()}
	response := handler.Handle(params)
...
func (suite *HandlerSuite) TestUpdateBackupContactsHandler() {
	...
	handler := UpdateBackupContactHandler{suite.HandlerContextWithServices()}
	response := handler.Handle(params)
