...
func (suite *HandlerSuite) TestCreateSignedCertificationHandler() {
	...
	handler := CreateSignedCertificationHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
...
func (suite *HandlerSuite) TestIndexSignedCertificationHandlerBadMoveID() {
	...
	handler := IndexSignedCertificationsHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
	response := handler.Handle(params)
