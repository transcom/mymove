...
func (suite *HandlerSuite) TestCreatePPMHandler() {
	...
	handler := CreatePersonallyProcuredMoveHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
...
func (suite *HandlerSuite) TestSubmitPPMHandler() {
	...
	// submit the PPM
	handler := SubmitPersonallyProcuredMoveHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
...
func (suite *HandlerSuite) TestIndexPPMHandler() {
	...
	handler := IndexPersonallyProcuredMovesHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
...
func (suite *HandlerSuite) TestRequestPPMPayment() {
	...
	handler := RequestPPMPaymentHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
...
func (suite *HandlerSuite) TestRequestPPMExpenseSummaryHandler() {
	...
	handler := RequestPPMExpenseSummaryHandler{handlers.NewHandlerConfig(suite.DB(), suite.TestLogger())}
