...
func payloadForMoveQueueItem(MoveQueueItem models.MoveQueueItem) *internalmessages.MoveQueueItem {
	MoveQueueItemPayload := internalmessages.MoveQueueItem{
		...
		OriginDutyLocationName:      swag.String(MoveQueueItem.OriginDutyStationName),
		DestinationDutyLocationName: swag.String(MoveQueueItem.DestinationDutyStationName),
