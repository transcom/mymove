...
func (suite *utils.HandlerSuite) TestValidateEntitlementHandlerReturns200() {
...
func (suite *utils.HandlerSuite) TestValidateEntitlementHandlerReturns409() {
	// Given: a set of orders, a move, user, servicemember and a PPM
	ppm := testdatagen.MakeDefaultPPM(suite.db)
	move := ppm.Move
...
func (suite *utils.HandlerSuite) TestValidateEntitlementHandlerReturns404IfNoPpm() {
...
func (suite *utils.HandlerSuite) TestValidateEntitlementHandlerReturns404IfNoMoveOrOrders() {
...
func (suite *utils.HandlerSuite) TestValidateEntitlementHandlerReturns404IfNoRank() {
	// Given: a set of orders, a move, user, servicemember and a PPM
	ppm := testdatagen.MakeDefaultPPM(suite.db)
	move := ppm.Move
