...
func (h UpdateWeightTicketHandler) Handle(params weightticketops.UpdateWeightTicketParams) middleware.Responder {
	...
	func(appCtx appcontext.AppContext) (middleware.Responder, error) {
		payload := params.UpdateWeightTicket
		if payload == nil {
		...
		updatedWeightTicket, err := h.weightTicketUpdater.UpdateWeightTicket(appCtx, weightTicket, params.IfMatch)
		if err != nil {
			return handleError(err)
		}
		returnPayload := payloads.WeightTicket(updatedWeightTicket)
