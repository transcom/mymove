...
func payloadForContractor(c *models.Contractor) *ghcmessages.Contractor {
	if c == nil {
		return nil
	}
	return &ghcmessages.Contractor{
		ID:             strfmt.UUID(c.ID.String()),
		Name:           *swag.String(c.Name),
		Type:           *swag.String(c.Type),
		ContractNumber: *swag.String(c.ContractNumber),
	}
}
