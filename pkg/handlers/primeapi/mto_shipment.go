...
// then converts the payload into the model
func UpdateMTOShipmentModel(mtoShipmentID strfmt.UUID, payload *primemessages.UpdateMTOShipment) (*models.MTOShipment, *validate.Errors) {
	...
	// Grabbing teh mtoShipmentID directly from the request ID
	// The user will not have to pass in the ID into the request body
	mtoShipment := payloads.MTOShipmentModelFromUpdate(payload, mtoShipmentID)
