...
func fakeAddress() *internalmodel.Address {
...
func TestSubmitForm1299HandlerAllValues(t *testing.T) {
	var rankE6 = internalmodel.ServiceMemberRankE6
	setUpLogger()
	// Given: an instance of Form1299 with all valid values
	newForm1299Payload := internalmodel.CreateForm1299Payload{
