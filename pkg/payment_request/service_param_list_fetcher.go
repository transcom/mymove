...
func (p *RequestPaymentHelper) FetchServiceParamList(appCfg appconfig.AppConfig, mtoServiceID uuid.UUID) (models.ServiceParams, error) {
	mtoServiceItem := models.MTOServiceItem{}
	serviceParams := models.ServiceParams{}

	err := appCfg.DB().Where("id = ?", mtoServiceID).First(&mtoServiceItem)
	if err != nil {
