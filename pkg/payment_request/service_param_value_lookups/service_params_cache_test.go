...
func (suite *ServiceParamValueLookupsSuite) makeSubtestData() (subtestData *paramsCacheSubtestData) {
	...
	reServiceDOP := factory.FetchReServiceByCode(suite.DB(), models.ReServiceCodeDOP)
	reServiceMS := factory.FetchReServiceByCode(suite.DB(), models.ReServiceCodeMS)
	reServiceDCRT := factory.FetchReServiceByCode(suite.DB(), models.ReServiceCodeDCRT)
