...
const (
	...
	// TelemetryEndpointFlag configures the endpoint to send OTEL GRPC
	// messages. Server side telemetry is sent here
	TelemetryEndpointFlag string = "telemetry-endpoint"
	// TelemetryHTTPEndpointFlag configures the endpoint to send OTEL
	// HTTP messages. Client side telemetry is sent here
...
func InitTelemetryFlags(flag *pflag.FlagSet) {
	...
	flag.String(TelemetryEndpointFlag, "stdout", "open telemetry GRPC tracing endpoint")
