...
// FetchOrMakeDefaultCurrentDutyLocation returns a default duty station - Yuma AFB
func FetchOrMakeDefaultCurrentDutyLocation(db *pop.Connection) models.DutyLocation {
	...
	defaultStation, err := models.FetchDutyLocationByName(db, "Yuma AFB")
	if err != nil {
		return MakeDutyLocation(db, Assertions{
...
// FetchOrMakeDefaultNewOrdersDutyLocation returns a default duty station - Yuma AFB
