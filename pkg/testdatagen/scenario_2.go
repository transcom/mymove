...
func RunScenarioTwo(db *pop.Connection) {
	...
	MakeTSPPerformance(db, tsp1, tdl, swag.Int(1), 5, 0, true)
	MakeTSPPerformance(db, tsp2, tdl, swag.Int(1), 4, 0, true)
	MakeTSPPerformance(db, tsp3, tdl, swag.Int(2), 3, 0, true)
	MakeTSPPerformance(db, tsp4, tdl, swag.Int(3), 2, 0, true)
	MakeTSPPerformance(db, tsp5, tdl, swag.Int(4), 1, 0, true)

	MakeTSPPerformance(db, tsp6, tdl2, swag.Int(1), 5, 0, true)
	MakeTSPPerformance(db, tsp7, tdl2, swag.Int(2), 4, 0, true)
	MakeTSPPerformance(db, tsp8, tdl2, swag.Int(3), 2, 0, true)
	MakeTSPPerformance(db, tsp9, tdl2, swag.Int(4), 1, 0, true)
	// Add blackout dates
