...
//  MakeGHCEntitlement creates a single GHCEntitlement and associated set of relationships
func MakeGHCEntitlement(db *pop.Connection, assertions Assertions) models.GHCEntitlement {
