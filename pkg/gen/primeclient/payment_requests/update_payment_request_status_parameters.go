...
func (o *UpdatePaymentRequestStatusParams) WithBody(body *primemessages.UpdatePaymentRequestStatusPayload) *UpdatePaymentRequestStatusParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update payment request status params
func (o *UpdatePaymentRequestStatusParams) SetBody(body *primemessages.UpdatePaymentRequestStatusPayload) {
	o.Body = body
}
