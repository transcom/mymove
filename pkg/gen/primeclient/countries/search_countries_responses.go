...
func (o *SearchCountriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /countries] searchCountries", response, response.Code())
	}
}
...
func (o *SearchCountriesOK) Error() string {
	return fmt.Sprintf("[GET /countries][%d] searchCountriesOK  %+v", 200, o.Payload)
}
...
func (o *SearchCountriesBadRequest) Error() string {
	return fmt.Sprintf("[GET /countries][%d] searchCountriesBadRequest  %+v", 400, o.Payload)
}
...
func (o *SearchCountriesForbidden) Error() string {
	return fmt.Sprintf("[GET /countries][%d] searchCountriesForbidden  %+v", 403, o.Payload)
}
...
func (o *SearchCountriesNotFound) Error() string {
	return fmt.Sprintf("[GET /countries][%d] searchCountriesNotFound  %+v", 404, o.Payload)
}
...
func (o *SearchCountriesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /countries][%d] searchCountriesInternalServerError  %+v", 500, o.Payload)
}
