...
// WithIfUnmodifiedSince adds the ifUnmodifiedSince to the update m t o post counseling information params
func (o *UpdateMTOPostCounselingInformationParams) WithIfUnmodifiedSince(ifUnmodifiedSince strfmt.DateTime) *UpdateMTOPostCounselingInformationParams {
	o.SetIfUnmodifiedSince(ifUnmodifiedSince)
	return o
}

// SetIfUnmodifiedSince adds the ifUnmodifiedSince to the update m t o post counseling information params
func (o *UpdateMTOPostCounselingInformationParams) SetIfUnmodifiedSince(ifUnmodifiedSince strfmt.DateTime) {
