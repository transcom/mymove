...
func (o *UpdateMoveTaskOrderStatusOK) Error() string {
	return fmt.Sprintf("[PATCH /support/move-task-orders/{moveTaskOrderID}/status][%d] updateMoveTaskOrderStatusOK  %+v", 200, o.Payload)
}

func (o *UpdateMoveTaskOrderStatusOK) GetPayload() *primemessages.MoveTaskOrder {
	return o.Payload
}
...
func (o *UpdateMoveTaskOrderStatusBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /support/move-task-orders/{moveTaskOrderID}/status][%d] updateMoveTaskOrderStatusBadRequest  %+v", 400, o.Payload)
}
...
func (o *UpdateMoveTaskOrderStatusUnauthorized) Error() string {
	return fmt.Sprintf("[PATCH /support/move-task-orders/{moveTaskOrderID}/status][%d] updateMoveTaskOrderStatusUnauthorized  %+v", 401, o.Payload)
}
...
func (o *UpdateMoveTaskOrderStatusForbidden) Error() string {
	return fmt.Sprintf("[PATCH /support/move-task-orders/{moveTaskOrderID}/status][%d] updateMoveTaskOrderStatusForbidden  %+v", 403, o.Payload)
}
...
func (o *UpdateMoveTaskOrderStatusNotFound) Error() string {
	return fmt.Sprintf("[PATCH /support/move-task-orders/{moveTaskOrderID}/status][%d] updateMoveTaskOrderStatusNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateMoveTaskOrderStatusPreconditionFailed) Error() string {
	return fmt.Sprintf("[PATCH /support/move-task-orders/{moveTaskOrderID}/status][%d] updateMoveTaskOrderStatusPreconditionFailed  %+v", 412, o.Payload)
}
...
func (o *UpdateMoveTaskOrderStatusInternalServerError) Error() string {
	return fmt.Sprintf("[PATCH /support/move-task-orders/{moveTaskOrderID}/status][%d] updateMoveTaskOrderStatusInternalServerError  %+v", 500, o.Payload)
}
