...
type ListMovesOK struct {
	Payload primev2messages.ListMoves
}
...
func (o *ListMovesOK) GetPayload() primev2messages.ListMoves {
	return o.Payload
}
...
func (o *ListMovesUnauthorized) GetPayload() *primev2messages.ClientError {
	return o.Payload
}
...
func (o *ListMovesForbidden) GetPayload() *primev2messages.ClientError {
	return o.Payload
}
...
func (o *ListMovesInternalServerError) GetPayload() *primev2messages.Error {
	return o.Payload
}
