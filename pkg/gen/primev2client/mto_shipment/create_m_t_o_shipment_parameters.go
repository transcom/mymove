...
func (o *CreateMTOShipmentParams) WithBody(body *primev2messages.CreateMTOShipment) *CreateMTOShipmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create m t o shipment params
func (o *CreateMTOShipmentParams) SetBody(body *primev2messages.CreateMTOShipment) {
	o.Body = body
}
