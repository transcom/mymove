...
func (o *UpdateMTOShipmentParams) WithBody(body *primev2messages.UpdateMTOShipment) *UpdateMTOShipmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update m t o shipment params
func (o *UpdateMTOShipmentParams) SetBody(body *primev2messages.UpdateMTOShipment) {
	o.Body = body
}
