...
func (m *Orders) validatePayGradeRank(formats strfmt.Registry) error {
...
func (m *Orders) contextValidatePayGradeRank(ctx context.Context, formats strfmt.Registry) error {
