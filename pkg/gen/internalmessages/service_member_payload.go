...
func (m *ServiceMemberPayload) validatePayGradeRank(formats strfmt.Registry) error {
...
func (m *ServiceMemberPayload) contextValidatePayGradeRank(ctx context.Context, formats strfmt.Registry) error {
