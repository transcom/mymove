...
func (m *ClientCertificateCreate) validatePptasBranch(formats strfmt.Registry) error {
...
func (m *ClientCertificateCreate) contextValidatePptasBranch(ctx context.Context, formats strfmt.Registry) error {
