...
func (m *ClientCertificate) validatePptasAffiliation(formats strfmt.Registry) error {
...
func (m *ClientCertificate) contextValidatePptasAffiliation(ctx context.Context, formats strfmt.Registry) error {
