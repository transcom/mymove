...
// Validate validates this transportation service provider performances
func (m TransportationServiceProviderPerformances) Validate(formats strfmt.Registry) error {
	var res []error
