...
func (o *GetMoveTaskOrderReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /move-task-orders/{moveID}] getMoveTaskOrder", response, response.Code())
	}
}
...
func (o *GetMoveTaskOrderOK) GetPayload() *primev3messages.MoveTaskOrder {
	return o.Payload
}
...
func (o *GetMoveTaskOrderOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(primev3messages.MoveTaskOrder)
...
func (o *GetMoveTaskOrderUnauthorized) GetPayload() *primev3messages.ClientError {
	return o.Payload
}
...
func (o *GetMoveTaskOrderForbidden) GetPayload() *primev3messages.ClientError {
	return o.Payload
}
...
func (o *GetMoveTaskOrderNotFound) GetPayload() *primev3messages.ClientError {
	return o.Payload
}
...
func (o *GetMoveTaskOrderInternalServerError) GetPayload() *primev3messages.Error {
	return o.Payload
}
