...
type UpdateShipmentDestinationAddressParams struct {
	...
	*/
	...
	// Body.
	Body *primev3messages.UpdateShipmentDestinationAddress
...
func (o *UpdateShipmentDestinationAddressParams) WithBody(body *primev3messages.UpdateShipmentDestinationAddress) *UpdateShipmentDestinationAddressParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update shipment destination address params
func (o *UpdateShipmentDestinationAddressParams) SetBody(body *primev3messages.UpdateShipmentDestinationAddress) {
	o.Body = body
}
