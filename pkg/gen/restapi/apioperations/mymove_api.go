...
func NewMymoveAPI(spec *loads.Document) *MymoveAPI {
	return &MymoveAPI{
		...
		TspsIndexTSPsHandler: tsps.IndexTSPsHandlerFunc(func(params tsps.IndexTSPsParams) middleware.Responder {
			return middleware.NotImplemented("operation tsps.IndexTSPs has not yet been implemented")
		}),
	}
}

/*MymoveAPI The public API for my.move.mil. This is a work in-progress, and is not a final product. We will be continuously updating this site based on feedback. */
type MymoveAPI struct {
	...
	// TspsIndexTSPsHandler sets the operation handler for the index t s ps operation
	TspsIndexTSPsHandler tsps.IndexTSPsHandler
...
func (o *MymoveAPI) Validate() error {
	...
	if o.TspsIndexTSPsHandler == nil {
		unregistered = append(unregistered, "tsps.IndexTSPsHandler")
	}
...
func (o *MymoveAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/tsps"] = tsps.NewIndexTSPs(o.context, o.TspsIndexTSPsHandler)
}
