...
func NewMymoveAPI(spec *loads.Document) *MymoveAPI {
	return &MymoveAPI{
		...
		DpsGetUserHandler: dps.GetUserHandlerFunc(func(params dps.GetUserParams) middleware.Responder {
			return middleware.NotImplemented("operation dps.GetUser has not yet been implemented")
		}),
	}
}

/*MymoveAPI MyMove API for DPS */
type MymoveAPI struct {
	...
	// DpsGetUserHandler sets the operation handler for the get user operation
	DpsGetUserHandler dps.GetUserHandler
...
func (o *MymoveAPI) Validate() error {
	...
	if o.DpsGetUserHandler == nil {
		unregistered = append(unregistered, "dps.GetUserHandler")
	}
...
func (o *MymoveAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/authentication/user"] = dps.NewGetUser(o.context, o.DpsGetUserHandler)
}
