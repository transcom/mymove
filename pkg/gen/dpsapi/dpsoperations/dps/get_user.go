...
/*GetUser swagger:route GET /authentication/user dps getUser

Retrieve user information given the authentication cookie provided by MyMove

Returns user information necessary for registration and login
