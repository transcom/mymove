...
// NewIndexAccessCodesParams creates a new IndexAccessCodesParams object
// no default values defined in spec.
func NewIndexAccessCodesParams() IndexAccessCodesParams {

	return IndexAccessCodesParams{}
}

// IndexAccessCodesParams contains all the bound params for the index access codes operation
// typically these are obtained from a http.Request
//
// swagger:parameters indexAccessCodes
type IndexAccessCodesParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewIndexAccessCodesParams() beforehand.
func (o *IndexAccessCodesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IndexAccessCodesParams) bindFilter(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *IndexAccessCodesParams) bindPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *IndexAccessCodesParams) bindPerPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
