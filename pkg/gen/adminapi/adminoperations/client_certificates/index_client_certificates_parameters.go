...
func NewIndexClientCertificatesParams() IndexClientCertificatesParams {
	...
	return IndexClientCertificatesParams{}
}

// IndexClientCertificatesParams contains all the bound params for the index client certificates operation
// typically these are obtained from a http.Request
//
// swagger:parameters indexClientCertificates
type IndexClientCertificatesParams struct {
...
func (o *IndexClientCertificatesParams) bindFilter(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *IndexClientCertificatesParams) bindPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *IndexClientCertificatesParams) bindPerPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *IndexClientCertificatesParams) bindSort(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
