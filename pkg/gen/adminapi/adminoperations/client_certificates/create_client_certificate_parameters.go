...
func NewCreateClientCertificateParams() CreateClientCertificateParams {
	...
	return CreateClientCertificateParams{}
}

// CreateClientCertificateParams contains all the bound params for the create client certificate operation
...
func (o *CreateClientCertificateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body adminmessages.ClientCertificateCreate
