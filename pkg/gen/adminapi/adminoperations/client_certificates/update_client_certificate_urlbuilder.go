...
type UpdateClientCertificateURL struct {
...
func (o *UpdateClientCertificateURL) Build() (*url.URL, error) {
	...
	var _path = "/client-certificates/{clientCertificateId}"

	clientCertificateID := o.ClientCertificateID.String()
	if clientCertificateID != "" {
		_path = strings.Replace(_path, "{clientCertificateId}", clientCertificateID, -1)
	} else {
		return nil, errors.New("clientCertificateId is required on UpdateClientCertificateURL")
	}
...
func (o *UpdateClientCertificateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateClientCertificateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateClientCertificateURL")
	}
