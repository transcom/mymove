...
type GetClientCertificateURL struct {
...
func (o *GetClientCertificateURL) Build() (*url.URL, error) {
	...
	if clientCertificateID != "" {
		...
		return nil, errors.New("clientCertificateId is required on GetClientCertificateURL")
	}
...
func (o *GetClientCertificateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetClientCertificateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetClientCertificateURL")
	}
