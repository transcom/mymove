...
type RemoveClientCertificateURL struct {
...
func (o *RemoveClientCertificateURL) Build() (*url.URL, error) {
	...
	if clientCertificateID != "" {
		...
		return nil, errors.New("clientCertificateId is required on RemoveClientCertificateURL")
	}
...
func (o *RemoveClientCertificateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RemoveClientCertificateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RemoveClientCertificateURL")
	}
