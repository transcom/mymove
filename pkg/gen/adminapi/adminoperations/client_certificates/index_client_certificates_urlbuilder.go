...
type IndexClientCertificatesURL struct {
	Filter  *string
	Order   *bool
	Page    *int64
	PerPage *int64
...
func (o *IndexClientCertificatesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on IndexClientCertificatesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on IndexClientCertificatesURL")
	}
