...
func NewIndexElectronicOrdersParams() IndexElectronicOrdersParams {
	...
	return IndexElectronicOrdersParams{}
}

// IndexElectronicOrdersParams contains all the bound params for the index electronic orders operation
...
func (o *IndexElectronicOrdersParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IndexElectronicOrdersParams) bindFilter(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *IndexElectronicOrdersParams) bindOrder(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *IndexElectronicOrdersParams) bindPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *IndexElectronicOrdersParams) bindPerPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *IndexElectronicOrdersParams) bindSort(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
