...
func (o *GetRequestedOfficeUserURL) WithBasePath(bp string) *GetRequestedOfficeUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetRequestedOfficeUserURL) Build() (*url.URL, error) {
	...
	if officeUserID != "" {
		...
		return nil, errors.New("officeUserId is required on GetRequestedOfficeUserURL")
	}
...
func (o *GetRequestedOfficeUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRequestedOfficeUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRequestedOfficeUserURL")
	}
