...
func NewUpdateRequestedOfficeUserParams() UpdateRequestedOfficeUserParams {
	...
	return UpdateRequestedOfficeUserParams{}
}

// UpdateRequestedOfficeUserParams contains all the bound params for the update requested office user operation
...
func (o *UpdateRequestedOfficeUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body adminmessages.RequestedOfficeUserUpdate
...
func (o *UpdateRequestedOfficeUserParams) bindOfficeUserID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateRequestedOfficeUserParams) validateOfficeUserID(formats strfmt.Registry) error {
