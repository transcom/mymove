...
func (o *UpdateRequestedOfficeUserURL) WithBasePath(bp string) *UpdateRequestedOfficeUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateRequestedOfficeUserURL) Build() (*url.URL, error) {
	...
	if officeUserID != "" {
		...
		return nil, errors.New("officeUserId is required on UpdateRequestedOfficeUserURL")
	}
...
func (o *UpdateRequestedOfficeUserURL) String() string {
...
func (o *UpdateRequestedOfficeUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateRequestedOfficeUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateRequestedOfficeUserURL")
	}
