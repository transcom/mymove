...
/*
	DeleteUser swagger:route DELETE /users/{userId} Users deleteUser

# Deletes a User

Deletes a single user in any status. This endpoint is used in the Admin UI that will allow the admin user to delete a user.
*/
