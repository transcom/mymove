...
func NewGetLoggedInAdminUserParams() GetLoggedInAdminUserParams {
	...
	return GetLoggedInAdminUserParams{}
}

// GetLoggedInAdminUserParams contains all the bound params for the get logged in admin user operation
...
func (o *GetLoggedInAdminUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
