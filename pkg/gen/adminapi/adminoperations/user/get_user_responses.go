...
type GetUserOK struct {
	...
	/*
	  In: Body
	*/
	Payload *adminmessages.UserInformation `json:"body,omitempty"`
}
...
func (o *GetUserOK) WithPayload(payload *adminmessages.UserInformation) *GetUserOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get user o k response
func (o *GetUserOK) SetPayload(payload *adminmessages.UserInformation) {
	o.Payload = payload
}
