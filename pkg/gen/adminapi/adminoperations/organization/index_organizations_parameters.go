...
func NewIndexOrganizationsParams() IndexOrganizationsParams {
	...
	return IndexOrganizationsParams{}
}

// IndexOrganizationsParams contains all the bound params for the index organizations operation
...
func (o *IndexOrganizationsParams) bindFilter(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *IndexOrganizationsParams) bindOrder(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *IndexOrganizationsParams) bindPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *IndexOrganizationsParams) bindPerPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *IndexOrganizationsParams) bindSort(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
