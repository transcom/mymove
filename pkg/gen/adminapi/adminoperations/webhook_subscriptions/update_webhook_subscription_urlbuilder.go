...
func (o *UpdateWebhookSubscriptionURL) WithBasePath(bp string) *UpdateWebhookSubscriptionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateWebhookSubscriptionURL) Build() (*url.URL, error) {
	...
	if webhookSubscriptionID != "" {
		...
		return nil, errors.New("webhookSubscriptionId is required on UpdateWebhookSubscriptionURL")
	}
...
func (o *UpdateWebhookSubscriptionURL) String() string {
...
func (o *UpdateWebhookSubscriptionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateWebhookSubscriptionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateWebhookSubscriptionURL")
	}
