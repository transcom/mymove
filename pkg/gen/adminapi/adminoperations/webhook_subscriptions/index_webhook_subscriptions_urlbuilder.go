...
func (o *IndexWebhookSubscriptionsURL) WithBasePath(bp string) *IndexWebhookSubscriptionsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *IndexWebhookSubscriptionsURL) Build() (*url.URL, error) {
	...
	var _path = "/webhookSubscriptions"
...
func (o *IndexWebhookSubscriptionsURL) String() string {
...
func (o *IndexWebhookSubscriptionsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on IndexWebhookSubscriptionsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on IndexWebhookSubscriptionsURL")
	}
