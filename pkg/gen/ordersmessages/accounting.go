...
// ContextValidate validates this accounting based on context it is used
func (m *Accounting) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
