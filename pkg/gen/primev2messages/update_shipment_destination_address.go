...
// UpdateShipmentDestinationAddress UpdateShipmentDestinationAddress contains the fields required for the prime to create a non SIT address update request.
//
