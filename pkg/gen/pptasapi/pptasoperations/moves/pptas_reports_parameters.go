...
// PptasReportsParams contains all the bound params for the pptas reports operation
...
func (o *PptasReportsParams) bindSince(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PptasReportsParams) validateSince(formats strfmt.Registry) error {
