...
// ReportsParams contains all the bound params for the reports operation
// typically these are obtained from a http.Request
//
// swagger:parameters reports
...
//
// To ensure default values, the struct must have been initialized with NewReportsParams() beforehand.
func (o *ReportsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReportsParams) bindSince(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReportsParams) validateSince(formats strfmt.Registry) error {
