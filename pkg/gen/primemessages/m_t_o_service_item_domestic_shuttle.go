...
// MTOServiceItemDomesticShuttle Describes a domestic shuttle service item.
//
// swagger:model MTOServiceItemDomesticShuttle
type MTOServiceItemDomesticShuttle struct {
	eTagField string
...
func (m *MTOServiceItemDomesticShuttle) ETag() string {
	return m.eTagField
}

// SetETag sets the e tag of this subtype
func (m *MTOServiceItemDomesticShuttle) SetETag(val string) {
	m.eTagField = val
}

// ID gets the id of this subtype
func (m *MTOServiceItemDomesticShuttle) ID() strfmt.UUID {
	return m.idField
}

// SetID sets the id of this subtype
func (m *MTOServiceItemDomesticShuttle) SetID(val strfmt.UUID) {
	m.idField = val
}

// LockedPriceCents gets the locked price cents of this subtype
func (m *MTOServiceItemDomesticShuttle) LockedPriceCents() *int64 {
	return m.lockedPriceCentsField
}

// SetLockedPriceCents sets the locked price cents of this subtype
func (m *MTOServiceItemDomesticShuttle) SetLockedPriceCents(val *int64) {
	m.lockedPriceCentsField = val
}

// ModelType gets the model type of this subtype
func (m *MTOServiceItemDomesticShuttle) ModelType() MTOServiceItemModelType {
	return "MTOServiceItemDomesticShuttle"
}

// SetModelType sets the model type of this subtype
func (m *MTOServiceItemDomesticShuttle) SetModelType(val MTOServiceItemModelType) {
}

// MoveTaskOrderID gets the move task order ID of this subtype
func (m *MTOServiceItemDomesticShuttle) MoveTaskOrderID() *strfmt.UUID {
	return m.moveTaskOrderIdField
}

// SetMoveTaskOrderID sets the move task order ID of this subtype
func (m *MTOServiceItemDomesticShuttle) SetMoveTaskOrderID(val *strfmt.UUID) {
	m.moveTaskOrderIdField = val
}

// MtoShipmentID gets the mto shipment ID of this subtype
func (m *MTOServiceItemDomesticShuttle) MtoShipmentID() strfmt.UUID {
	return m.mtoShipmentIdField
}

// SetMtoShipmentID sets the mto shipment ID of this subtype
func (m *MTOServiceItemDomesticShuttle) SetMtoShipmentID(val strfmt.UUID) {
	m.mtoShipmentIdField = val
}

// ReServiceName gets the re service name of this subtype
func (m *MTOServiceItemDomesticShuttle) ReServiceName() string {
	return m.reServiceNameField
}

// SetReServiceName sets the re service name of this subtype
func (m *MTOServiceItemDomesticShuttle) SetReServiceName(val string) {
	m.reServiceNameField = val
}

// RejectionReason gets the rejection reason of this subtype
func (m *MTOServiceItemDomesticShuttle) RejectionReason() *string {
	return m.rejectionReasonField
}

// SetRejectionReason sets the rejection reason of this subtype
func (m *MTOServiceItemDomesticShuttle) SetRejectionReason(val *string) {
	m.rejectionReasonField = val
}

// ServiceRequestDocuments gets the service request documents of this subtype
func (m *MTOServiceItemDomesticShuttle) ServiceRequestDocuments() ServiceRequestDocuments {
	return m.serviceRequestDocumentsField
}

// SetServiceRequestDocuments sets the service request documents of this subtype
func (m *MTOServiceItemDomesticShuttle) SetServiceRequestDocuments(val ServiceRequestDocuments) {
	m.serviceRequestDocumentsField = val
}

// Status gets the status of this subtype
func (m *MTOServiceItemDomesticShuttle) Status() MTOServiceItemStatus {
	return m.statusField
}

// SetStatus sets the status of this subtype
func (m *MTOServiceItemDomesticShuttle) SetStatus(val MTOServiceItemStatus) {
	m.statusField = val
}

// UnmarshalJSON unmarshals this object with a polymorphic type from a JSON structure
func (m *MTOServiceItemDomesticShuttle) UnmarshalJSON(raw []byte) error {
	var data struct {
...
func (m MTOServiceItemDomesticShuttle) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
// Validate validates this m t o service item domestic shuttle
func (m *MTOServiceItemDomesticShuttle) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MTOServiceItemDomesticShuttle) validateID(formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) validateMoveTaskOrderID(formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) validateMtoShipmentID(formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) validateServiceRequestDocuments(formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) validateStatus(formats strfmt.Registry) error {
...
var mTOServiceItemDomesticShuttleTypeReServiceCodePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		mTOServiceItemDomesticShuttleTypeReServiceCodePropEnum = append(mTOServiceItemDomesticShuttleTypeReServiceCodePropEnum, v)
	}
}

// property enum
func (m *MTOServiceItemDomesticShuttle) validateReServiceCodeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, mTOServiceItemDomesticShuttleTypeReServiceCodePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *MTOServiceItemDomesticShuttle) validateReServiceCode(formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) validateReason(formats strfmt.Registry) error {
...
// ContextValidate validate this m t o service item domestic shuttle based on the context it is used
func (m *MTOServiceItemDomesticShuttle) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MTOServiceItemDomesticShuttle) contextValidateETag(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) contextValidateModelType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) contextValidateReServiceName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) contextValidateRejectionReason(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) contextValidateServiceRequestDocuments(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MTOServiceItemDomesticShuttle) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MTOServiceItemDomesticShuttle) UnmarshalBinary(b []byte) error {
	var res MTOServiceItemDomesticShuttle
