...
type MTOShipment struct {
	...
	// status
	// Read Only: true
	// Enum: [APPROVED SUBMITTED REJECTED CANCELLATION_REQUESTED CANCELED]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["APPROVED","SUBMITTED","REJECTED","CANCELLATION_REQUESTED","CANCELED"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
