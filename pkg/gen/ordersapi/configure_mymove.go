...
//go:generate swagger generate server --target ../../gen --name Mymove --spec ../../../swagger/orders.yaml --api-package ordersoperations --model-package ordersmessages --server-package ordersapi --principal interface{} --exclude-main
