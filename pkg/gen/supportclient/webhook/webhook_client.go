...
/*
PostNotification tests endpoint for notifications

Just a Test
*/
func (a *Client) PostNotification(params *PostNotificationParams) (*PostNotificationOK, error) {
	...
	success, ok := result.(*PostNotificationOK)
	if ok {
		return success, nil
	}
