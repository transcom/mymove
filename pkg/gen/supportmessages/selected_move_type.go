...
// ContextValidate validates this selected move type based on context it is used
func (m SelectedMoveType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
