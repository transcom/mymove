...
type UpdatePaymentRequestStatus struct {
	...
	// Attribute of the payment request object that automatically changes when the request is updated. Required when sending PUT or PATCH requests to prevent updating stale data. This matches the value passed in the header for If-Match.
