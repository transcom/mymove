...
func init() {
  ...
  "paths": {
    ...
    "/move-task-orders/{moveTaskOrderID}": {
      "get": {
        "description": "Gets an individual move task order by ID. \u003cbr /\u003e \u003cbr /\u003e This is a support endpoint and will not be available in production.\n",
        "produces": [
          "application/json"
        ],
        "tags": [
    ...
    "/move-task-orders/{moveTaskOrderID}/status": {
      "patch": {
        "description": "Updates move task order ` + "`" + `isAvailableToPrime` + "`" + ` to TRUE to make it available to prime. \u003cbr /\u003e \u003cbr /\u003e This is a support endpoint and will not be available in production.\n",
        "consumes": [
          "application/json"
        ],
        "produces": [
    ...
    "/payment-requests/{paymentRequestID}/status": {
      "patch": {
        "description": "Updates status of a payment request to REVIEWED, SENT_TO_GEX, RECEIVED_BY_GEX, or PAID. A status of REVIEWED can optionally have a ` + "`" + `rejectionReason` + "`" + `. \u003cbr /\u003e \u003cbr /\u003e This is a support endpoint and will not be available in production.\n",
        "consumes": [
          "application/json"
        ],
        "produces": [
    ...
    "/service-items/{mtoServiceItemID}/status": {
      "patch": {
        "description": "Updates the status of a service item for a move order to APPROVED or REJECTED. \u003cbr /\u003e \u003cbr /\u003e This is a support endpoint and will not be available in production.\n",
        "consumes": [
          "application/json"
        ],
        "produces": [
