...
func configureAPI(api *supportoperations.MymoveAPI) http.Handler {
	...
	if api.WebhookPostNotificationHandler == nil {
		api.WebhookPostNotificationHandler = webhook.PostNotificationHandlerFunc(func(params webhook.PostNotificationParams) middleware.Responder {
			return middleware.NotImplemented("operation webhook.PostNotification has not yet been implemented")
		})
	}
