...
type GetMoveTaskOrderCustomerOK struct {
	...
	/*
	  In: Body
	*/
	Payload *supportmessages.Customer `json:"body,omitempty"`
}
...
func (o *GetMoveTaskOrderCustomerOK) WithPayload(payload *supportmessages.Customer) *GetMoveTaskOrderCustomerOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get move task order customer o k response
func (o *GetMoveTaskOrderCustomerOK) SetPayload(payload *supportmessages.Customer) {
	o.Payload = payload
}
...
func (o *GetMoveTaskOrderCustomerUnprocessableEntity) WithPayload(payload *supportmessages.ValidationError) *GetMoveTaskOrderCustomerUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get move task order customer unprocessable entity response
func (o *GetMoveTaskOrderCustomerUnprocessableEntity) SetPayload(payload *supportmessages.ValidationError) {
	o.Payload = payload
}
