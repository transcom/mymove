...
func (o *UpdateMTOPostCounselingInformationOK) WithPayload(payload *supportmessages.MoveTaskOrder) *UpdateMTOPostCounselingInformationOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o post counseling information o k response
func (o *UpdateMTOPostCounselingInformationOK) SetPayload(payload *supportmessages.MoveTaskOrder) {
	o.Payload = payload
}
...
func (o *UpdateMTOPostCounselingInformationUnprocessableEntity) WithPayload(payload *supportmessages.ValidationError) *UpdateMTOPostCounselingInformationUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o post counseling information unprocessable entity response
func (o *UpdateMTOPostCounselingInformationUnprocessableEntity) SetPayload(payload *supportmessages.ValidationError) {
	o.Payload = payload
}
