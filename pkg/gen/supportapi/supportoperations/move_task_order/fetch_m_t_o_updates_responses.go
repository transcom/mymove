...
func (o *FetchMTOUpdatesOK) WithPayload(payload supportmessages.MoveTaskOrders) *FetchMTOUpdatesOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the fetch m t o updates o k response
func (o *FetchMTOUpdatesOK) SetPayload(payload supportmessages.MoveTaskOrders) {
	o.Payload = payload
}
