...
func NewMymoveAPI(spec *loads.Document) *MymoveAPI {
	return &MymoveAPI{
		...
		WebhookPostNotificationHandler: webhook.PostNotificationHandlerFunc(func(params webhook.PostNotificationParams) middleware.Responder {
			return middleware.NotImplemented("operation WebhookPostNotification has not yet been implemented")
		}),
...
type MymoveAPI struct {
	...
	// WebhookPostNotificationHandler sets the operation handler for the post notification operation
	WebhookPostNotificationHandler webhook.PostNotificationHandler
...
func (o *MymoveAPI) Validate() error {
	...
	if o.WebhookPostNotificationHandler == nil {
		unregistered = append(unregistered, "webhook.PostNotificationHandler")
	}
...
func (o *MymoveAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/webhook-notify"] = webhook.NewPostNotification(o.context, o.WebhookPostNotificationHandler)
