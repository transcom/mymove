...
func (o *CreatePaymentRequestCreated) WithPayload(payload *supportmessages.PaymentRequest) *CreatePaymentRequestCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create payment request created response
func (o *CreatePaymentRequestCreated) SetPayload(payload *supportmessages.PaymentRequest) {
	o.Payload = payload
}
