...
func (o *CreateMTOServiceItemOK) WithPayload(payload supportmessages.MTOServiceItem) *CreateMTOServiceItemOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o service item o k response
func (o *CreateMTOServiceItemOK) SetPayload(payload supportmessages.MTOServiceItem) {
	o.Payload = payload
}
...
func (o *CreateMTOServiceItemUnprocessableEntity) WithPayload(payload *supportmessages.ValidationError) *CreateMTOServiceItemUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o service item unprocessable entity response
func (o *CreateMTOServiceItemUnprocessableEntity) SetPayload(payload *supportmessages.ValidationError) {
	o.Payload = payload
}
