...
// Report Report for Navy PPTAS, contains information about Service Members, Orders, Move Task Orders, Shipments, and Payment Requests.
//
...
func (m *Report) validateAddress(formats strfmt.Registry) error {
...
func (m *Report) validateAffiliation(formats strfmt.Registry) error {
...
func (m *Report) validateCounseledDate(formats strfmt.Registry) error {
...
func (m *Report) validateCratingDimensions(formats strfmt.Registry) error {
...
func (m *Report) validateDd2278IssueDate(formats strfmt.Registry) error {
...
func (m *Report) validateDeliveryDate(formats strfmt.Registry) error {
...
func (m *Report) validateDestinationAddress(formats strfmt.Registry) error {
...
func (m *Report) validateDestinationGbloc(formats strfmt.Registry) error {
...
func (m *Report) validateMoveDate(formats strfmt.Registry) error {
...
func (m *Report) validateOrdersDate(formats strfmt.Registry) error {
...
func (m *Report) validateOriginAddress(formats strfmt.Registry) error {
...
func (m *Report) validateOriginGbloc(formats strfmt.Registry) error {
...
func (m *Report) validatePaidDate(formats strfmt.Registry) error {
...
var reportTypePayGradePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		reportTypePayGradePropEnum = append(reportTypePayGradePropEnum, v)
	}
}

const (

	// ReportPayGradeE1 captures enum value "E_1"
	ReportPayGradeE1 string = "E_1"

	// ReportPayGradeE2 captures enum value "E_2"
	ReportPayGradeE2 string = "E_2"

	// ReportPayGradeE3 captures enum value "E_3"
	ReportPayGradeE3 string = "E_3"

	// ReportPayGradeE4 captures enum value "E_4"
	ReportPayGradeE4 string = "E_4"

	// ReportPayGradeE5 captures enum value "E_5"
	ReportPayGradeE5 string = "E_5"

	// ReportPayGradeE6 captures enum value "E_6"
	ReportPayGradeE6 string = "E_6"

	// ReportPayGradeE7 captures enum value "E_7"
	ReportPayGradeE7 string = "E_7"

	// ReportPayGradeE8 captures enum value "E_8"
	ReportPayGradeE8 string = "E_8"

	// ReportPayGradeE9 captures enum value "E_9"
	ReportPayGradeE9 string = "E_9"

	// ReportPayGradeE9SPECIALSENIORENLISTED captures enum value "E_9_SPECIAL_SENIOR_ENLISTED"
	ReportPayGradeE9SPECIALSENIORENLISTED string = "E_9_SPECIAL_SENIOR_ENLISTED"

	// ReportPayGradeO1ACADEMYGRADUATE captures enum value "O_1_ACADEMY_GRADUATE"
	ReportPayGradeO1ACADEMYGRADUATE string = "O_1_ACADEMY_GRADUATE"

	// ReportPayGradeO2 captures enum value "O_2"
	ReportPayGradeO2 string = "O_2"

	// ReportPayGradeO3 captures enum value "O_3"
	ReportPayGradeO3 string = "O_3"

	// ReportPayGradeO4 captures enum value "O_4"
	ReportPayGradeO4 string = "O_4"

	// ReportPayGradeO5 captures enum value "O_5"
	ReportPayGradeO5 string = "O_5"

	// ReportPayGradeO6 captures enum value "O_6"
	ReportPayGradeO6 string = "O_6"

	// ReportPayGradeO7 captures enum value "O_7"
	ReportPayGradeO7 string = "O_7"

	// ReportPayGradeO8 captures enum value "O_8"
	ReportPayGradeO8 string = "O_8"

	// ReportPayGradeO9 captures enum value "O_9"
	ReportPayGradeO9 string = "O_9"

	// ReportPayGradeO10 captures enum value "O_10"
	ReportPayGradeO10 string = "O_10"

	// ReportPayGradeW1 captures enum value "W_1"
	ReportPayGradeW1 string = "W_1"

	// ReportPayGradeW2 captures enum value "W_2"
	ReportPayGradeW2 string = "W_2"

	// ReportPayGradeW3 captures enum value "W_3"
	ReportPayGradeW3 string = "W_3"

	// ReportPayGradeW4 captures enum value "W_4"
	ReportPayGradeW4 string = "W_4"

	// ReportPayGradeW5 captures enum value "W_5"
	ReportPayGradeW5 string = "W_5"

	// ReportPayGradeAVIATIONCADET captures enum value "AVIATION_CADET"
	ReportPayGradeAVIATIONCADET string = "AVIATION_CADET"

	// ReportPayGradeCIVILIANEMPLOYEE captures enum value "CIVILIAN_EMPLOYEE"
	ReportPayGradeCIVILIANEMPLOYEE string = "CIVILIAN_EMPLOYEE"

	// ReportPayGradeACADEMYCADET captures enum value "ACADEMY_CADET"
	ReportPayGradeACADEMYCADET string = "ACADEMY_CADET"

	// ReportPayGradeMIDSHIPMAN captures enum value "MIDSHIPMAN"
	ReportPayGradeMIDSHIPMAN string = "MIDSHIPMAN"
)

// prop value enum
func (m *Report) validatePayGradeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, reportTypePayGradePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Report) validatePayGrade(formats strfmt.Registry) error {
...
func (m *Report) validatePickupDate(formats strfmt.Registry) error {
...
func (m *Report) validateShipmentID(formats strfmt.Registry) error {
...
func (m *Report) validateSitInDate(formats strfmt.Registry) error {
...
func (m *Report) validateSitOutDate(formats strfmt.Registry) error {
...
func (m *Report) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Report) contextValidateAffiliation(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Report) contextValidateCratingDimensions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Report) contextValidateDestinationAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Report) contextValidateOriginAddress(ctx context.Context, formats strfmt.Registry) error {
