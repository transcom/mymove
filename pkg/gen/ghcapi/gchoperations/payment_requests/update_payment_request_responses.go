...
func (o *UpdatePaymentRequestBadRequest) WithPayload(payload *ghcmessages.Error) *UpdatePaymentRequestBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update payment request bad request response
func (o *UpdatePaymentRequestBadRequest) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *UpdatePaymentRequestUnauthorized) WithPayload(payload *ghcmessages.Error) *UpdatePaymentRequestUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update payment request unauthorized response
func (o *UpdatePaymentRequestUnauthorized) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *UpdatePaymentRequestForbidden) WithPayload(payload *ghcmessages.Error) *UpdatePaymentRequestForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update payment request forbidden response
func (o *UpdatePaymentRequestForbidden) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *UpdatePaymentRequestNotFound) WithPayload(payload *ghcmessages.Error) *UpdatePaymentRequestNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update payment request not found response
func (o *UpdatePaymentRequestNotFound) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *UpdatePaymentRequestInternalServerError) WithPayload(payload *ghcmessages.Error) *UpdatePaymentRequestInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update payment request internal server error response
func (o *UpdatePaymentRequestInternalServerError) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
