...
func (o *CreatePaymentRequestBadRequest) WithPayload(payload *ghcmessages.Error) *CreatePaymentRequestBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create payment request bad request response
func (o *CreatePaymentRequestBadRequest) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *CreatePaymentRequestUnauthorized) WithPayload(payload *ghcmessages.Error) *CreatePaymentRequestUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create payment request unauthorized response
func (o *CreatePaymentRequestUnauthorized) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *CreatePaymentRequestForbidden) WithPayload(payload *ghcmessages.Error) *CreatePaymentRequestForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create payment request forbidden response
func (o *CreatePaymentRequestForbidden) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *CreatePaymentRequestNotFound) WithPayload(payload *ghcmessages.Error) *CreatePaymentRequestNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create payment request not found response
func (o *CreatePaymentRequestNotFound) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *CreatePaymentRequestInternalServerError) WithPayload(payload *ghcmessages.Error) *CreatePaymentRequestInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create payment request internal server error response
func (o *CreatePaymentRequestInternalServerError) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
