...
func (o *DeleteServiceItemBadRequest) WithPayload(payload *ghcmessages.Error) *DeleteServiceItemBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete service item bad request response
func (o *DeleteServiceItemBadRequest) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *DeleteServiceItemUnauthorized) WithPayload(payload *ghcmessages.Error) *DeleteServiceItemUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete service item unauthorized response
func (o *DeleteServiceItemUnauthorized) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *DeleteServiceItemForbidden) WithPayload(payload *ghcmessages.Error) *DeleteServiceItemForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete service item forbidden response
func (o *DeleteServiceItemForbidden) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *DeleteServiceItemNotFound) WithPayload(payload *ghcmessages.Error) *DeleteServiceItemNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete service item not found response
func (o *DeleteServiceItemNotFound) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *DeleteServiceItemInternalServerError) WithPayload(payload *ghcmessages.Error) *DeleteServiceItemInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete service item internal server error response
func (o *DeleteServiceItemInternalServerError) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
