...
func (o *UpdateServiceItemBadRequest) WithPayload(payload *ghcmessages.Error) *UpdateServiceItemBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update service item bad request response
func (o *UpdateServiceItemBadRequest) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *UpdateServiceItemUnauthorized) WithPayload(payload *ghcmessages.Error) *UpdateServiceItemUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update service item unauthorized response
func (o *UpdateServiceItemUnauthorized) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *UpdateServiceItemForbidden) WithPayload(payload *ghcmessages.Error) *UpdateServiceItemForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update service item forbidden response
func (o *UpdateServiceItemForbidden) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *UpdateServiceItemNotFound) WithPayload(payload *ghcmessages.Error) *UpdateServiceItemNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update service item not found response
func (o *UpdateServiceItemNotFound) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *UpdateServiceItemInternalServerError) WithPayload(payload *ghcmessages.Error) *UpdateServiceItemInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update service item internal server error response
func (o *UpdateServiceItemInternalServerError) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
