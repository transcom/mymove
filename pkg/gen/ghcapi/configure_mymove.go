...
func configureAPI(api *ghcoperations.MymoveAPI) http.Handler {
	...
	if api.PaymentRequestsUpdateReviewedPaymentRequestStatusHandler == nil {
		api.PaymentRequestsUpdateReviewedPaymentRequestStatusHandler = payment_requests.UpdateReviewedPaymentRequestStatusHandlerFunc(func(params payment_requests.UpdateReviewedPaymentRequestStatusParams) middleware.Responder {
