...
func configureAPI(api *ghcoperations.MymoveAPI) http.Handler {
	...
	if api.MoveTaskOrderUpdateDestinationAddressHandler == nil {
		api.MoveTaskOrderUpdateDestinationAddressHandler = move_task_order.UpdateDestinationAddressHandlerFunc(func(params move_task_order.UpdateDestinationAddressParams) middleware.Responder {
			return middleware.NotImplemented("operation move_task_order.UpdateDestinationAddress has not yet been implemented")
		})
	}
	...
	if api.MoveTaskOrderUpdatePostCounselingInfoHandler == nil {
		api.MoveTaskOrderUpdatePostCounselingInfoHandler = move_task_order.UpdatePostCounselingInfoHandlerFunc(func(params move_task_order.UpdatePostCounselingInfoParams) middleware.Responder {
			return middleware.NotImplemented("operation move_task_order.UpdatePostCounselingInfo has not yet been implemented")
		})
	}
