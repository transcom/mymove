...
func init() {
  ...
  "paths": {
    ...
    "/move-task-orders/{moveTaskOrderID}/destination-address": {
      "patch": {
        "description": "Updates a move task order's destination address by ID",
        "consumes": [
          "application/json"
        ],
        "produces": [
        ...
        "summary": "Updates a move task order's destination address",
        "operationId": "updateDestinationAddress",
        "parameters": [
          {
            "name": "body",
            "in": "body",
    ...
    "/move-task-orders/{moveTaskOrderID}/post-counseling": {
      "patch": {
        "description": "Updates a move task order's post counseling info by ID",
        "consumes": [
          "application/json"
        ],
        "produces": [
        ...
        "summary": "Updates a move task order's post counseling info such as scheduled move date, secondary and pickup and delivery addresses, and whether or not the PPM is included",
        "operationId": "updatePostCounselingInfo",
        "parameters": [
          {
            "name": "body",
            "in": "body",
