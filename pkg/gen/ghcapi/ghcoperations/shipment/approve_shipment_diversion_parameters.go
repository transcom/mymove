...
func NewApproveShipmentDiversionParams() ApproveShipmentDiversionParams {
	...
	return ApproveShipmentDiversionParams{}
}

// ApproveShipmentDiversionParams contains all the bound params for the approve shipment diversion operation
...
func (o *ApproveShipmentDiversionParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ApproveShipmentDiversionParams) bindShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ApproveShipmentDiversionParams) validateShipmentID(formats strfmt.Registry) error {
