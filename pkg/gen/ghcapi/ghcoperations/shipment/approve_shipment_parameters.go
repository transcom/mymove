...
func NewApproveShipmentParams() ApproveShipmentParams {
	...
	return ApproveShipmentParams{}
}

// ApproveShipmentParams contains all the bound params for the approve shipment operation
...
func (o *ApproveShipmentParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ApproveShipmentParams) bindShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ApproveShipmentParams) validateShipmentID(formats strfmt.Registry) error {
