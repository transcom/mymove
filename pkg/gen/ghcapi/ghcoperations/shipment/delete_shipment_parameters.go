...
func (o *DeleteShipmentParams) bindShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteShipmentParams) validateShipmentID(formats strfmt.Registry) error {
