...
func (o *CreateApprovedSITDurationUpdateURL) Build() (*url.URL, error) {
	...
	if shipmentID != "" {
		...
		return nil, errors.New("shipmentId is required on CreateApprovedSITDurationUpdateURL")
	}
...
func (o *CreateApprovedSITDurationUpdateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateApprovedSITDurationUpdateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateApprovedSITDurationUpdateURL")
	}
