...
func NewCreateApprovedSITDurationUpdateParams() CreateApprovedSITDurationUpdateParams {
	...
	return CreateApprovedSITDurationUpdateParams{}
}

// CreateApprovedSITDurationUpdateParams contains all the bound params for the create approved s i t duration update operation
...
func (o *CreateApprovedSITDurationUpdateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body ghcmessages.CreateApprovedSITDurationUpdate
...
func (o *CreateApprovedSITDurationUpdateParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CreateApprovedSITDurationUpdateParams) bindShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateApprovedSITDurationUpdateParams) validateShipmentID(formats strfmt.Registry) error {
