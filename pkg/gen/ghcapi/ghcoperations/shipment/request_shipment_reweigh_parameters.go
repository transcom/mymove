...
func NewRequestShipmentReweighParams() RequestShipmentReweighParams {
	...
	return RequestShipmentReweighParams{}
}

// RequestShipmentReweighParams contains all the bound params for the request shipment reweigh operation
...
func (o *RequestShipmentReweighParams) bindShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RequestShipmentReweighParams) validateShipmentID(formats strfmt.Registry) error {
