...
// RequestShipmentCancellationParams contains all the bound params for the request shipment cancellation operation
...
func (o *RequestShipmentCancellationParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *RequestShipmentCancellationParams) bindShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RequestShipmentCancellationParams) validateShipmentID(formats strfmt.Registry) error {
