...
func NewReviewShipmentAddressUpdateParams() ReviewShipmentAddressUpdateParams {
	...
	return ReviewShipmentAddressUpdateParams{}
}

// ReviewShipmentAddressUpdateParams contains all the bound params for the review shipment address update operation
...
func (o *ReviewShipmentAddressUpdateParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReviewShipmentAddressUpdateParams) bindShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReviewShipmentAddressUpdateParams) validateShipmentID(formats strfmt.Registry) error {
