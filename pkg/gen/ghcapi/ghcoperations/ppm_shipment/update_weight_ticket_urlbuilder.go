...
func (o *UpdateWeightTicketURL) Build() (*url.URL, error) {
	...
	if ppmShipmentID != "" {
		...
		return nil, errors.New("ppmShipmentId is required on UpdateWeightTicketURL")
	}
	...
	if weightTicketID != "" {
		...
		return nil, errors.New("weightTicketId is required on UpdateWeightTicketURL")
	}
...
func (o *UpdateWeightTicketURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateWeightTicketURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateWeightTicketURL")
	}
