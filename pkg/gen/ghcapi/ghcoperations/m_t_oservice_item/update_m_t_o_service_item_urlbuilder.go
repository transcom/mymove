...
func (o *UpdateMTOServiceItemURL) WithBasePath(bp string) *UpdateMTOServiceItemURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateMTOServiceItemURL) Build() (*url.URL, error) {
	...
	if moveTaskOrderID != "" {
		...
		return nil, errors.New("moveTaskOrderId is required on UpdateMTOServiceItemURL")
	}
	...
	if mtoServiceItemID != "" {
		...
		return nil, errors.New("mtoServiceItemId is required on UpdateMTOServiceItemURL")
	}
...
func (o *UpdateMTOServiceItemURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateMTOServiceItemURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateMTOServiceItemURL")
	}
