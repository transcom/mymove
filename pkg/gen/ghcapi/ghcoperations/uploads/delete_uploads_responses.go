...
func (o *DeleteUploadsBadRequest) WithPayload(payload *ghcmessages.InvalidRequestResponsePayload) *DeleteUploadsBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete uploads bad request response
func (o *DeleteUploadsBadRequest) SetPayload(payload *ghcmessages.InvalidRequestResponsePayload) {
	o.Payload = payload
}
