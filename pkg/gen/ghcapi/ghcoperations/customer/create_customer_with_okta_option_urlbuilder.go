...
func (o *CreateCustomerWithOktaOptionURL) WithBasePath(bp string) *CreateCustomerWithOktaOptionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateCustomerWithOktaOptionURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *CreateCustomerWithOktaOptionURL) String() string {
...
func (o *CreateCustomerWithOktaOptionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateCustomerWithOktaOptionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateCustomerWithOktaOptionURL")
	}
