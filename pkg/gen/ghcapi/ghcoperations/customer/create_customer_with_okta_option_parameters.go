...
func NewCreateCustomerWithOktaOptionParams() CreateCustomerWithOktaOptionParams {
	...
	return CreateCustomerWithOktaOptionParams{}
}

// CreateCustomerWithOktaOptionParams contains all the bound params for the create customer with okta option operation
...
func (o *CreateCustomerWithOktaOptionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body ghcmessages.CreateCustomerPayload
