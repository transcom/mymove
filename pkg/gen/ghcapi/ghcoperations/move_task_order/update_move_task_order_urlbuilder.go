...
type UpdateMoveTaskOrderURL struct {
...
func (o *UpdateMoveTaskOrderURL) Build() (*url.URL, error) {
	...
	if moveTaskOrderID != "" {
		...
		return nil, errors.New("moveTaskOrderId is required on UpdateMoveTaskOrderURL")
	}
...
func (o *UpdateMoveTaskOrderURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateMoveTaskOrderURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateMoveTaskOrderURL")
	}
