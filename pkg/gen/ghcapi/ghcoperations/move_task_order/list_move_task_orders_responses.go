...
func (o *ListMoveTaskOrdersBadRequest) WithPayload(payload *ghcmessages.InvalidRequest) *ListMoveTaskOrdersBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list move task orders bad request response
func (o *ListMoveTaskOrdersBadRequest) SetPayload(payload *ghcmessages.InvalidRequest) {
	o.Payload = payload
}
...
func (o *ListMoveTaskOrdersUnauthorized) WithPayload(payload *ghcmessages.PermissionDenied) *ListMoveTaskOrdersUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list move task orders unauthorized response
func (o *ListMoveTaskOrdersUnauthorized) SetPayload(payload *ghcmessages.PermissionDenied) {
	o.Payload = payload
}
...
func (o *ListMoveTaskOrdersForbidden) WithPayload(payload *ghcmessages.PermissionDenied) *ListMoveTaskOrdersForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list move task orders forbidden response
func (o *ListMoveTaskOrdersForbidden) SetPayload(payload *ghcmessages.PermissionDenied) {
	o.Payload = payload
}
...
func (o *ListMoveTaskOrdersNotFound) WithPayload(payload *ghcmessages.NotFound) *ListMoveTaskOrdersNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list move task orders not found response
func (o *ListMoveTaskOrdersNotFound) SetPayload(payload *ghcmessages.NotFound) {
	o.Payload = payload
}
...
func (o *ListMoveTaskOrdersInternalServerError) WithPayload(payload *ghcmessages.ServerError) *ListMoveTaskOrdersInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list move task orders internal server error response
func (o *ListMoveTaskOrdersInternalServerError) SetPayload(payload *ghcmessages.ServerError) {
	o.Payload = payload
}
