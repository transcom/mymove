...
func (o *UpdateMoveTaskOrderBadRequest) WithPayload(payload *ghcmessages.InvalidRequest) *UpdateMoveTaskOrderBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update move task order bad request response
func (o *UpdateMoveTaskOrderBadRequest) SetPayload(payload *ghcmessages.InvalidRequest) {
	o.Payload = payload
}
...
func (o *UpdateMoveTaskOrderUnauthorized) WithPayload(payload *ghcmessages.PermissionDenied) *UpdateMoveTaskOrderUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update move task order unauthorized response
func (o *UpdateMoveTaskOrderUnauthorized) SetPayload(payload *ghcmessages.PermissionDenied) {
	o.Payload = payload
}
...
func (o *UpdateMoveTaskOrderForbidden) WithPayload(payload *ghcmessages.PermissionDenied) *UpdateMoveTaskOrderForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update move task order forbidden response
func (o *UpdateMoveTaskOrderForbidden) SetPayload(payload *ghcmessages.PermissionDenied) {
	o.Payload = payload
}
...
func (o *UpdateMoveTaskOrderNotFound) WithPayload(payload *ghcmessages.NotFound) *UpdateMoveTaskOrderNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update move task order not found response
func (o *UpdateMoveTaskOrderNotFound) SetPayload(payload *ghcmessages.NotFound) {
	o.Payload = payload
}
...
func (o *UpdateMoveTaskOrderInternalServerError) WithPayload(payload *ghcmessages.ServerError) *UpdateMoveTaskOrderInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update move task order internal server error response
func (o *UpdateMoveTaskOrderInternalServerError) SetPayload(payload *ghcmessages.ServerError) {
	o.Payload = payload
}
