...
func NewUpdateMTOReviewedBillableWeightsAtParams() UpdateMTOReviewedBillableWeightsAtParams {
	...
	return UpdateMTOReviewedBillableWeightsAtParams{}
}
...
func (o *UpdateMTOReviewedBillableWeightsAtParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdateMTOReviewedBillableWeightsAtParams) bindMoveTaskOrderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
