...
func (o *AssociateReportViolationsURL) WithBasePath(bp string) *AssociateReportViolationsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *AssociateReportViolationsURL) Build() (*url.URL, error) {
	...
	var _path = "/report-violations/{reportID}"

	reportID := o.ReportID.String()
	if reportID != "" {
		_path = strings.Replace(_path, "{reportID}", reportID, -1)
	} else {
		return nil, errors.New("reportId is required on AssociateReportViolationsURL")
	}
...
func (o *AssociateReportViolationsURL) String() string {
...
func (o *AssociateReportViolationsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on AssociateReportViolationsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on AssociateReportViolationsURL")
	}
