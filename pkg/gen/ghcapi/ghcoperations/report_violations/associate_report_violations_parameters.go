...
func NewAssociateReportViolationsParams() AssociateReportViolationsParams {
	...
	return AssociateReportViolationsParams{}
}

// AssociateReportViolationsParams contains all the bound params for the associate report violations operation
...
func (o *AssociateReportViolationsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body ghcmessages.AssociateReportViolations
...
func (o *AssociateReportViolationsParams) bindReportID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *AssociateReportViolationsParams) validateReportID(formats strfmt.Registry) error {
