...
func (o *CreateRequestedOfficeUserURL) WithBasePath(bp string) *CreateRequestedOfficeUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateRequestedOfficeUserURL) String() string {
...
func (o *CreateRequestedOfficeUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateRequestedOfficeUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateRequestedOfficeUserURL")
	}
