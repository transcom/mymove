...
/*
	UpdateOfficeUser swagger:route PATCH /office-users/{officeUserId} officeUsers updateOfficeUser

# Updates an Office User

This endpoint updates a single Office User by ID. This is to be used by office users to update their profile.
*/
