...
// UpdateAllowanceBadRequestCode is the HTTP code returned for type UpdateAllowanceBadRequest
const UpdateAllowanceBadRequestCode int = 400

/*UpdateAllowanceBadRequest The request payload is invalid

swagger:response updateAllowanceBadRequest
*/
type UpdateAllowanceBadRequest struct {
...
// NewUpdateAllowanceBadRequest creates UpdateAllowanceBadRequest with default headers values
func NewUpdateAllowanceBadRequest() *UpdateAllowanceBadRequest {

	return &UpdateAllowanceBadRequest{}
}

// WithPayload adds the payload to the update allowance bad request response
func (o *UpdateAllowanceBadRequest) WithPayload(payload *ghcmessages.Error) *UpdateAllowanceBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update allowance bad request response
func (o *UpdateAllowanceBadRequest) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *UpdateAllowanceBadRequest) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
// UpdateAllowanceUnauthorizedCode is the HTTP code returned for type UpdateAllowanceUnauthorized
const UpdateAllowanceUnauthorizedCode int = 401

/*UpdateAllowanceUnauthorized The request was unauthorized

swagger:response updateAllowanceUnauthorized
*/
type UpdateAllowanceUnauthorized struct {
...
// NewUpdateAllowanceUnauthorized creates UpdateAllowanceUnauthorized with default headers values
func NewUpdateAllowanceUnauthorized() *UpdateAllowanceUnauthorized {

	return &UpdateAllowanceUnauthorized{}
}

// WithPayload adds the payload to the update allowance unauthorized response
func (o *UpdateAllowanceUnauthorized) WithPayload(payload *ghcmessages.Error) *UpdateAllowanceUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update allowance unauthorized response
func (o *UpdateAllowanceUnauthorized) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *UpdateAllowanceUnauthorized) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
