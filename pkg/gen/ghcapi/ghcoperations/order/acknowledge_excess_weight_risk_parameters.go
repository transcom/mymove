...
func NewAcknowledgeExcessWeightRiskParams() AcknowledgeExcessWeightRiskParams {
	...
	return AcknowledgeExcessWeightRiskParams{}
}

// AcknowledgeExcessWeightRiskParams contains all the bound params for the acknowledge excess weight risk operation
...
func (o *AcknowledgeExcessWeightRiskParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AcknowledgeExcessWeightRiskParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *AcknowledgeExcessWeightRiskParams) bindOrderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AcknowledgeExcessWeightRiskParams) validateOrderID(formats strfmt.Registry) error {
