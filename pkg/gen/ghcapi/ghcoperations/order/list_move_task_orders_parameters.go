...
func (o *ListMoveTaskOrdersParams) bindOrderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ListMoveTaskOrdersParams) validateOrderID(formats strfmt.Registry) error {
