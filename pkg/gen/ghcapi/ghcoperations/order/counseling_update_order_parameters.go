...
func NewCounselingUpdateOrderParams() CounselingUpdateOrderParams {
	...
	return CounselingUpdateOrderParams{}
}

// CounselingUpdateOrderParams contains all the bound params for the counseling update order operation
...
func (o *CounselingUpdateOrderParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body ghcmessages.CounselingUpdateOrderPayload
...
func (o *CounselingUpdateOrderParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CounselingUpdateOrderParams) bindOrderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CounselingUpdateOrderParams) validateOrderID(formats strfmt.Registry) error {
