...
func NewUpdateBillableWeightParams() UpdateBillableWeightParams {
	...
	return UpdateBillableWeightParams{}
}

// UpdateBillableWeightParams contains all the bound params for the update billable weight operation
...
func (o *UpdateBillableWeightParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body ghcmessages.UpdateBillableWeightPayload
...
func (o *UpdateBillableWeightParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdateBillableWeightParams) bindOrderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateBillableWeightParams) validateOrderID(formats strfmt.Registry) error {
