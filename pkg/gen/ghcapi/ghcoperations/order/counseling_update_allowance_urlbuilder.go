...
func (o *CounselingUpdateAllowanceURL) WithBasePath(bp string) *CounselingUpdateAllowanceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CounselingUpdateAllowanceURL) Build() (*url.URL, error) {
	...
	var _path = "/counseling/orders/{orderID}/allowances"

	orderID := o.OrderID.String()
	if orderID != "" {
		_path = strings.Replace(_path, "{orderID}", orderID, -1)
	} else {
		return nil, errors.New("orderId is required on CounselingUpdateAllowanceURL")
	}
...
func (o *CounselingUpdateAllowanceURL) String() string {
...
func (o *CounselingUpdateAllowanceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CounselingUpdateAllowanceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CounselingUpdateAllowanceURL")
	}
