...
func NewCounselingUpdateAllowanceParams() CounselingUpdateAllowanceParams {
	...
	return CounselingUpdateAllowanceParams{}
}

// CounselingUpdateAllowanceParams contains all the bound params for the counseling update allowance operation
...
func (o *CounselingUpdateAllowanceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body ghcmessages.CounselingUpdateAllowancePayload
...
func (o *CounselingUpdateAllowanceParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CounselingUpdateAllowanceParams) bindOrderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CounselingUpdateAllowanceParams) validateOrderID(formats strfmt.Registry) error {
