...
func (o *CounselingUpdateOrderURL) WithBasePath(bp string) *CounselingUpdateOrderURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CounselingUpdateOrderURL) Build() (*url.URL, error) {
	...
	var _path = "/counseling/orders/{orderID}"

	orderID := o.OrderID.String()
	if orderID != "" {
		_path = strings.Replace(_path, "{orderID}", orderID, -1)
	} else {
		return nil, errors.New("orderId is required on CounselingUpdateOrderURL")
	}
...
func (o *CounselingUpdateOrderURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CounselingUpdateOrderURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CounselingUpdateOrderURL")
	}
