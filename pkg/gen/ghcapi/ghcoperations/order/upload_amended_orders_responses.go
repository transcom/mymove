...
func (o *UploadAmendedOrdersCreated) WithPayload(payload *ghcmessages.Upload) *UploadAmendedOrdersCreated {
	o.Payload = payload
	return o
}
...
func (o *UploadAmendedOrdersBadRequest) WithPayload(payload *ghcmessages.InvalidRequestResponsePayload) *UploadAmendedOrdersBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the upload amended orders bad request response
func (o *UploadAmendedOrdersBadRequest) SetPayload(payload *ghcmessages.InvalidRequestResponsePayload) {
	o.Payload = payload
}
