...
func (o *UpdateBillableWeightURL) WithBasePath(bp string) *UpdateBillableWeightURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateBillableWeightURL) Build() (*url.URL, error) {
	...
	var _path = "/orders/{orderID}/update-billable-weight"

	orderID := o.OrderID.String()
	if orderID != "" {
		_path = strings.Replace(_path, "{orderID}", orderID, -1)
	} else {
		return nil, errors.New("orderId is required on UpdateBillableWeightURL")
	}
...
func (o *UpdateBillableWeightURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateBillableWeightURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateBillableWeightURL")
	}
