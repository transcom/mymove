...
func NewDeleteAssignedOfficeUserParams() DeleteAssignedOfficeUserParams {
	...
	return DeleteAssignedOfficeUserParams{}
}

// DeleteAssignedOfficeUserParams contains all the bound params for the delete assigned office user operation
...
func (o *DeleteAssignedOfficeUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body DeleteAssignedOfficeUserBody
...
func (o *DeleteAssignedOfficeUserParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteAssignedOfficeUserParams) validateMoveID(formats strfmt.Registry) error {
