...
func (o *UpdateAssignedOfficeUserURL) WithBasePath(bp string) *UpdateAssignedOfficeUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateAssignedOfficeUserURL) Build() (*url.URL, error) {
	...
	var _path = "/moves/{moveID}/assignOfficeUser"

	moveID := o.MoveID.String()
	if moveID != "" {
		_path = strings.Replace(_path, "{moveID}", moveID, -1)
	} else {
		return nil, errors.New("moveId is required on UpdateAssignedOfficeUserURL")
	}
...
func (o *UpdateAssignedOfficeUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateAssignedOfficeUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateAssignedOfficeUserURL")
	}
