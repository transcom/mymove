...
func NewUpdateAssignedOfficeUserParams() UpdateAssignedOfficeUserParams {
	...
	return UpdateAssignedOfficeUserParams{}
}

// UpdateAssignedOfficeUserParams contains all the bound params for the update assigned office user operation
...
func (o *UpdateAssignedOfficeUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body ghcmessages.AssignOfficeUserBody
...
func (o *UpdateAssignedOfficeUserParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateAssignedOfficeUserParams) validateMoveID(formats strfmt.Registry) error {
