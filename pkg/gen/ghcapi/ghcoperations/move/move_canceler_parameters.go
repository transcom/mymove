...
func NewMoveCancelerParams() MoveCancelerParams {
	...
	return MoveCancelerParams{}
}

// MoveCancelerParams contains all the bound params for the move canceler operation
...
func (o *MoveCancelerParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *MoveCancelerParams) validateMoveID(formats strfmt.Registry) error {
