...
func (o *UploadAdditionalDocumentsURL) WithBasePath(bp string) *UploadAdditionalDocumentsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UploadAdditionalDocumentsURL) String() string {
...
func (o *UploadAdditionalDocumentsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UploadAdditionalDocumentsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UploadAdditionalDocumentsURL")
	}
