...
func (o *UpdateCloseoutOfficeURL) WithBasePath(bp string) *UpdateCloseoutOfficeURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateCloseoutOfficeURL) Build() (*url.URL, error) {
	...
	var _path = "/moves/{locator}/closeout-office"

	locator := o.Locator
	if locator != "" {
		_path = strings.Replace(_path, "{locator}", locator, -1)
	} else {
		return nil, errors.New("locator is required on UpdateCloseoutOfficeURL")
	}
...
func (o *UpdateCloseoutOfficeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateCloseoutOfficeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateCloseoutOfficeURL")
	}
