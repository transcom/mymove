...
func NewGetMoveShipmentEvaluationReportsListParams() GetMoveShipmentEvaluationReportsListParams {
	...
	return GetMoveShipmentEvaluationReportsListParams{}
}

// GetMoveShipmentEvaluationReportsListParams contains all the bound params for the get move shipment evaluation reports list operation
...
func (o *GetMoveShipmentEvaluationReportsListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetMoveShipmentEvaluationReportsListParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetMoveShipmentEvaluationReportsListParams) validateMoveID(formats strfmt.Registry) error {
