...
func (o *DeleteAssignedOfficeUserURL) WithBasePath(bp string) *DeleteAssignedOfficeUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteAssignedOfficeUserURL) Build() (*url.URL, error) {
	...
	var _path = "/moves/{moveID}/unassignOfficeUser"

	moveID := o.MoveID.String()
	if moveID != "" {
		_path = strings.Replace(_path, "{moveID}", moveID, -1)
	} else {
		return nil, errors.New("moveId is required on DeleteAssignedOfficeUserURL")
	}
...
func (o *DeleteAssignedOfficeUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteAssignedOfficeUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteAssignedOfficeUserURL")
	}
