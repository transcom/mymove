...
func (o *MoveCancelerURL) Build() (*url.URL, error) {
	...
	if moveID != "" {
		...
		return nil, errors.New("moveId is required on MoveCancelerURL")
	}
...
func (o *MoveCancelerURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on MoveCancelerURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on MoveCancelerURL")
	}
