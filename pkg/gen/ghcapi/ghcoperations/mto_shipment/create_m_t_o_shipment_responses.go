...
func (o *CreateMTOShipmentOK) WithPayload(payload *ghcmessages.MTOShipment) *CreateMTOShipmentOK {
	o.Payload = payload
	return o
}
...
func (o *CreateMTOShipmentBadRequest) WithPayload(payload *ghcmessages.Error) *CreateMTOShipmentBadRequest {
	o.Payload = payload
	return o
}
...
func (o *CreateMTOShipmentNotFound) WithPayload(payload *ghcmessages.Error) *CreateMTOShipmentNotFound {
	o.Payload = payload
	return o
}
...
func (o *CreateMTOShipmentUnprocessableEntity) WithPayload(payload *ghcmessages.ValidationError) *CreateMTOShipmentUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o shipment unprocessable entity response
func (o *CreateMTOShipmentUnprocessableEntity) SetPayload(payload *ghcmessages.ValidationError) {
	o.Payload = payload
}
...
func (o *CreateMTOShipmentInternalServerError) WithPayload(payload *ghcmessages.Error) *CreateMTOShipmentInternalServerError {
	o.Payload = payload
	return o
}
