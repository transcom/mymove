...
func (o *GetTransportationOfficesOpenURL) WithBasePath(bp string) *GetTransportationOfficesOpenURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetTransportationOfficesOpenURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/open/transportation-offices"
...
func (o *GetTransportationOfficesOpenURL) String() string {
...
func (o *GetTransportationOfficesOpenURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetTransportationOfficesOpenURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetTransportationOfficesOpenURL")
	}
