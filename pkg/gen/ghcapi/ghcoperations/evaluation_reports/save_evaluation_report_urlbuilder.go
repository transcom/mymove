...
func (o *SaveEvaluationReportURL) Build() (*url.URL, error) {
	...
	if reportID != "" {
		...
		return nil, errors.New("reportId is required on SaveEvaluationReportURL")
	}
...
func (o *SaveEvaluationReportURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SaveEvaluationReportURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SaveEvaluationReportURL")
	}
