...
func NewCreateEvaluationReportParams() CreateEvaluationReportParams {
	...
	return CreateEvaluationReportParams{}
}

// CreateEvaluationReportParams contains all the bound params for the create evaluation report operation
...
func (o *CreateEvaluationReportParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body ghcmessages.CreateEvaluationReport
...
func (o *CreateEvaluationReportParams) bindLocator(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
