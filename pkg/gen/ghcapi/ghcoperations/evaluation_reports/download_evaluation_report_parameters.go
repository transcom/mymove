...
func NewDownloadEvaluationReportParams() DownloadEvaluationReportParams {
	...
	return DownloadEvaluationReportParams{}
}

// DownloadEvaluationReportParams contains all the bound params for the download evaluation report operation
...
func (o *DownloadEvaluationReportParams) bindReportID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DownloadEvaluationReportParams) validateReportID(formats strfmt.Registry) error {
