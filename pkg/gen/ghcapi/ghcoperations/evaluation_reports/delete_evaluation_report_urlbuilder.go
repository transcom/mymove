...
func (o *DeleteEvaluationReportURL) Build() (*url.URL, error) {
	...
	if reportID != "" {
		...
		return nil, errors.New("reportId is required on DeleteEvaluationReportURL")
	}
...
func (o *DeleteEvaluationReportURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteEvaluationReportURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteEvaluationReportURL")
	}
