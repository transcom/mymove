...
func (o *CreateEvaluationReportURL) Build() (*url.URL, error) {
	...
	var _path = "/moves/{locator}/evaluation-reports"

	locator := o.Locator
	if locator != "" {
		_path = strings.Replace(_path, "{locator}", locator, -1)
	} else {
		return nil, errors.New("locator is required on CreateEvaluationReportURL")
	}
...
func (o *CreateEvaluationReportURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateEvaluationReportURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateEvaluationReportURL")
	}
