...
func (o *GetPaymentRequestURL) Build() (*url.URL, error) {
	...
	if paymentRequestID != "" {
		...
		return nil, errors.New("paymentRequestId is required on GetPaymentRequestURL")
	}
...
func (o *GetPaymentRequestURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetPaymentRequestURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetPaymentRequestURL")
	}
