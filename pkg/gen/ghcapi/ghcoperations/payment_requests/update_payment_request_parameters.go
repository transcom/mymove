...
// NewUpdatePaymentRequestParams creates a new UpdatePaymentRequestParams object
// no default values defined in spec.
func NewUpdatePaymentRequestParams() UpdatePaymentRequestParams {

	return UpdatePaymentRequestParams{}
}

// UpdatePaymentRequestParams contains all the bound params for the update payment request operation
// typically these are obtained from a http.Request
//
// swagger:parameters updatePaymentRequest
...
//
// To ensure default values, the struct must have been initialized with NewUpdatePaymentRequestParams() beforehand.
func (o *UpdatePaymentRequestParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body ghcmessages.UpdatePaymentRequestPayload
...
func (o *UpdatePaymentRequestParams) bindPaymentRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdatePaymentRequestParams) validatePaymentRequestID(formats strfmt.Registry) error {
