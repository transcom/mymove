...
// GetShipmentsPaymentSITBalanceParams contains all the bound params for the get shipments payment s i t balance operation
...
func (o *GetShipmentsPaymentSITBalanceParams) bindPaymentRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetShipmentsPaymentSITBalanceParams) validatePaymentRequestID(formats strfmt.Registry) error {
