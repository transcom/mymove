...
func (o *GetPaymentRequestsForMoveURL) Build() (*url.URL, error) {
	...
	if locator != "" {
		...
		return nil, errors.New("locator is required on GetPaymentRequestsForMoveURL")
	}
...
func (o *GetPaymentRequestsForMoveURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetPaymentRequestsForMoveURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetPaymentRequestsForMoveURL")
	}
