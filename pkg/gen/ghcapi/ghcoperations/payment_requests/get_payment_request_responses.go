...
func (o *GetPaymentRequestBadRequest) WithPayload(payload *ghcmessages.InvalidRequest) *GetPaymentRequestBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get payment request bad request response
func (o *GetPaymentRequestBadRequest) SetPayload(payload *ghcmessages.InvalidRequest) {
	o.Payload = payload
}
...
func (o *GetPaymentRequestUnauthorized) WithPayload(payload *ghcmessages.PermissionDenied) *GetPaymentRequestUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get payment request unauthorized response
func (o *GetPaymentRequestUnauthorized) SetPayload(payload *ghcmessages.PermissionDenied) {
	o.Payload = payload
}
...
func (o *GetPaymentRequestForbidden) WithPayload(payload *ghcmessages.PermissionDenied) *GetPaymentRequestForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get payment request forbidden response
func (o *GetPaymentRequestForbidden) SetPayload(payload *ghcmessages.PermissionDenied) {
	o.Payload = payload
}
...
func (o *GetPaymentRequestNotFound) WithPayload(payload *ghcmessages.NotFound) *GetPaymentRequestNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get payment request not found response
func (o *GetPaymentRequestNotFound) SetPayload(payload *ghcmessages.NotFound) {
	o.Payload = payload
}
...
func (o *GetPaymentRequestInternalServerError) WithPayload(payload *ghcmessages.ServerError) *GetPaymentRequestInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get payment request internal server error response
func (o *GetPaymentRequestInternalServerError) SetPayload(payload *ghcmessages.ServerError) {
	o.Payload = payload
}
