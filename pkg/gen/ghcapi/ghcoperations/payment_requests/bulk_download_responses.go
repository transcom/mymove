...
// BulkDownloadForbiddenCode is the HTTP code returned for type BulkDownloadForbidden
const BulkDownloadForbiddenCode int = 403

/*
BulkDownloadForbidden The request was denied

swagger:response bulkDownloadForbidden
*/
type BulkDownloadForbidden struct {
...
// NewBulkDownloadForbidden creates BulkDownloadForbidden with default headers values
func NewBulkDownloadForbidden() *BulkDownloadForbidden {

	return &BulkDownloadForbidden{}
}

// WithPayload adds the payload to the bulk download forbidden response
func (o *BulkDownloadForbidden) WithPayload(payload *ghcmessages.Error) *BulkDownloadForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the bulk download forbidden response
func (o *BulkDownloadForbidden) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *BulkDownloadForbidden) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
// BulkDownloadNotFoundCode is the HTTP code returned for type BulkDownloadNotFound
const BulkDownloadNotFoundCode int = 404

/*
BulkDownloadNotFound The requested resource wasn't found

swagger:response bulkDownloadNotFound
*/
type BulkDownloadNotFound struct {
...
// NewBulkDownloadNotFound creates BulkDownloadNotFound with default headers values
func NewBulkDownloadNotFound() *BulkDownloadNotFound {

	return &BulkDownloadNotFound{}
}

// WithPayload adds the payload to the bulk download not found response
func (o *BulkDownloadNotFound) WithPayload(payload *ghcmessages.Error) *BulkDownloadNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the bulk download not found response
func (o *BulkDownloadNotFound) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *BulkDownloadNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
