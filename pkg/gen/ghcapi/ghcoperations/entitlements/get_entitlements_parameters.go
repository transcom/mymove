...
// GetEntitlementsParams contains all the bound params for the get entitlements operation
...
func (o *GetEntitlementsParams) bindMoveTaskOrderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
