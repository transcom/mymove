...
func (o *GetPrimeEntitlementsOK) WithPayload(payload *ghcmessages.Entitlements) *GetPrimeEntitlementsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get prime entitlements o k response
func (o *GetPrimeEntitlementsOK) SetPayload(payload *ghcmessages.Entitlements) {
	o.Payload = payload
}
...
func (o *GetPrimeEntitlementsBadRequest) WithPayload(payload *ghcmessages.Error) *GetPrimeEntitlementsBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get prime entitlements bad request response
func (o *GetPrimeEntitlementsBadRequest) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *GetPrimeEntitlementsUnauthorized) WithPayload(payload *ghcmessages.Error) *GetPrimeEntitlementsUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get prime entitlements unauthorized response
func (o *GetPrimeEntitlementsUnauthorized) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *GetPrimeEntitlementsForbidden) WithPayload(payload *ghcmessages.Error) *GetPrimeEntitlementsForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get prime entitlements forbidden response
func (o *GetPrimeEntitlementsForbidden) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *GetPrimeEntitlementsNotFound) WithPayload(payload *ghcmessages.Error) *GetPrimeEntitlementsNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get prime entitlements not found response
func (o *GetPrimeEntitlementsNotFound) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *GetPrimeEntitlementsInternalServerError) WithPayload(payload *ghcmessages.Error) *GetPrimeEntitlementsInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get prime entitlements internal server error response
func (o *GetPrimeEntitlementsInternalServerError) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
