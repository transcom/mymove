...
func (o *DeleteCustomerSupportRemarkURL) Build() (*url.URL, error) {
	...
	if customerSupportRemarkID != "" {
		...
		return nil, errors.New("customerSupportRemarkId is required on DeleteCustomerSupportRemarkURL")
	}
...
func (o *DeleteCustomerSupportRemarkURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteCustomerSupportRemarkURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteCustomerSupportRemarkURL")
	}
