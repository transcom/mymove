...
// UpdateServiceItemSitEntryDateParams contains all the bound params for the update service item sit entry date operation
...
func (o *UpdateServiceItemSitEntryDateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body ghcmessages.ServiceItemSitEntryDate
...
func (o *UpdateServiceItemSitEntryDateParams) bindMtoServiceItemID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
