...
func (o *GetMTOServiceItemURL) Build() (*url.URL, error) {
	...
	if moveTaskOrderID != "" {
		...
		return nil, errors.New("moveTaskOrderId is required on GetMTOServiceItemURL")
	}
	...
	if mtoServiceItemID != "" {
		...
		return nil, errors.New("mtoServiceItemId is required on GetMTOServiceItemURL")
	}
...
func (o *GetMTOServiceItemURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetMTOServiceItemURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetMTOServiceItemURL")
	}
