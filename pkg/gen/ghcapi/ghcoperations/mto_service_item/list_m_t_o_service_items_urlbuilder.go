...
func (o *ListMTOServiceItemsURL) WithBasePath(bp string) *ListMTOServiceItemsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListMTOServiceItemsURL) Build() (*url.URL, error) {
	...
	if moveTaskOrderID != "" {
		...
		return nil, errors.New("moveTaskOrderId is required on ListMTOServiceItemsURL")
	}
...
func (o *ListMTOServiceItemsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListMTOServiceItemsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListMTOServiceItemsURL")
	}
