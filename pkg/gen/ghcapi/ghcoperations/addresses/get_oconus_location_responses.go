...
type GetOconusLocationOK struct {
	...
	/*
	  In: Body
	*/
	Payload ghcmessages.VIntlLocations `json:"body,omitempty"`
}
...
func (o *GetOconusLocationOK) WithPayload(payload ghcmessages.VIntlLocations) *GetOconusLocationOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get oconus location o k response
func (o *GetOconusLocationOK) SetPayload(payload ghcmessages.VIntlLocations) {
	o.Payload = payload
}
...
func (o *GetOconusLocationOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = ghcmessages.VIntlLocations{}
	}
...
func (o *GetOconusLocationBadRequest) WithPayload(payload *ghcmessages.Error) *GetOconusLocationBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get oconus location bad request response
func (o *GetOconusLocationBadRequest) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *GetOconusLocationForbidden) WithPayload(payload *ghcmessages.Error) *GetOconusLocationForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get oconus location forbidden response
func (o *GetOconusLocationForbidden) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *GetOconusLocationNotFound) WithPayload(payload *ghcmessages.Error) *GetOconusLocationNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get oconus location not found response
func (o *GetOconusLocationNotFound) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *GetOconusLocationInternalServerError) WithPayload(payload *ghcmessages.Error) *GetOconusLocationInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get oconus location internal server error response
func (o *GetOconusLocationInternalServerError) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
