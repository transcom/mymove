...
func (o *ShowAOAPacketBadRequest) WithPayload(payload *ghcmessages.Error) *ShowAOAPacketBadRequest {
	o.Payload = payload
	return o
}
...
func (o *ShowAOAPacketForbidden) WithPayload(payload *ghcmessages.Error) *ShowAOAPacketForbidden {
	o.Payload = payload
	return o
}
...
func (o *ShowAOAPacketNotFound) WithPayload(payload *ghcmessages.Error) *ShowAOAPacketNotFound {
	o.Payload = payload
	return o
}
...
func (o *ShowAOAPacketUnprocessableEntity) WithPayload(payload *ghcmessages.ValidationError) *ShowAOAPacketUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the show a o a packet unprocessable entity response
func (o *ShowAOAPacketUnprocessableEntity) SetPayload(payload *ghcmessages.ValidationError) {
	o.Payload = payload
}
...
func (o *ShowAOAPacketInternalServerError) WithPayload(payload *ghcmessages.Error) *ShowAOAPacketInternalServerError {
	o.Payload = payload
	return o
}
