...
/*
DeleteProGearWeightTicketNoContent Successfully deleted the pro gear weight ticket
...
// DeleteProGearWeightTicketPreconditionFailedCode is the HTTP code returned for type DeleteProGearWeightTicketPreconditionFailed
const DeleteProGearWeightTicketPreconditionFailedCode int = 412

/*
DeleteProGearWeightTicketPreconditionFailed Precondition failed

swagger:response deleteProGearWeightTicketPreconditionFailed
*/
type DeleteProGearWeightTicketPreconditionFailed struct {
...
// NewDeleteProGearWeightTicketPreconditionFailed creates DeleteProGearWeightTicketPreconditionFailed with default headers values
func NewDeleteProGearWeightTicketPreconditionFailed() *DeleteProGearWeightTicketPreconditionFailed {

	return &DeleteProGearWeightTicketPreconditionFailed{}
}

// WithPayload adds the payload to the delete pro gear weight ticket precondition failed response
func (o *DeleteProGearWeightTicketPreconditionFailed) WithPayload(payload *ghcmessages.Error) *DeleteProGearWeightTicketPreconditionFailed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete pro gear weight ticket precondition failed response
func (o *DeleteProGearWeightTicketPreconditionFailed) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteProGearWeightTicketPreconditionFailed) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
