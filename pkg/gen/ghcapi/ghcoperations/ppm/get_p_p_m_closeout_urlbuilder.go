...
func (o *GetPPMCloseoutURL) Build() (*url.URL, error) {
	...
	if ppmShipmentID != "" {
		...
		return nil, errors.New("ppmShipmentId is required on GetPPMCloseoutURL")
	}
...
func (o *GetPPMCloseoutURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetPPMCloseoutURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetPPMCloseoutURL")
	}
