...
func (o *UpdateMovingExpenseURL) Build() (*url.URL, error) {
	...
	if ppmShipmentID != "" {
		...
		return nil, errors.New("ppmShipmentId is required on UpdateMovingExpenseURL")
	}
...
func (o *UpdateMovingExpenseURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateMovingExpenseURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateMovingExpenseURL")
	}
