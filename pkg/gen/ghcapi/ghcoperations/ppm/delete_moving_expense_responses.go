...
/*
DeleteMovingExpenseNoContent Successfully deleted the moving expense
...
func (o *DeleteMovingExpenseBadRequest) WithPayload(payload *ghcmessages.Error) *DeleteMovingExpenseBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete moving expense bad request response
func (o *DeleteMovingExpenseBadRequest) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *DeleteMovingExpenseUnauthorized) WithPayload(payload *ghcmessages.Error) *DeleteMovingExpenseUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete moving expense unauthorized response
func (o *DeleteMovingExpenseUnauthorized) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *DeleteMovingExpenseForbidden) WithPayload(payload *ghcmessages.Error) *DeleteMovingExpenseForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete moving expense forbidden response
func (o *DeleteMovingExpenseForbidden) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *DeleteMovingExpenseNotFound) WithPayload(payload *ghcmessages.Error) *DeleteMovingExpenseNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete moving expense not found response
func (o *DeleteMovingExpenseNotFound) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
// DeleteMovingExpensePreconditionFailedCode is the HTTP code returned for type DeleteMovingExpensePreconditionFailed
const DeleteMovingExpensePreconditionFailedCode int = 412

/*
DeleteMovingExpensePreconditionFailed Precondition failed

swagger:response deleteMovingExpensePreconditionFailed
*/
type DeleteMovingExpensePreconditionFailed struct {
...
// NewDeleteMovingExpensePreconditionFailed creates DeleteMovingExpensePreconditionFailed with default headers values
func NewDeleteMovingExpensePreconditionFailed() *DeleteMovingExpensePreconditionFailed {

	return &DeleteMovingExpensePreconditionFailed{}
}

// WithPayload adds the payload to the delete moving expense precondition failed response
func (o *DeleteMovingExpensePreconditionFailed) WithPayload(payload *ghcmessages.Error) *DeleteMovingExpensePreconditionFailed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete moving expense precondition failed response
func (o *DeleteMovingExpensePreconditionFailed) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteMovingExpensePreconditionFailed) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
func (o *DeleteMovingExpenseUnprocessableEntity) WithPayload(payload *ghcmessages.ValidationError) *DeleteMovingExpenseUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete moving expense unprocessable entity response
func (o *DeleteMovingExpenseUnprocessableEntity) SetPayload(payload *ghcmessages.ValidationError) {
	o.Payload = payload
}
...
func (o *DeleteMovingExpenseInternalServerError) WithPayload(payload *ghcmessages.Error) *DeleteMovingExpenseInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete moving expense internal server error response
func (o *DeleteMovingExpenseInternalServerError) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
