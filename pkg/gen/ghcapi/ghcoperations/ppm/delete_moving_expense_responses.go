...
/*
DeleteMovingExpenseConflict Conflict error
...
func (o *DeleteMovingExpenseConflict) WithPayload(payload *ghcmessages.Error) *DeleteMovingExpenseConflict {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete moving expense conflict response
func (o *DeleteMovingExpenseConflict) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
