...
// GetPPMActualWeightParams contains all the bound params for the get p p m actual weight operation
...
func (o *GetPPMActualWeightParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetPPMActualWeightParams) bindPpmShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetPPMActualWeightParams) validatePpmShipmentID(formats strfmt.Registry) error {
