...
func NewGetPPMCloseoutParams() GetPPMCloseoutParams {
	...
	return GetPPMCloseoutParams{}
}

// GetPPMCloseoutParams contains all the bound params for the get p p m closeout operation
...
func (o *GetPPMCloseoutParams) bindPpmShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetPPMCloseoutParams) validatePpmShipmentID(formats strfmt.Registry) error {
