...
/*
DeleteWeightTicketNoContent Successfully deleted the weight ticket
...
// DeleteWeightTicketPreconditionFailedCode is the HTTP code returned for type DeleteWeightTicketPreconditionFailed
const DeleteWeightTicketPreconditionFailedCode int = 412

/*
DeleteWeightTicketPreconditionFailed Precondition failed

swagger:response deleteWeightTicketPreconditionFailed
*/
type DeleteWeightTicketPreconditionFailed struct {
...
// NewDeleteWeightTicketPreconditionFailed creates DeleteWeightTicketPreconditionFailed with default headers values
func NewDeleteWeightTicketPreconditionFailed() *DeleteWeightTicketPreconditionFailed {

	return &DeleteWeightTicketPreconditionFailed{}
}

// WithPayload adds the payload to the delete weight ticket precondition failed response
func (o *DeleteWeightTicketPreconditionFailed) WithPayload(payload *ghcmessages.Error) *DeleteWeightTicketPreconditionFailed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete weight ticket precondition failed response
func (o *DeleteWeightTicketPreconditionFailed) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteWeightTicketPreconditionFailed) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
