...
func (o *CreatePPMUploadCreated) WithPayload(payload *ghcmessages.Upload) *CreatePPMUploadCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create p p m upload created response
func (o *CreatePPMUploadCreated) SetPayload(payload *ghcmessages.Upload) {
	o.Payload = payload
}
...
func (o *CreatePPMUploadBadRequest) WithPayload(payload *ghcmessages.InvalidRequestResponsePayload) *CreatePPMUploadBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create p p m upload bad request response
func (o *CreatePPMUploadBadRequest) SetPayload(payload *ghcmessages.InvalidRequestResponsePayload) {
	o.Payload = payload
}
...
func (o *CreatePPMUploadForbidden) WithPayload(payload *ghcmessages.Error) *CreatePPMUploadForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create p p m upload forbidden response
func (o *CreatePPMUploadForbidden) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *CreatePPMUploadNotFound) WithPayload(payload *ghcmessages.Error) *CreatePPMUploadNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create p p m upload not found response
func (o *CreatePPMUploadNotFound) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *CreatePPMUploadUnprocessableEntity) WithPayload(payload *ghcmessages.ValidationError) *CreatePPMUploadUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create p p m upload unprocessable entity response
func (o *CreatePPMUploadUnprocessableEntity) SetPayload(payload *ghcmessages.ValidationError) {
	o.Payload = payload
}
...
func (o *CreatePPMUploadInternalServerError) WithPayload(payload *ghcmessages.Error) *CreatePPMUploadInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create p p m upload internal server error response
func (o *CreatePPMUploadInternalServerError) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
...
func (o *CreatePPMUploadIncorrectXlsxFormat) WithPayload(payload *ghcmessages.Error) *CreatePPMUploadIncorrectXlsxFormat {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create p p m upload incorrect xlsx format response
func (o *CreatePPMUploadIncorrectXlsxFormat) SetPayload(payload *ghcmessages.Error) {
	o.Payload = payload
}
