...
func NewShowPaymentPacketParams() ShowPaymentPacketParams {
	...
	return ShowPaymentPacketParams{}
}

// ShowPaymentPacketParams contains all the bound params for the show payment packet operation
...
func (o *ShowPaymentPacketParams) bindPpmShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ShowPaymentPacketParams) validatePpmShipmentID(formats strfmt.Registry) error {
