...
// NewUpdatePPMSITParams creates a new UpdatePPMSITParams object
//
// There are no default values defined in the spec.
func NewUpdatePPMSITParams() UpdatePPMSITParams {

	return UpdatePPMSITParams{}
}

// UpdatePPMSITParams contains all the bound params for the update p p m s i t operation
// typically these are obtained from a http.Request
//
// swagger:parameters updatePPMSIT
type UpdatePPMSITParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewUpdatePPMSITParams() beforehand.
func (o *UpdatePPMSITParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body ghcmessages.PPMShipmentSIT
...
func (o *UpdatePPMSITParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdatePPMSITParams) bindPpmShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdatePPMSITParams) validatePpmShipmentID(formats strfmt.Registry) error {
