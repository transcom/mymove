...
func (o *FinishDocumentReviewURL) WithBasePath(bp string) *FinishDocumentReviewURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *FinishDocumentReviewURL) Build() (*url.URL, error) {
	...
	var _path = "/ppm-shipments/{ppmShipmentId}/finish-document-review"

	ppmShipmentID := o.PpmShipmentID.String()
	if ppmShipmentID != "" {
		_path = strings.Replace(_path, "{ppmShipmentId}", ppmShipmentID, -1)
	} else {
		return nil, errors.New("ppmShipmentId is required on FinishDocumentReviewURL")
	}
...
func (o *FinishDocumentReviewURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on FinishDocumentReviewURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on FinishDocumentReviewURL")
	}
