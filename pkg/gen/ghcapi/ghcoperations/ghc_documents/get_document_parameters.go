...
func (o *GetDocumentParams) bindDocumentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetDocumentParams) validateDocumentID(formats strfmt.Registry) error {
