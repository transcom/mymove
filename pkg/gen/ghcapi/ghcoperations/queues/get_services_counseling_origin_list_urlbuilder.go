...
func (o *GetServicesCounselingOriginListURL) WithBasePath(bp string) *GetServicesCounselingOriginListURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetServicesCounselingOriginListURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/queues/counseling/origin-list"
...
func (o *GetServicesCounselingOriginListURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *GetServicesCounselingOriginListURL) String() string {
...
func (o *GetServicesCounselingOriginListURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetServicesCounselingOriginListURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetServicesCounselingOriginListURL")
	}
