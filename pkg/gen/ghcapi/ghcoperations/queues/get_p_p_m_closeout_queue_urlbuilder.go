...
// GetPPMCloseoutQueueURL generates an URL for the get p p m closeout queue operation
type GetPPMCloseoutQueueURL struct {
...
func (o *GetPPMCloseoutQueueURL) WithBasePath(bp string) *GetPPMCloseoutQueueURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *GetPPMCloseoutQueueURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *GetPPMCloseoutQueueURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/queues/ppmCloseout"
	...
	var activeOfficeIDQ string
	if o.ActiveOfficeID != nil {
		activeOfficeIDQ = o.ActiveOfficeID.String()
	}
	if activeOfficeIDQ != "" {
		qs.Set("activeOfficeID", activeOfficeIDQ)
	}
...
func (o *GetPPMCloseoutQueueURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *GetPPMCloseoutQueueURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *GetPPMCloseoutQueueURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetPPMCloseoutQueueURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetPPMCloseoutQueueURL")
	}
...
func (o *GetPPMCloseoutQueueURL) StringFull(scheme, host string) string {
