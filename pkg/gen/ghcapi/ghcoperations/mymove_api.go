...
func NewMymoveAPI(spec *loads.Document) *MymoveAPI {
	return &MymoveAPI{
		...
		MoveTaskOrderGetMovePaymentRequestsHandler: move_task_order.GetMovePaymentRequestsHandlerFunc(func(params move_task_order.GetMovePaymentRequestsParams) middleware.Responder {
		...
		MoveOrderUpdateMoveOrderHandler: move_order.UpdateMoveOrderHandlerFunc(func(params move_order.UpdateMoveOrderParams) middleware.Responder {
...
type MymoveAPI struct {
	...
	// MoveTaskOrderGetMovePaymentRequestsHandler sets the operation handler for the get move payment requests operation
	MoveTaskOrderGetMovePaymentRequestsHandler move_task_order.GetMovePaymentRequestsHandler
	...
	// MoveOrderUpdateMoveOrderHandler sets the operation handler for the update move order operation
	MoveOrderUpdateMoveOrderHandler move_order.UpdateMoveOrderHandler
...
func (o *MymoveAPI) Validate() error {
	...
	if o.MoveTaskOrderGetMovePaymentRequestsHandler == nil {
		unregistered = append(unregistered, "move_task_order.GetMovePaymentRequestsHandler")
	}
	...
	if o.MoveOrderUpdateMoveOrderHandler == nil {
		unregistered = append(unregistered, "move_order.UpdateMoveOrderHandler")
	}
...
func (o *MymoveAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/move-task-orders/{moveTaskOrderID}/payment-requests"] = move_task_order.NewGetMovePaymentRequests(o.context, o.MoveTaskOrderGetMovePaymentRequestsHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["PATCH"]["/move-orders/{moveOrderID}"] = move_order.NewUpdateMoveOrder(o.context, o.MoveOrderUpdateMoveOrderHandler)
	if o.handlers["PATCH"] == nil {
		o.handlers["PATCH"] = make(map[string]http.Handler)
	}
