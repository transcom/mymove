...
type UpdateMTOShipmentOK struct {
	...
	/*
	  In: Body
	*/
	Payload *ghcv2messages.MTOShipment `json:"body,omitempty"`
}
...
func (o *UpdateMTOShipmentOK) WithPayload(payload *ghcv2messages.MTOShipment) *UpdateMTOShipmentOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment o k response
func (o *UpdateMTOShipmentOK) SetPayload(payload *ghcv2messages.MTOShipment) {
	o.Payload = payload
}
...
type UpdateMTOShipmentBadRequest struct {
	...
	/*
	  In: Body
	*/
	Payload *ghcv2messages.Error `json:"body,omitempty"`
}
...
func (o *UpdateMTOShipmentBadRequest) WithPayload(payload *ghcv2messages.Error) *UpdateMTOShipmentBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment bad request response
func (o *UpdateMTOShipmentBadRequest) SetPayload(payload *ghcv2messages.Error) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentUnauthorized) WithPayload(payload *ghcv2messages.Error) *UpdateMTOShipmentUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment unauthorized response
func (o *UpdateMTOShipmentUnauthorized) SetPayload(payload *ghcv2messages.Error) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentForbidden) WithPayload(payload *ghcv2messages.Error) *UpdateMTOShipmentForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment forbidden response
func (o *UpdateMTOShipmentForbidden) SetPayload(payload *ghcv2messages.Error) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentNotFound) WithPayload(payload *ghcv2messages.Error) *UpdateMTOShipmentNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment not found response
func (o *UpdateMTOShipmentNotFound) SetPayload(payload *ghcv2messages.Error) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentPreconditionFailed) WithPayload(payload *ghcv2messages.Error) *UpdateMTOShipmentPreconditionFailed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment precondition failed response
func (o *UpdateMTOShipmentPreconditionFailed) SetPayload(payload *ghcv2messages.Error) {
	o.Payload = payload
}
...
type UpdateMTOShipmentUnprocessableEntity struct {
	...
	/*
	  In: Body
	*/
	Payload *ghcv2messages.ValidationError `json:"body,omitempty"`
}
...
func (o *UpdateMTOShipmentUnprocessableEntity) WithPayload(payload *ghcv2messages.ValidationError) *UpdateMTOShipmentUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment unprocessable entity response
func (o *UpdateMTOShipmentUnprocessableEntity) SetPayload(payload *ghcv2messages.ValidationError) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentInternalServerError) WithPayload(payload *ghcv2messages.Error) *UpdateMTOShipmentInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment internal server error response
func (o *UpdateMTOShipmentInternalServerError) SetPayload(payload *ghcv2messages.Error) {
	o.Payload = payload
}
