...
type CreateMTOShipmentOK struct {
	...
	/*
	  In: Body
	*/
	Payload *primev2messages.MTOShipment `json:"body,omitempty"`
}
...
func (o *CreateMTOShipmentOK) WithPayload(payload *primev2messages.MTOShipment) *CreateMTOShipmentOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o shipment o k response
func (o *CreateMTOShipmentOK) SetPayload(payload *primev2messages.MTOShipment) {
	o.Payload = payload
}
...
type CreateMTOShipmentBadRequest struct {
	...
	/*
	  In: Body
	*/
	Payload *primev2messages.ClientError `json:"body,omitempty"`
}
...
func (o *CreateMTOShipmentBadRequest) WithPayload(payload *primev2messages.ClientError) *CreateMTOShipmentBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o shipment bad request response
func (o *CreateMTOShipmentBadRequest) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
func (o *CreateMTOShipmentNotFound) WithPayload(payload *primev2messages.ClientError) *CreateMTOShipmentNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o shipment not found response
func (o *CreateMTOShipmentNotFound) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
type CreateMTOShipmentUnprocessableEntity struct {
	...
	/*
	  In: Body
	*/
	Payload *primev2messages.ValidationError `json:"body,omitempty"`
}
...
func (o *CreateMTOShipmentUnprocessableEntity) WithPayload(payload *primev2messages.ValidationError) *CreateMTOShipmentUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o shipment unprocessable entity response
func (o *CreateMTOShipmentUnprocessableEntity) SetPayload(payload *primev2messages.ValidationError) {
	o.Payload = payload
}
...
type CreateMTOShipmentInternalServerError struct {
	...
	/*
	  In: Body
	*/
	Payload *primev2messages.Error `json:"body,omitempty"`
}
...
func (o *CreateMTOShipmentInternalServerError) WithPayload(payload *primev2messages.Error) *CreateMTOShipmentInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o shipment internal server error response
func (o *CreateMTOShipmentInternalServerError) SetPayload(payload *primev2messages.Error) {
	o.Payload = payload
}
