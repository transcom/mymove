...
func (o *UpdateMTOShipmentOK) WithPayload(payload *primev2messages.MTOShipment) *UpdateMTOShipmentOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment o k response
func (o *UpdateMTOShipmentOK) SetPayload(payload *primev2messages.MTOShipment) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentBadRequest) WithPayload(payload *primev2messages.ClientError) *UpdateMTOShipmentBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment bad request response
func (o *UpdateMTOShipmentBadRequest) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentUnauthorized) WithPayload(payload *primev2messages.ClientError) *UpdateMTOShipmentUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment unauthorized response
func (o *UpdateMTOShipmentUnauthorized) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentForbidden) WithPayload(payload *primev2messages.ClientError) *UpdateMTOShipmentForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment forbidden response
func (o *UpdateMTOShipmentForbidden) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentNotFound) WithPayload(payload *primev2messages.ClientError) *UpdateMTOShipmentNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment not found response
func (o *UpdateMTOShipmentNotFound) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentPreconditionFailed) WithPayload(payload *primev2messages.ClientError) *UpdateMTOShipmentPreconditionFailed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment precondition failed response
func (o *UpdateMTOShipmentPreconditionFailed) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentUnprocessableEntity) WithPayload(payload *primev2messages.ValidationError) *UpdateMTOShipmentUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment unprocessable entity response
func (o *UpdateMTOShipmentUnprocessableEntity) SetPayload(payload *primev2messages.ValidationError) {
	o.Payload = payload
}
...
func (o *UpdateMTOShipmentInternalServerError) WithPayload(payload *primev2messages.Error) *UpdateMTOShipmentInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update m t o shipment internal server error response
func (o *UpdateMTOShipmentInternalServerError) SetPayload(payload *primev2messages.Error) {
	o.Payload = payload
}
