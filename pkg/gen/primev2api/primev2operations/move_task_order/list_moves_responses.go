...
type ListMovesOK struct {
	...
	/*
	  In: Body
	*/
	Payload primev2messages.ListMoves `json:"body,omitempty"`
}
...
func (o *ListMovesOK) WithPayload(payload primev2messages.ListMoves) *ListMovesOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list moves o k response
func (o *ListMovesOK) SetPayload(payload primev2messages.ListMoves) {
	o.Payload = payload
}
...
func (o *ListMovesUnauthorized) WithPayload(payload *primev2messages.ClientError) *ListMovesUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list moves unauthorized response
func (o *ListMovesUnauthorized) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
func (o *ListMovesForbidden) WithPayload(payload *primev2messages.ClientError) *ListMovesForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list moves forbidden response
func (o *ListMovesForbidden) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
func (o *ListMovesInternalServerError) WithPayload(payload *primev2messages.Error) *ListMovesInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list moves internal server error response
func (o *ListMovesInternalServerError) SetPayload(payload *primev2messages.Error) {
	o.Payload = payload
}
