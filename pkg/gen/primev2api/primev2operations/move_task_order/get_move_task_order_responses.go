...
type GetMoveTaskOrderOK struct {
	...
	/*
	  In: Body
	*/
	Payload *primev2messages.MoveTaskOrder `json:"body,omitempty"`
}
...
func (o *GetMoveTaskOrderOK) WithPayload(payload *primev2messages.MoveTaskOrder) *GetMoveTaskOrderOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get move task order o k response
func (o *GetMoveTaskOrderOK) SetPayload(payload *primev2messages.MoveTaskOrder) {
	o.Payload = payload
}
...
func (o *GetMoveTaskOrderUnauthorized) WithPayload(payload *primev2messages.ClientError) *GetMoveTaskOrderUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get move task order unauthorized response
func (o *GetMoveTaskOrderUnauthorized) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
func (o *GetMoveTaskOrderForbidden) WithPayload(payload *primev2messages.ClientError) *GetMoveTaskOrderForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get move task order forbidden response
func (o *GetMoveTaskOrderForbidden) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
func (o *GetMoveTaskOrderNotFound) WithPayload(payload *primev2messages.ClientError) *GetMoveTaskOrderNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get move task order not found response
func (o *GetMoveTaskOrderNotFound) SetPayload(payload *primev2messages.ClientError) {
	o.Payload = payload
}
...
func (o *GetMoveTaskOrderInternalServerError) WithPayload(payload *primev2messages.Error) *GetMoveTaskOrderInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get move task order internal server error response
func (o *GetMoveTaskOrderInternalServerError) SetPayload(payload *primev2messages.Error) {
	o.Payload = payload
}
