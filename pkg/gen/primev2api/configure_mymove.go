...
//go:generate swagger generate server --target ../../gen --name Mymove --spec ../../../swagger/primev2.yaml --api-package primev2operations --model-package primev2messages --server-package primev2api --principal interface{} --exclude-main
