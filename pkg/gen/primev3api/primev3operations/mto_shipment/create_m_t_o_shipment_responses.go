...
func (o *CreateMTOShipmentOK) WithPayload(payload *primev3messages.MTOShipment) *CreateMTOShipmentOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o shipment o k response
func (o *CreateMTOShipmentOK) SetPayload(payload *primev3messages.MTOShipment) {
	o.Payload = payload
}
...
func (o *CreateMTOShipmentBadRequest) WithPayload(payload *primev3messages.ClientError) *CreateMTOShipmentBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o shipment bad request response
func (o *CreateMTOShipmentBadRequest) SetPayload(payload *primev3messages.ClientError) {
	o.Payload = payload
}
...
func (o *CreateMTOShipmentNotFound) WithPayload(payload *primev3messages.ClientError) *CreateMTOShipmentNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o shipment not found response
func (o *CreateMTOShipmentNotFound) SetPayload(payload *primev3messages.ClientError) {
	o.Payload = payload
}
...
func (o *CreateMTOShipmentUnprocessableEntity) WithPayload(payload *primev3messages.ValidationError) *CreateMTOShipmentUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o shipment unprocessable entity response
func (o *CreateMTOShipmentUnprocessableEntity) SetPayload(payload *primev3messages.ValidationError) {
	o.Payload = payload
}
...
func (o *CreateMTOShipmentInternalServerError) WithPayload(payload *primev3messages.Error) *CreateMTOShipmentInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create m t o shipment internal server error response
func (o *CreateMTOShipmentInternalServerError) SetPayload(payload *primev3messages.Error) {
	o.Payload = payload
}
