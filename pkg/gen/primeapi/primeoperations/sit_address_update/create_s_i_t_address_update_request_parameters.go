...
// CreateSITAddressUpdateRequestParams contains all the bound params for the create s i t address update request operation
...
func (o *CreateSITAddressUpdateRequestParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body primemessages.CreateSITAddressUpdateRequest
