...
func (o *UpdatePaymentRequestStatusOK) WithPayload(payload *primemessages.PaymentRequest) *UpdatePaymentRequestStatusOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update payment request status o k response
func (o *UpdatePaymentRequestStatusOK) SetPayload(payload *primemessages.PaymentRequest) {
	o.Payload = payload
}
...
func (o *UpdatePaymentRequestStatusUnprocessableEntity) WithPayload(payload *primemessages.ValidationError) *UpdatePaymentRequestStatusUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update payment request status unprocessable entity response
func (o *UpdatePaymentRequestStatusUnprocessableEntity) SetPayload(payload *primemessages.ValidationError) {
	o.Payload = payload
}
