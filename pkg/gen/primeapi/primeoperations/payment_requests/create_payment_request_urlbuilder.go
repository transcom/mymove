...
func (o *CreatePaymentRequestURL) WithBasePath(bp string) *CreatePaymentRequestURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreatePaymentRequestURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreatePaymentRequestURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreatePaymentRequestURL")
	}
