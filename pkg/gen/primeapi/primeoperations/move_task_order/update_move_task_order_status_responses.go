...
func (o *UpdateMoveTaskOrderStatusOK) WithPayload(payload *primemessages.MoveTaskOrder) *UpdateMoveTaskOrderStatusOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update move task order status o k response
func (o *UpdateMoveTaskOrderStatusOK) SetPayload(payload *primemessages.MoveTaskOrder) {
	o.Payload = payload
}
