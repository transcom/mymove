...
func (o *DownloadMoveOrderURL) Build() (*url.URL, error) {
	...
	if locator != "" {
		...
		return nil, errors.New("locator is required on DownloadMoveOrderURL")
	}
...
func (o *DownloadMoveOrderURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DownloadMoveOrderURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DownloadMoveOrderURL")
	}
