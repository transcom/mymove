...
func (o *GetMoveTaskOrderBadRequest) WithPayload(payload *primemessages.ClientError) *GetMoveTaskOrderBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get move task order bad request response
func (o *GetMoveTaskOrderBadRequest) SetPayload(payload *primemessages.ClientError) {
	o.Payload = payload
}
