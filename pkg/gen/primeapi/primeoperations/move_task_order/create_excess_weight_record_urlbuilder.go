...
func (o *CreateExcessWeightRecordURL) WithBasePath(bp string) *CreateExcessWeightRecordURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateExcessWeightRecordURL) Build() (*url.URL, error) {
	...
	var _path = "/move-task-orders/{moveTaskOrderID}/excess-weight-record"

	moveTaskOrderID := o.MoveTaskOrderID.String()
	if moveTaskOrderID != "" {
		_path = strings.Replace(_path, "{moveTaskOrderID}", moveTaskOrderID, -1)
	} else {
		return nil, errors.New("moveTaskOrderId is required on CreateExcessWeightRecordURL")
	}
...
func (o *CreateExcessWeightRecordURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateExcessWeightRecordURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateExcessWeightRecordURL")
	}
