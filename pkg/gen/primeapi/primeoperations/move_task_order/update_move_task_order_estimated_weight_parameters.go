...
// UpdateMoveTaskOrderEstimatedWeightParams contains all the bound params for the update move task order estimated weight operation
// typically these are obtained from a http.Request
//
// swagger:parameters updateMoveTaskOrderEstimatedWeight
...
//
// To ensure default values, the struct must have been initialized with NewUpdateMoveTaskOrderEstimatedWeightParams() beforehand.
func (o *UpdateMoveTaskOrderEstimatedWeightParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body UpdateMoveTaskOrderEstimatedWeightBody
...
func (o *UpdateMoveTaskOrderEstimatedWeightParams) bindMoveTaskOrderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
