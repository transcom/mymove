...
func (o *UpdateMTOPostCounselingInformationParams) bindIfUnmodifiedSince(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdateMTOPostCounselingInformationParams) validateIfUnmodifiedSince(formats strfmt.Registry) error {
