...
func (o *UpdateMTOShipmentAddressURL) Build() (*url.URL, error) {
	...
	if addressID != "" {
		...
		return nil, errors.New("addressId is required on UpdateMTOShipmentAddressURL")
	}
	...
	if mtoShipmentID != "" {
		...
		return nil, errors.New("mtoShipmentId is required on UpdateMTOShipmentAddressURL")
	}
...
func (o *UpdateMTOShipmentAddressURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateMTOShipmentAddressURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateMTOShipmentAddressURL")
	}
