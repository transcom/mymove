...
// UpdateMTOAgentParams contains all the bound params for the update m t o agent operation
...
func (o *UpdateMTOAgentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	rAgentID, rhkAgentID, _ := route.Params.GetOK("agentID")
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body primemessages.MTOAgent
...
func (o *UpdateMTOAgentParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdateMTOAgentParams) bindAgentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if err != nil {
		return errors.InvalidType("agentID", "path", "strfmt.UUID", raw)
	}
	o.AgentID = *(value.(*strfmt.UUID))
...
// validateAgentID carries on validations for parameter AgentID
func (o *UpdateMTOAgentParams) validateAgentID(formats strfmt.Registry) error {

	if err := validate.FormatOf("agentID", "path", "uuid", o.AgentID.String(), formats); err != nil {
		return err
	}
	return nil
}
...
func (o *UpdateMTOAgentParams) bindMtoShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateMTOAgentParams) validateMtoShipmentID(formats strfmt.Registry) error {
