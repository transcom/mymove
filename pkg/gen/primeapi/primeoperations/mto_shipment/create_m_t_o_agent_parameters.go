...
// CreateMTOAgentParams contains all the bound params for the create m t o agent operation
...
func (o *CreateMTOAgentParams) bindMtoShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateMTOAgentParams) validateMtoShipmentID(formats strfmt.Registry) error {
