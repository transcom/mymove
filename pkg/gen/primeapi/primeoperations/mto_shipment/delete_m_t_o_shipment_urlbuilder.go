...
func (o *DeleteMTOShipmentURL) Build() (*url.URL, error) {
	...
	if mtoShipmentID != "" {
		...
		return nil, errors.New("mtoShipmentId is required on DeleteMTOShipmentURL")
	}
...
func (o *DeleteMTOShipmentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteMTOShipmentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteMTOShipmentURL")
	}
