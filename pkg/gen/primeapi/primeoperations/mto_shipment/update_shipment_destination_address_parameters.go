...
// UpdateShipmentDestinationAddressParams contains all the bound params for the update shipment destination address operation
...
func (o *UpdateShipmentDestinationAddressParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body primemessages.UpdateShipmentDestinationAddress
...
func (o *UpdateShipmentDestinationAddressParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdateShipmentDestinationAddressParams) bindMtoShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateShipmentDestinationAddressParams) validateMtoShipmentID(formats strfmt.Registry) error {
