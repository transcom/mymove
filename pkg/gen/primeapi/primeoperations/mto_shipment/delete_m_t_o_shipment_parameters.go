...
// DeleteMTOShipmentParams contains all the bound params for the delete m t o shipment operation
...
func (o *DeleteMTOShipmentParams) bindMtoShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteMTOShipmentParams) validateMtoShipmentID(formats strfmt.Registry) error {
