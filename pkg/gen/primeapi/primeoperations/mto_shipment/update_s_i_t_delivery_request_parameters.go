...
// UpdateSITDeliveryRequestParams contains all the bound params for the update s i t delivery request operation
// typically these are obtained from a http.Request
//
// swagger:parameters updateSITDeliveryRequest
...
//
// To ensure default values, the struct must have been initialized with NewUpdateSITDeliveryRequestParams() beforehand.
func (o *UpdateSITDeliveryRequestParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *UpdateSITDeliveryRequestParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdateSITDeliveryRequestParams) bindMtoShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateSITDeliveryRequestParams) validateMtoShipmentID(formats strfmt.Registry) error {
