...
// CreateNonSITAddressUpdateRequestParams contains all the bound params for the create non s i t address update request operation
// typically these are obtained from a http.Request
//
// swagger:parameters createNonSITAddressUpdateRequest
...
//
// To ensure default values, the struct must have been initialized with NewCreateNonSITAddressUpdateRequestParams() beforehand.
func (o *CreateNonSITAddressUpdateRequestParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body primemessages.CreateNonSITAddressUpdateRequest
...
func (o *CreateNonSITAddressUpdateRequestParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CreateNonSITAddressUpdateRequestParams) bindMtoShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateNonSITAddressUpdateRequestParams) validateMtoShipmentID(formats strfmt.Registry) error {
