...
If the chain cannot be established it will fall back to the `PrimeActualWeight`. This is utilized because diverted shipments are all one single shipment, but going to different locations.
