...
type GetLocationByZipCityStateOK struct {
	...
	/*
	  In: Body
	*/
	Payload primemessages.VLocations `json:"body,omitempty"`
}
...
func (o *GetLocationByZipCityStateOK) WithPayload(payload primemessages.VLocations) *GetLocationByZipCityStateOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get location by zip city state o k response
func (o *GetLocationByZipCityStateOK) SetPayload(payload primemessages.VLocations) {
	o.Payload = payload
}
...
func (o *GetLocationByZipCityStateBadRequest) WithPayload(payload *primemessages.ClientError) *GetLocationByZipCityStateBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get location by zip city state bad request response
func (o *GetLocationByZipCityStateBadRequest) SetPayload(payload *primemessages.ClientError) {
	o.Payload = payload
}
...
func (o *GetLocationByZipCityStateForbidden) WithPayload(payload *primemessages.ClientError) *GetLocationByZipCityStateForbidden {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get location by zip city state forbidden response
func (o *GetLocationByZipCityStateForbidden) SetPayload(payload *primemessages.ClientError) {
	o.Payload = payload
}
...
func (o *GetLocationByZipCityStateNotFound) WithPayload(payload *primemessages.ClientError) *GetLocationByZipCityStateNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get location by zip city state not found response
func (o *GetLocationByZipCityStateNotFound) SetPayload(payload *primemessages.ClientError) {
	o.Payload = payload
}
...
func (o *GetLocationByZipCityStateInternalServerError) WithPayload(payload *primemessages.Error) *GetLocationByZipCityStateInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get location by zip city state internal server error response
func (o *GetLocationByZipCityStateInternalServerError) SetPayload(payload *primemessages.Error) {
	o.Payload = payload
}
