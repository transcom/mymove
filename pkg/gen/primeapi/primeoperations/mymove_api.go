...
func (o *MymoveAPI) initHandlerCache() {
	...
	o.handlers["PUT"]["/move_task_orders/{moveTaskOrderID}/mto_shipments/{mtoShipmentID}"] = mto_shipment.NewUpdateMTOShipment(o.context, o.MtoShipmentUpdateMTOShipmentHandler)
