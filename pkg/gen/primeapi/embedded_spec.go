      ...
      "allOf": [
        ...
        },
        {
          ...
          "properties": {
            ...
            "timeMilitary1": {
              "description": "Time of attempted delivery by the prime corresponding to 'dateOfContact1', in military format.",
              "type": "string",
              "pattern": "\\d{4}Z",
              "x-nullable": true,
              "example": "1400Z"
            ...
            "timeMilitary2": {
              "description": "Time of attempted delivery by the prime corresponding to 'dateOfContact2', in military format.",
              "type": "string",
              "pattern": "\\d{4}Z",
              "x-nullable": true,
              "example": "1400Z"
