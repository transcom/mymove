...
func (o *ListMovesOK) GetPayload() pptasmessages.ListMoves {
	return o.Payload
}
...
func (o *ListMovesUnauthorized) GetPayload() *pptasmessages.ClientError {
	return o.Payload
}
...
func (o *ListMovesForbidden) GetPayload() *pptasmessages.ClientError {
	return o.Payload
}
