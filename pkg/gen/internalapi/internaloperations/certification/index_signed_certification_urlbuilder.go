...
func (o *IndexSignedCertificationURL) WithBasePath(bp string) *IndexSignedCertificationURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *IndexSignedCertificationURL) Build() (*url.URL, error) {
	...
	if moveID != "" {
		...
		return nil, errors.New("moveId is required on IndexSignedCertificationURL")
	}
...
func (o *IndexSignedCertificationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on IndexSignedCertificationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on IndexSignedCertificationURL")
	}
