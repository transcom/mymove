...
// IndexSignedCertificationParams contains all the bound params for the index signed certification operation
...
func (o *IndexSignedCertificationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IndexSignedCertificationParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *IndexSignedCertificationParams) validateMoveID(formats strfmt.Registry) error {
