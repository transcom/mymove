...
func NewCreateSignedCertificationParams() CreateSignedCertificationParams {
	...
	return CreateSignedCertificationParams{}
}

// CreateSignedCertificationParams contains all the bound params for the create signed certification operation
...
func (o *CreateSignedCertificationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		...
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			...
			if len(res) == 0 {
				o.CreateSignedCertificationPayload = &body
			}
		}
	} else {
		res = append(res, errors.Required("createSignedCertificationPayload", "body", ""))
...
func (o *CreateSignedCertificationParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateSignedCertificationParams) validateMoveID(formats strfmt.Registry) error {
