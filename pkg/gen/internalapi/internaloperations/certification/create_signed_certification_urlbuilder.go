...
func (o *CreateSignedCertificationURL) WithBasePath(bp string) *CreateSignedCertificationURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateSignedCertificationURL) Build() (*url.URL, error) {
	...
	var _path = "/moves/{moveId}/signed_certifications"

	moveID := o.MoveID.String()
	if moveID != "" {
		_path = strings.Replace(_path, "{moveId}", moveID, -1)
	} else {
		return nil, errors.New("moveId is required on CreateSignedCertificationURL")
	}
...
func (o *CreateSignedCertificationURL) String() string {
...
func (o *CreateSignedCertificationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateSignedCertificationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateSignedCertificationURL")
	}
