...
func (o *CancelMoveURL) Build() (*url.URL, error) {
	...
	if moveID != "" {
		...
		return nil, errors.New("moveId is required on CancelMoveURL")
	}
...
func (o *CancelMoveURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CancelMoveURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CancelMoveURL")
	}
