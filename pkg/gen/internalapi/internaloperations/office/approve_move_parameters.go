...
// ApproveMoveParams contains all the bound params for the approve move operation
...
func (o *ApproveMoveParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ApproveMoveParams) validateMoveID(formats strfmt.Registry) error {
