...
func NewUpdateOktaInfoParams() UpdateOktaInfoParams {
	...
	return UpdateOktaInfoParams{}
}

// UpdateOktaInfoParams contains all the bound params for the update okta info operation
...
func (o *UpdateOktaInfoParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body internalmessages.UpdateOktaUserProfileData
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("updateOktaUserProfileData", "body", ""))
			} else {
				res = append(res, errors.NewParseError("updateOktaUserProfileData", "body", "", err))
			}
		} else {
			...
			if len(res) == 0 {
				o.UpdateOktaUserProfileData = &body
			}
		}
	} else {
		res = append(res, errors.Required("updateOktaUserProfileData", "body", ""))
