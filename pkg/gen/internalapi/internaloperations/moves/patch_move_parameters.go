...
func NewPatchMoveParams() PatchMoveParams {
	...
	return PatchMoveParams{}
}

// PatchMoveParams contains all the bound params for the patch move operation
...
func (o *PatchMoveParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body internalmessages.PatchMovePayload
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("patchMovePayload", "body", ""))
			} else {
				res = append(res, errors.NewParseError("patchMovePayload", "body", "", err))
			}
		} else {
...
func (o *PatchMoveParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchMoveParams) validateMoveID(formats strfmt.Registry) error {
