...
func (o *ShowMoveURL) Build() (*url.URL, error) {
	...
	if moveID != "" {
		...
		return nil, errors.New("moveId is required on ShowMoveURL")
	}
...
func (o *ShowMoveURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ShowMoveURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ShowMoveURL")
	}
