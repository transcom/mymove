...
func (o *UploadAdditionalDocumentsCreated) WithPayload(payload *internalmessages.Upload) *UploadAdditionalDocumentsCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the upload additional documents created response
func (o *UploadAdditionalDocumentsCreated) SetPayload(payload *internalmessages.Upload) {
	o.Payload = payload
}
...
func (o *UploadAdditionalDocumentsBadRequest) WithPayload(payload *internalmessages.InvalidRequestResponsePayload) *UploadAdditionalDocumentsBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the upload additional documents bad request response
func (o *UploadAdditionalDocumentsBadRequest) SetPayload(payload *internalmessages.InvalidRequestResponsePayload) {
	o.Payload = payload
}
