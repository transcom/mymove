...
func (o *UpdateOrdersURL) Build() (*url.URL, error) {
	...
	if ordersID != "" {
		...
		return nil, errors.New("ordersId is required on UpdateOrdersURL")
	}
...
func (o *UpdateOrdersURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateOrdersURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateOrdersURL")
	}
