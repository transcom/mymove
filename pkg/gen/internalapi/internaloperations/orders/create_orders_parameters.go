...
func NewCreateOrdersParams() CreateOrdersParams {
	...
	return CreateOrdersParams{}
}

// CreateOrdersParams contains all the bound params for the create orders operation
...
type CreateOrdersParams struct {
	...
	/*
	  ...
	  In: body
	*/
	CreateOrders *internalmessages.CreateUpdateOrders
}
