...
// CreateWeightTicketDocumentParams contains all the bound params for the create weight ticket document operation
...
func (o *CreateWeightTicketDocumentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body internalmessages.CreateWeightTicketDocumentsPayload
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("createWeightTicketDocument", "body", ""))
			} else {
				res = append(res, errors.NewParseError("createWeightTicketDocument", "body", "", err))
			}
		} else {
...
func (o *CreateWeightTicketDocumentParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateWeightTicketDocumentParams) validateMoveID(formats strfmt.Registry) error {
