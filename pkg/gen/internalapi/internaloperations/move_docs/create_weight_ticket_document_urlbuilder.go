...
func (o *CreateWeightTicketDocumentURL) WithBasePath(bp string) *CreateWeightTicketDocumentURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateWeightTicketDocumentURL) Build() (*url.URL, error) {
	...
	var _path = "/moves/{moveId}/weight_ticket"

	moveID := o.MoveID.String()
	if moveID != "" {
		_path = strings.Replace(_path, "{moveId}", moveID, -1)
	} else {
		return nil, errors.New("moveId is required on CreateWeightTicketDocumentURL")
	}
...
func (o *CreateWeightTicketDocumentURL) String() string {
...
func (o *CreateWeightTicketDocumentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateWeightTicketDocumentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateWeightTicketDocumentURL")
	}
