...
// IndexMoveDocumentsParams contains all the bound params for the index move documents operation
...
func (o *IndexMoveDocumentsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *IndexMoveDocumentsParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *IndexMoveDocumentsParams) validateMoveID(formats strfmt.Registry) error {
