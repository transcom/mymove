...
func NewCreateGenericMoveDocumentParams() CreateGenericMoveDocumentParams {
	...
	return CreateGenericMoveDocumentParams{}
}

// CreateGenericMoveDocumentParams contains all the bound params for the create generic move document operation
...
func (o *CreateGenericMoveDocumentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body internalmessages.CreateGenericMoveDocumentPayload
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("createGenericMoveDocumentPayload", "body", ""))
			} else {
				res = append(res, errors.NewParseError("createGenericMoveDocumentPayload", "body", "", err))
			}
		} else {
			...
			if len(res) == 0 {
				o.CreateGenericMoveDocumentPayload = &body
			}
		}
	} else {
		res = append(res, errors.Required("createGenericMoveDocumentPayload", "body", ""))
...
func (o *CreateGenericMoveDocumentParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateGenericMoveDocumentParams) validateMoveID(formats strfmt.Registry) error {
