...
func (o *UpdateMoveDocumentURL) Build() (*url.URL, error) {
	...
	if moveDocumentID != "" {
		...
		return nil, errors.New("moveDocumentId is required on UpdateMoveDocumentURL")
	}
...
func (o *UpdateMoveDocumentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateMoveDocumentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateMoveDocumentURL")
	}
