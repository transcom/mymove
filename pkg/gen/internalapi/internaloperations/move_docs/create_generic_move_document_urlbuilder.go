...
func (o *CreateGenericMoveDocumentURL) WithBasePath(bp string) *CreateGenericMoveDocumentURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateGenericMoveDocumentURL) Build() (*url.URL, error) {
	...
	if moveID != "" {
		...
		return nil, errors.New("moveId is required on CreateGenericMoveDocumentURL")
	}
...
func (o *CreateGenericMoveDocumentURL) String() string {
...
func (o *CreateGenericMoveDocumentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateGenericMoveDocumentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateGenericMoveDocumentURL")
	}
