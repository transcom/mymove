...
func (o *ValidateURL) Build() (*url.URL, error) {
	...
	var _path = "/open/application_parameters"
...
func (o *ValidateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ValidateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ValidateURL")
	}
