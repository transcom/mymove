...
// ValidateEntitlementParams contains all the bound params for the validate entitlement operation
// typically these are obtained from a http.Request
//
// swagger:parameters validateEntitlement
type ValidateEntitlementParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewValidateEntitlementParams() beforehand.
func (o *ValidateEntitlementParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ValidateEntitlementParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ValidateEntitlementParams) validateMoveID(formats strfmt.Registry) error {
