...
// PatchPersonallyProcuredMoveParams contains all the bound params for the patch personally procured move operation
// typically these are obtained from a http.Request
//
// swagger:parameters patchPersonallyProcuredMove
type PatchPersonallyProcuredMoveParams struct {
	...
	*/
	...
	/*
	  ...
	  In: body
	*/
	PatchPersonallyProcuredMovePayload *internalmessages.PatchPersonallyProcuredMovePayload
...
//
// To ensure default values, the struct must have been initialized with NewPatchPersonallyProcuredMoveParams() beforehand.
func (o *PatchPersonallyProcuredMoveParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PatchPersonallyProcuredMoveParams) bindMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchPersonallyProcuredMoveParams) validateMoveID(formats strfmt.Registry) error {
...
func (o *PatchPersonallyProcuredMoveParams) bindPersonallyProcuredMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPersonallyProcuredMoveParams) validatePersonallyProcuredMoveID(formats strfmt.Registry) error {
