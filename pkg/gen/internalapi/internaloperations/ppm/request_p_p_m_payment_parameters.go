...
// RequestPPMPaymentParams contains all the bound params for the request p p m payment operation
// typically these are obtained from a http.Request
//
// swagger:parameters requestPPMPayment
type RequestPPMPaymentParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewRequestPPMPaymentParams() beforehand.
func (o *RequestPPMPaymentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RequestPPMPaymentParams) bindPersonallyProcuredMoveID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RequestPPMPaymentParams) validatePersonallyProcuredMoveID(formats strfmt.Registry) error {
