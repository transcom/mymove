...
func (o *ShowPaymentPacketUnprocessableEntity) WithPayload(payload *internalmessages.ValidationError) *ShowPaymentPacketUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the show payment packet unprocessable entity response
func (o *ShowPaymentPacketUnprocessableEntity) SetPayload(payload *internalmessages.ValidationError) {
	o.Payload = payload
}
