...
// CreatePPMUploadIncorrectXlsxFormat is the HTTP code returned for type CreatePPMUploadIncorrectXlsxFormat
const CreatePPMUploadIncorrectXlsxFormatCode int = 422

/*
CreatePPMUploadUIncorrectXlsxFormat The payload was unprocessable.

swagger:response createPPMUploadIncorrectXlsxFormat
*/
type CreatePPMUploadIncorrectXlsxFormat struct {
...
func NewCreatePPMUploadIncorrectXlsxFormat() *CreatePPMUploadIncorrectXlsxFormat {

	return &CreatePPMUploadIncorrectXlsxFormat{}
}
...
// WriteResponse to the client
func (o *CreatePPMUploadIncorrectXlsxFormat) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
