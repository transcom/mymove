...
func (o *ShowAOAPacketURL) Build() (*url.URL, error) {
	...
	if ppmShipmentID != "" {
		...
		return nil, errors.New("ppmShipmentId is required on ShowAOAPacketURL")
	}
...
func (o *ShowAOAPacketURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ShowAOAPacketURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ShowAOAPacketURL")
	}
