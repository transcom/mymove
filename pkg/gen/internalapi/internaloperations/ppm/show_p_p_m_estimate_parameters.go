...
// ShowPPMEstimateParams contains all the bound params for the show p p m estimate operation
// typically these are obtained from a http.Request
//
// swagger:parameters showPPMEstimate
type ShowPPMEstimateParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewShowPPMEstimateParams() beforehand.
func (o *ShowPPMEstimateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ShowPPMEstimateParams) bindDestinationDutyStationZip(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ShowPPMEstimateParams) validateDestinationDutyStationZip(formats strfmt.Registry) error {
...
func (o *ShowPPMEstimateParams) validateOriginDutyStationZip(formats strfmt.Registry) error {
...
func (o *ShowPPMEstimateParams) validateOriginZip(formats strfmt.Registry) error {
...
func (o *ShowPPMEstimateParams) validateOriginalMoveDate(formats strfmt.Registry) error {
