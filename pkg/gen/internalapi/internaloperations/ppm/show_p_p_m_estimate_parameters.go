...
func (o *ShowPPMEstimateParams) bindOriginDutyLocationZip(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ShowPPMEstimateParams) validateOriginDutyLocationZip(formats strfmt.Registry) error {
