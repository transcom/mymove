...
func NewCreateMovingExpenseParams() CreateMovingExpenseParams {
	...
	return CreateMovingExpenseParams{}
}

// CreateMovingExpenseParams contains all the bound params for the create moving expense operation
...
func (o *CreateMovingExpenseParams) bindPpmShipmentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateMovingExpenseParams) validatePpmShipmentID(formats strfmt.Registry) error {
