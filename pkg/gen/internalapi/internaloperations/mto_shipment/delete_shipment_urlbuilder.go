...
func (o *DeleteShipmentURL) Build() (*url.URL, error) {
	...
	if mtoShipmentID != "" {
		...
		return nil, errors.New("mtoShipmentId is required on DeleteShipmentURL")
	}
...
func (o *DeleteShipmentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteShipmentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteShipmentURL")
	}
