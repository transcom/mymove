...
func (o *ShowAvailableMoveDatesURL) WithBasePath(bp string) *ShowAvailableMoveDatesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ShowAvailableMoveDatesURL) Build() (*url.URL, error) {
	...
	var _path = "/calendar/available_move_dates"
...
func (o *ShowAvailableMoveDatesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ShowAvailableMoveDatesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ShowAvailableMoveDatesURL")
	}
