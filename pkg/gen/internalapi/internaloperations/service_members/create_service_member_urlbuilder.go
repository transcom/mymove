...
func (o *CreateServiceMemberURL) WithBasePath(bp string) *CreateServiceMemberURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateServiceMemberURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateServiceMemberURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateServiceMemberURL")
	}
