...
func (o *ShowServiceMemberOrdersURL) WithBasePath(bp string) *ShowServiceMemberOrdersURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ShowServiceMemberOrdersURL) Build() (*url.URL, error) {
	...
	var _path = "/service_members/{serviceMemberId}/current_orders"

	serviceMemberID := o.ServiceMemberID.String()
	if serviceMemberID != "" {
		_path = strings.Replace(_path, "{serviceMemberId}", serviceMemberID, -1)
	} else {
		return nil, errors.New("serviceMemberId is required on ShowServiceMemberOrdersURL")
	}
...
func (o *ShowServiceMemberOrdersURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ShowServiceMemberOrdersURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ShowServiceMemberOrdersURL")
	}
