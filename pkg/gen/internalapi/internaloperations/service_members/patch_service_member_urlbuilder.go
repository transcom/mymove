...
func (o *PatchServiceMemberURL) Build() (*url.URL, error) {
	...
	if serviceMemberID != "" {
		...
		return nil, errors.New("serviceMemberId is required on PatchServiceMemberURL")
	}
...
func (o *PatchServiceMemberURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PatchServiceMemberURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PatchServiceMemberURL")
	}
