...
// ShowServiceMemberParams contains all the bound params for the show service member operation
...
func (o *ShowServiceMemberParams) bindServiceMemberID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ShowServiceMemberParams) validateServiceMemberID(formats strfmt.Registry) error {
