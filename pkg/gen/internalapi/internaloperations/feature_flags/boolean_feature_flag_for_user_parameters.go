...
func NewBooleanFeatureFlagForUserParams() BooleanFeatureFlagForUserParams {
	...
	return BooleanFeatureFlagForUserParams{}
}

// BooleanFeatureFlagForUserParams contains all the bound params for the boolean feature flag for user operation
...
func (o *BooleanFeatureFlagForUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *BooleanFeatureFlagForUserParams) bindKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
