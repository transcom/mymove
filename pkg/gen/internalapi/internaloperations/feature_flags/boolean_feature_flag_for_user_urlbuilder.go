...
func (o *BooleanFeatureFlagForUserURL) WithBasePath(bp string) *BooleanFeatureFlagForUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *BooleanFeatureFlagForUserURL) Build() (*url.URL, error) {
	...
	var _path = "/feature-flags/user-boolean/{key}"

	key := o.Key
	if key != "" {
		_path = strings.Replace(_path, "{key}", key, -1)
	} else {
		return nil, errors.New("key is required on BooleanFeatureFlagForUserURL")
	}
...
func (o *BooleanFeatureFlagForUserURL) String() string {
...
func (o *BooleanFeatureFlagForUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on BooleanFeatureFlagForUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on BooleanFeatureFlagForUserURL")
	}
