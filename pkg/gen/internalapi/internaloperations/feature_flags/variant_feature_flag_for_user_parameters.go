...
func NewVariantFeatureFlagForUserParams() VariantFeatureFlagForUserParams {
	...
	return VariantFeatureFlagForUserParams{}
}

// VariantFeatureFlagForUserParams contains all the bound params for the variant feature flag for user operation
...
func (o *VariantFeatureFlagForUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *VariantFeatureFlagForUserParams) bindKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
