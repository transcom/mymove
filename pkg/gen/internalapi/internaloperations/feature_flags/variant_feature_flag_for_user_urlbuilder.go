...
func (o *VariantFeatureFlagForUserURL) WithBasePath(bp string) *VariantFeatureFlagForUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *VariantFeatureFlagForUserURL) Build() (*url.URL, error) {
	...
	var _path = "/feature-flags/user-variant/{key}"

	key := o.Key
	if key != "" {
		_path = strings.Replace(_path, "{key}", key, -1)
	} else {
		return nil, errors.New("key is required on VariantFeatureFlagForUserURL")
	}
...
func (o *VariantFeatureFlagForUserURL) String() string {
...
func (o *VariantFeatureFlagForUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on VariantFeatureFlagForUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on VariantFeatureFlagForUserURL")
	}
