...
func init() {
	...
	if err := json.Unmarshal([]byte(`["HHG","HHG_LONGHAUL_DOMESTIC","HHG_SHORTHAUL_DOMESTIC","HHG_INTO_NTS_DOMESTIC","HHG_OUTOF_NTS_DOMESTIC","INTERNATIONAL_HHG","INTERNATIONAL_UB","PPM"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
