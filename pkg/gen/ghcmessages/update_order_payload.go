...
func (m *UpdateOrderPayload) validateRank(formats strfmt.Registry) error {
...
func (m *UpdateOrderPayload) contextValidateRank(ctx context.Context, formats strfmt.Registry) error {
