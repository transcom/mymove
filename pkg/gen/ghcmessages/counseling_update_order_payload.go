...
func (m *CounselingUpdateOrderPayload) validateRank(formats strfmt.Registry) error {
...
func (m *CounselingUpdateOrderPayload) contextValidateRank(ctx context.Context, formats strfmt.Registry) error {
