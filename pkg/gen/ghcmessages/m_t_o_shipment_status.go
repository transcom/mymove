...
const (
	...
	// MTOShipmentStatusTERMINATEDFORCAUSE captures enum value "TERMINATED_FOR_CAUSE"
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["SUBMITTED","REJECTED","APPROVED","CANCELLATION_REQUESTED","CANCELED","DIVERSION_REQUESTED","TERMINATED_FOR_CAUSE","APPROVALS_REQUESTED"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
