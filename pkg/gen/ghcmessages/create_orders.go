...
func (m *CreateOrders) validateRankShortName(formats strfmt.Registry) error {
...
func (m *CreateOrders) contextValidateRankShortName(ctx context.Context, formats strfmt.Registry) error {
