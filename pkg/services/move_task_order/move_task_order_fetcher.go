...
func (f moveTaskOrderFetcher) FetchMoveTaskOrder(appCtx appcontext.AppContext, searchParams *services.MoveTaskOrderFetcherParams) (*models.Move, error) {
	...
	query := appCtx.DB().EagerPreload(
		...
		"MTOServiceItems.ReService",
		"MTOServiceItems.Dimensions",
		"MTOServiceItems.SITDestinationFinalAddress.State",
		"MTOServiceItems.SITDestinationFinalAddress.Country",
		"MTOServiceItems.SITOriginHHGOriginalAddress.State",
		"MTOServiceItems.SITOriginHHGOriginalAddress.Country",
		"MTOServiceItems.SITOriginHHGActualAddress.State",
		"MTOServiceItems.SITOriginHHGActualAddress.Country",
		"MTOServiceItems.ServiceRequestDocuments.ServiceRequestDocumentUploads",
		...
		"MTOShipments.StorageFacility.Address.State",
		"MTOShipments.StorageFacility.Address.Country",
		"MTOShipments.DeliveryAddressUpdate",
		"MTOShipments.DeliveryAddressUpdate.OriginalAddress.Country",
		"MTOShipments.DeliveryAddressUpdate.OriginalAddress.State",
		"Orders.ServiceMember",
