package movetaskorderfetcherv2
...
// We also have to make a separate struct on which we attach our services methods
...
// ListPrimeMoveTaskOrdersV2 performs an optimized fetch for moves specifically targeting the Prime API.
