...
func (f *pptasReportListFetcher) GetMovesForReportBuilder(appCtx appcontext.AppContext, params *services.MovesForPPTASFetcherParams, affiliation *models.ServiceMemberAffiliation) (models.Moves, error) {
	moves, err := f.moveFetcher.FetchMovesForPPTASReports(appCtx, params, affiliation)
