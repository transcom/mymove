...
func checkShipmentID() mtoAgentValidator {
	return mtoAgentValidatorFunc(func(appCfg appconfig.AppConfig, newAgent models.MTOAgent, oldAgent *models.MTOAgent, _ *models.MTOShipment) error {
...
func checkAgentID() mtoAgentValidator {
	return mtoAgentValidatorFunc(func(appCfg appconfig.AppConfig, newAgent models.MTOAgent, oldAgent *models.MTOAgent, shipment *models.MTOShipment) error {
		verrs := validate.NewErrors()
		if oldAgent == nil {
...
func checkPrimeAvailability(checker services.MoveTaskOrderChecker) mtoAgentValidator {
	return mtoAgentValidatorFunc(func(appCfg appconfig.AppConfig, newAgent models.MTOAgent, oldAgent *models.MTOAgent, shipment *models.MTOShipment) error {
		...
		isAvailable, err := checker.MTOAvailableToPrime(appCfg, shipment.MoveTaskOrderID)
