...
func (p domesticCratingPricer) Price(appCtx appcontext.AppContext, contractCode string, referenceDate time.Time, billedCubicFeet unit.CubicFeet, serviceSchedule int, standaloneCrate bool) (unit.Cents, services.PricingDisplayParams, error) {
	return priceDomesticCrating(appCtx, models.ReServiceCodeDCRT, contractCode, referenceDate, billedCubicFeet, serviceSchedule, standaloneCrate)
}
...
func (p domesticCratingPricer) PriceUsingParams(appCtx appcontext.AppContext, params models.PaymentServiceItemParams) (unit.Cents, services.PricingDisplayParams, error) {
	...
	return p.Price(appCtx, contractCode, referenceDate, cubicFeetBilled, serviceScheduleDestination, standaloneCrate)
}
