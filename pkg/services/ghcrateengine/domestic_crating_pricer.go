...
func (p domesticCratingPricer) Price(contractCode string, requestedPickupDate time.Time, billedCubicFeet float64, serviceSchedule int) (unit.Cents, services.PricingDisplayParams, error) {
