...
const (
	...
	dddsitTestServiceArea                         = "796"
	dddsitTestIsPeakPeriod                        = true
	dddsitTestContractYearName                    = "Base Period Year 1"
	dddsitTestEscalationCompounded                = 1.11
	...
	dddsitTestDomesticOtherBasePriceCents         = unit.Cents(22011)
	dddsitTestDomesticLinehaulBasePriceMillicents = unit.Millicents(252400)
	dddsitTestDomesticServiceAreaBasePriceCents   = unit.Cents(153)
)

var dddsitTestRequestedPickupDate = time.Date(testdatagen.TestYear, time.June, 10, 10, 22, 11, 456, time.UTC)
...
func (suite *GHCRateEngineServiceSuite) TestDomesticDestinationSITDeliveryPricerSameZip3s() {
	...
	expectedPrice := unit.Cents(549720) // dddsitTestDomesticServiceAreaBasePriceCents * (dddsitTestWeight / 100) * distance * dddsitTestEscalationCompounded
...
func (suite *GHCRateEngineServiceSuite) TestDomesticDestinationSITDeliveryPricer50PlusMilesDiffZip3s() {
	...
	pricer := NewDomesticDestinationSITDeliveryPricer()
	expectedPrice := unit.Cents(1922873)
...
func (suite *GHCRateEngineServiceSuite) TestDomesticDestinationSITDeliveryPricer50MilesOrLessDiffZip3s() {
	...
	pricer := NewDomesticDestinationSITDeliveryPricer()
	expectedPrice := unit.Cents(549720)
