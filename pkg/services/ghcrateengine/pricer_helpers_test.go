...
func (suite *GHCRateEngineServiceSuite) Test_priceDomesticPackUnpack() {
	...
	suite.Run("not finding shipment type price", func() {
		...
		isPPM := false
		suite.setupDomesticNTSPackPrices(dnpkTestServicesScheduleOrigin, dnpkTestIsPeakPeriod, dnpkTestBasePriceCents, badMarket, dnpkTestFactor)
...
func (suite *GHCRateEngineServiceSuite) Test_priceDomesticShuttling() {
	suite.Run("destination golden path", func() {
		suite.setupDomesticAccessorialPrice(models.ReServiceCodeDOSHUT, doshutTestServiceSchedule)
...
func (suite *GHCRateEngineServiceSuite) Test_priceDomesticCrating() {
	suite.Run("crating golden path", func() {
		suite.setupDomesticAccessorialPrice(models.ReServiceCodeDCRT, dcrtTestServiceSchedule)
