...
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name FileStorer
type FileStorer interface {
	Create(string) (afero.File, error)
}

// FormFiller is an interface for formFiller implementation
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name FormFiller
