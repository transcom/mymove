...
// NewFormFiller creates a new instance of FormFiller. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewFormFiller(t testing.TB) *FormFiller {
	mock := &FormFiller{}
	mock.Mock.Test(t)
