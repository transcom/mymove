...
type UserFetcher interface {
	FetchUser(appCfg appconfig.AppConfig, filters []QueryFilter) (models.User, error)
}
...
type UserUpdater interface {
	UpdateUser(appCfg appconfig.AppConfig, id uuid.UUID, user *models.User) (*models.User, *validate.Errors, error)
}
...
type UserSessionRevocation interface {
	RevokeUserSession(appCfg appconfig.AppConfig, id uuid.UUID, payload *adminmessages.UserUpdatePayload, sessionStore scs.Store) (*models.User, *validate.Errors, error)
}
