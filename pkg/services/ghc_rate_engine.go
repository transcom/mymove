...
type ServiceItemPricer interface {
	PriceServiceItem(appCfg appconfig.AppConfig, item models.PaymentServiceItem) (unit.Cents, models.PaymentServiceItemParams, error)
}
...
type ParamsPricer interface {
	PriceUsingParams(appCfg appconfig.AppConfig, params models.PaymentServiceItemParams) (unit.Cents, PricingDisplayParams, error)
}
...
type ManagementServicesPricer interface {
	Price(appCfg appconfig.AppConfig, contractCode string, mtoAvailableToPrimeAt time.Time) (unit.Cents, PricingDisplayParams, error)
	ParamsPricer
}
...
type DomesticLinehaulPricer interface {
	Price(appCfg appconfig.AppConfig, contractCode string, requestedPickupDate time.Time, distance unit.Miles, weight unit.Pound, serviceArea string) (unit.Cents, PricingDisplayParams, error)
	ParamsPricer
}
...
type DomesticOriginPricer interface {
	Price(appCfg appconfig.AppConfig, contractCode string, requestedPickupDate time.Time, weight unit.Pound, serviceArea string) (unit.Cents, PricingDisplayParams, error)
	ParamsPricer
}
...
type DomesticOriginShuttlingPricer interface {
	Price(appCfg appconfig.AppConfig, contractCode string, requestedPickupDate time.Time, weight unit.Pound, servicesScheduleOrigin int) (unit.Cents, PricingDisplayParams, error)
	ParamsPricer
}
...
type DomesticDestinationShuttlingPricer interface {
	Price(appCfg appconfig.AppConfig, contractCode string, requestedPickupDate time.Time, weight unit.Pound, servicesScheduleDest int) (unit.Cents, PricingDisplayParams, error)
	ParamsPricer
}
...
type DomesticCratingPricer interface {
	Price(appCfg appconfig.AppConfig, contractCode string, requestedPickupDate time.Time, billedCubicFeet unit.CubicFeet, servicesScheduleOrigin int) (unit.Cents, PricingDisplayParams, error)
	ParamsPricer
}
...
type DomesticUncratingPricer interface {
	Price(appCfg appconfig.AppConfig, contractCode string, requestedPickupDate time.Time, billedCubicFeet unit.CubicFeet, servicesScheduleDest int) (unit.Cents, PricingDisplayParams, error)
	ParamsPricer
}
...
type FuelSurchargePricer interface {
	Price(appCfg appconfig.AppConfig, actualPickupDate time.Time, distance unit.Miles, weight unit.Pound, fscWeightBasedDistanceMultiplier float64, eiaFuelPrice unit.Millicents) (unit.Cents, PricingDisplayParams, error)
	ParamsPricer
}
...
type DomesticOriginAdditionalDaysSITPricer interface {
	Price(appCfg appconfig.AppConfig, contractCode string, requestedPickupDate time.Time, weight unit.Pound, serviceArea string, numberOfDaysInSIT int) (unit.Cents, PricingDisplayParams, error)
	ParamsPricer
}
...
type DomesticOriginSITPickupPricer interface {
	Price(appCfg appconfig.AppConfig, contractCode string, requestedPickupDate time.Time, weight unit.Pound, serviceArea string, sitSchedule int, zipSITOriginOriginal string, zipSITOriginActual string, distance unit.Miles) (unit.Cents, PricingDisplayParams, error)
	ParamsPricer
}
...
type DomesticDestinationSITDeliveryPricer interface {
	Price(appCfg appconfig.AppConfig, contractCode string, requestedPickupDate time.Time, weight unit.Pound, serviceArea string, sitSchedule int, zipDest string, zipSITDest string, distance unit.Miles) (unit.Cents, PricingDisplayParams, error)
	ParamsPricer
}
