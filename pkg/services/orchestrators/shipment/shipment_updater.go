...
func (s *shipmentUpdater) UpdateShipment(appCtx appcontext.AppContext, shipment *models.MTOShipmentUpdate, eTag string) (*models.MTOShipment, error) {
	validationShipment, _ := shipment.GetShipmentModelFromUpdateModel()
	if err := validateShipment(appCtx, *validationShipment, s.checks...); err != nil {
		return nil, err
	}
