...
//go:generate mockery -name StorageInTransitCreator -output=$GOPATH/src/github.com/transcom/mymove/mocks
...
//go:generate mockery -name StorageInTransitsIndexer -output=$GOPATH/src/github.com/transcom/mymove/mocks
...
//go:generate mockery -name StorageInTransitApprover -output=$GOPATH/src/github.com/transcom/mymove/mocks
...
//go:generate mockery -name StorageInTransitDenier -output=$GOPATH/src/github.com/transcom/mymove/mocks
...
//go:generate mockery -name StorageInTransitInSITPlacer -output=$GOPATH/src/github.com/transcom/mymove/mocks
...
//go:generate mockery -name StorageInTransitDeliverer -output=$GOPATH/src/github.com/transcom/mymove/mocks
...
//go:generate mockery -name StorageInTransitReleaser -output=$GOPATH/src/github.com/transcom/mymove/mocks
...
//go:generate mockery -name StorageInTransitDeleter -output=$GOPATH/src/github.com/transcom/mymove/mocks
...
//go:generate mockery -name StorageInTransitPatcher -output=$GOPATH/src/github.com/transcom/mymove/mocks
...
//go:generate mockery -name StorageInTransitByIDFetcher -output=$GOPATH/src/github.com/transcom/mymove/mocks
