...
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name StorageInTransitCreator
...
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name StorageInTransitsIndexer
...
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name StorageInTransitApprover
...
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name StorageInTransitDenier
...
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name StorageInTransitInSITPlacer
...
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name StorageInTransitDeliverer
...
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name StorageInTransitReleaser
...
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name StorageInTransitDeleter
...
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name StorageInTransitPatcher
...
//go:generate $GOPATH/src/github.com/transcom/mymove/bin/mockery -name StorageInTransitByIDFetcher
