...
type MoveFetcher interface {
	...
	FetchMovesForPPTASReports(appCtx appcontext.AppContext, params *MovesForPPTASFetcherParams, affiliation *models.ServiceMemberAffiliation) (models.Moves, error)
