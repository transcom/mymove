...
type MoveAssigner interface {
	...
	BulkMoveReAssignment(appCtx appcontext.AppContext, queueType string, officeUserData []*ghcmessages.BulkAssignmentForUser, reAssignFrom strfmt.UUID) (*models.Moves, error)
}
