...
func (suite *MTOServiceItemServiceSuite) TestCreateMTOServiceItemWithInvalidMove() {
	...
	creator := NewMTOServiceItemCreator(planner, builder, moveRouter, ghcrateengine.NewServiceItemPricer(), ghcrateengine.NewDomesticUnpackPricer(), ghcrateengine.NewDomesticPackPricer())
