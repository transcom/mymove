...
type updateMTOServiceItemValidator interface {
	validate(appCfg appconfig.AppConfig, serviceItemData *updateMTOServiceItemData) error
}
...
func (v *basicUpdateMTOServiceItemValidator) validate(appCfg appconfig.AppConfig, serviceItemData *updateMTOServiceItemData) error {
...
func (v *primeUpdateMTOServiceItemValidator) validate(appCfg appconfig.AppConfig, serviceItemData *updateMTOServiceItemData) error {
...
func (v *updateMTOServiceItemData) checkLinkedIDs(appCfg appconfig.AppConfig) error {
...
func (v *updateMTOServiceItemData) checkPrimeAvailability(appCfg appconfig.AppConfig) error {
	isAvailable, err := v.availabilityChecker.MTOAvailableToPrime(appCfg, v.oldServiceItem.MoveTaskOrderID)
...
func (v *updateMTOServiceItemData) checkNonPrimeFields(appCfg appconfig.AppConfig) error {
...
// SITDepartureDate
func (v *updateMTOServiceItemData) checkSITDeparture(appCfg appconfig.AppConfig) error {
...
func (v *updateMTOServiceItemData) checkPaymentRequests(appCfg appconfig.AppConfig) error {
	var paymentServiceItem models.PaymentServiceItem
	err := appCfg.DB().Where("mto_service_item_id = $1", v.updatedServiceItem.ID).First(&paymentServiceItem)
