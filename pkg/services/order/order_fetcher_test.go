...
func (suite *OrderServiceSuite) TestListOrders() {
	...
	suite.Run("task order queue does not return move with ONLY a destination address update request", func() {
		...
		// suite.Equal(models.ShipmentAddressUpdateStatusRequested, shipmentAddressUpdate.Status)
		suite.Equal(models.ShipmentAddressUpdateStatusApproved, approvedShipmentAddressUpdate.Status)
...
// 		},
// 	}, nil)
// 	shipmentAddressUpdate2 := factory.BuildShipmentAddressUpdate(suite.DB(), []factory.Customization{
// 		{
// 			Model:    shipment2,
// 			LinkOnly: true,
// 		},
...
// 	suite.Equal(models.ShipmentAddressUpdateStatusRequested, shipmentAddressUpdate.Status)
// 	suite.Equal(models.ShipmentAddressUpdateStatusApproved, shipmentAddressUpdate2.Status)

// 	suite.FatalNoError(err)
// 	suite.Equal(0, len(moves))
// })

// suite.Run("returns moves filtered by update title", func() {
// 	// Under test: ListOrders
// 	// Set up:           Make 3 moves, with different submitted_at times, and search for a specific move
// 	// Expected outcome: Only the one move with the right date should be returned
// 	officeUser, _, session := setupTestData()
...
// 	suite.Equal(ddfServiceItem.ReService.Code, models.ReServiceCodeDDFSIT)
// 	suite.FatalNoError(err)
// 	suite.Equal(1, len(moves))
// })
...
// 	})
//
// 	suite.Run("does not return move with ONLY destination queue requests (SIT, shuttle, or destination address changes", func() {

// 		officeUser, session := setupTestData("KKFA")

// 		// postalCode := "40356"
// 		factory.FetchOrBuildPostalCodeToGBLOC(suite.DB(), "40356", "KKFA")

// 		// setting up a few moves, one with requested destination SIT service items
// 		// one with requested origin and destination SIT service items
...
// 		orderFetcher := NewOrderFetcher()
// 		taskOrderMoves, taskOrderMoveCount, err := orderFetcher.ListOrders(suite.AppContextWithSessionForTest(&session), officeUser.ID, roles.RoleTypeTOO, &services.ListOrderParams{})

// 		suite.NotNil(shipmentAddressUpdate)
// 		suite.NotNil(serviceItem)
// 		suite.NotNil(serviceItem.MoveTaskOrderID)

// 		// check the number of moves in the task order queue
// 		// taskOrderMoves, taskOrderMoveCount, err := orderFetcher.ListOrders(
// 		// 	suite.AppContextWithSessionForTest(&session), officeUser.ID, roles.RoleTypeTOO, &services.ListOrderParams{},
// 		// )
// 		suite.FatalNoError(err)
// 		suite.Equal(0, taskOrderMoveCount)
// 		suite.Len(taskOrderMoves, 0)
// 		// suite.Len(taskOrderMoves[0].MTOServiceItems, 1)
// 		// suite.Equal(taskOrderMoves[0].MTOServiceItems[0].Status, models.MTOServiceItemStatusSubmitted)
// //		suite.Equal(taskOrderMoves[0].MTOServiceItems[0].ReService.Code, models.ReServiceCodeDOASIT)
// 		// suite.Equal(taskOrderMoves[1].MTOServiceItems[0].ReService.Code, models.ReServiceCodeDOASIT)

// 		// suite.Len(taskOrderMoves[1].MTOServiceItems, 1)

// 		// check the number of moves in the destination queue
// 		destinationQueueMoves, destinationQueueMoveCount, err := orderFetcher.ListDestinationRequestsOrders(
// 			suite.AppContextWithSessionForTest(&session), officeUser.ID, roles.RoleTypeTOO, &services.ListOrderParams{},
// 		)
// 		suite.FatalNoError(err)
// 		suite.Equal(1, destinationQueueMoveCount)
// 		suite.Len(destinationQueueMoves, 1)
// 		// suite.Len(destinationQueueMoves[0].MTOServiceItems, 1)
// 		// // suite.Len(destinationQueueMoves[1].MTOServiceItems, 1)
// 		// suite.Equal(destinationQueueMoves[0].MTOServiceItems[0].Status, models.MTOServiceItemStatusSubmitted)
// 		// suite.Equal(destinationQueueMoves[0].MTOServiceItems[0].ReService.Code, models.ReServiceCodeDDFSIT)

// 	})

// suite.Run("does not return move with ONLY destination address change", func() {
...
// destinationQueueMove := factory.BuildMoveWithShipment(suite.DB(), []factory.Customization{
// 	{
// 		Model: models.Move{
// 			Status: models.MoveStatusAPPROVALSREQUESTED,
// 			Show:   models.BoolPointer(true),
...
// // destinationQueueMove := factory.BuildAvailableToPrimeMove(suite.DB(), []factory.Customization{
// // 	{
// // 		Model: models.Move{
// // 			Status: models.MoveStatusAPPROVALSREQUESTED,
// // 			Show:   models.BoolPointer(true),
...
// new
// destinationAddressNew := factory.BuildAddress(suite.DB(), []factory.Customization{
// 	{
// 		Model: models.Address{PostalCode: postalCode},
// 	},
// }, nil)

// destinationQueueMoveNew := factory.BuildMoveWithShipment(suite.DB(), []factory.Customization{
// 	{
// 		Model: models.Move{
// 			Status: models.MoveStatusAPPROVALSREQUESTED,
// 			Show:   models.BoolPointer(true),
...
// shipmentNew := factory.BuildMTOShipment(suite.DB(), []factory.Customization{
// 	{
// 		Model: models.MTOShipment{
// 			Status: models.MTOShipmentStatusApproved,
// 		},
// 	},
// 	{
// 		Model:    destinationQueueMoveNew,
// 		LinkOnly: true,
// 	},
// 	{
// 		Model:    destinationAddressNew,
// 		LinkOnly: true,
// 	},
// }, nil)
...
// taskOrderQueueMove := factory.BuildMoveWithShipment(suite.DB(), []factory.Customization{
// 	{
// 		Model: models.Move{
// 			Status: models.MoveStatusAPPROVALSREQUESTED,
// 			Show:   models.BoolPointer(true),
...
// 	},
// }, nil)
// // taskOrderQueueMove := factory.BuildAvailableToPrimeMove(suite.DB(), []factory.Customization{
// 	// {
// 	// 	Model: models.Move{
// 	// 		Status: models.MoveStatusAPPROVALSREQUESTED,
// 	// 		Show:   models.BoolPointer(true),
...
// orderFetcher := NewOrderFetcher()
// taskOrderMoves, taskOrderMoveCount, err := orderFetcher.ListOrders(suite.AppContextWithSessionForTest(&session), tooOfficeUser.ID, roles.RoleTypeTOO, &services.ListOrderParams{})
