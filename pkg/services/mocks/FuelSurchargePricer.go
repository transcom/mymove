...
// Price provides a mock function with given fields: contractCode, actualPickupDate, distance, weight, fscWeightBasedDistanceMultiplier, eiaFuelPrice
func (_m *FuelSurchargePricer) Price(contractCode string, actualPickupDate time.Time, distance unit.Miles, weight unit.Pound, fscWeightBasedDistanceMultiplier float64, eiaFuelPrice unit.Millicents) (unit.Cents, services.PricingDisplayParams, error) {
	ret := _m.Called(contractCode, actualPickupDate, distance, weight, fscWeightBasedDistanceMultiplier, eiaFuelPrice)

	var r0 unit.Cents
	if rf, ok := ret.Get(0).(func(string, time.Time, unit.Miles, unit.Pound, float64, unit.Millicents) unit.Cents); ok {
		r0 = rf(contractCode, actualPickupDate, distance, weight, fscWeightBasedDistanceMultiplier, eiaFuelPrice)
	} else {
	...
	if rf, ok := ret.Get(1).(func(string, time.Time, unit.Miles, unit.Pound, float64, unit.Millicents) services.PricingDisplayParams); ok {
		r1 = rf(contractCode, actualPickupDate, distance, weight, fscWeightBasedDistanceMultiplier, eiaFuelPrice)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(string, time.Time, unit.Miles, unit.Pound, float64, unit.Millicents) error); ok {
		r2 = rf(contractCode, actualPickupDate, distance, weight, fscWeightBasedDistanceMultiplier, eiaFuelPrice)
	} else {
		r2 = ret.Error(2)
	}
