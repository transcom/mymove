...
// NewMTOShipmentCreator creates a new instance of MTOShipmentCreator. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMTOShipmentCreator(t testing.TB) *MTOShipmentCreator {
