...
// IntlShippingAndLinehaulPricer is an autogenerated mock type for the IntlShippingAndLinehaulPricer type
...
func (_m *IntlShippingAndLinehaulPricer) PriceUsingParams(appCtx appcontext.AppContext, params models.PaymentServiceItemParams) (unit.Cents, services.PricingDisplayParams, error) {
...
// NewIntlShippingAndLinehaulPricer creates a new instance of IntlShippingAndLinehaulPricer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIntlShippingAndLinehaulPricer(t interface {
	mock.TestingT
	Cleanup(func())
}) *IntlShippingAndLinehaulPricer {
	mock := &IntlShippingAndLinehaulPricer{}
	mock.Mock.Test(t)
