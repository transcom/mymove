...
// NewPaymentRequestReviewedProcessor creates a new instance of PaymentRequestReviewedProcessor. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewPaymentRequestReviewedProcessor(t testing.TB) *PaymentRequestReviewedProcessor {
