...
// TransportationOfficeAssignmentUpdater is an autogenerated mock type for the TransportationOfficeAssignmentUpdater type
...
func (_m *TransportationOfficeAssignmentUpdater) UpdateTransportationOfficeAssignments(appCtx appcontext.AppContext, officeUserId uuid.UUID, transportationOfficeAssignments models.TransportationOfficeAssignments) (models.TransportationOfficeAssignments, error) {
...
// NewTransportationOfficeAssignmentUpdater creates a new instance of TransportationOfficeAssignmentUpdater. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewTransportationOfficeAssignmentUpdater(t interface {
	mock.TestingT
	Cleanup(func())
}) *TransportationOfficeAssignmentUpdater {
	mock := &TransportationOfficeAssignmentUpdater{}
	mock.Mock.Test(t)
