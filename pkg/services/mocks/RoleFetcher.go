...
// RoleFetcher is an autogenerated mock type for the RoleFetcher type
type RoleFetcher struct {
	mock.Mock
}

// FetchRoleTypes provides a mock function with given fields: appCtx
func (_m *RoleFetcher) FetchRoleTypes(appCtx appcontext.AppContext) ([]roles.RoleType, error) {
...
func (_m *RoleFetcher) FetchRolesForUser(appCtx appcontext.AppContext, userID uuid.UUID) (roles.Roles, error) {
...
func (_m *RoleFetcher) FetchRolesPrivileges(appCtx appcontext.AppContext) ([]roles.Role, error) {
	ret := _m.Called(appCtx)
...
// NewRoleFetcher creates a new instance of RoleFetcher. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewRoleFetcher(t interface {
	mock.TestingT
	Cleanup(func())
}) *RoleFetcher {
	mock := &RoleFetcher{}
