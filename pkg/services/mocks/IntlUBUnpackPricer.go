...
// IntlUBUnpackPricer is an autogenerated mock type for the IntlUBUnpackPricer type
...
func (_m *IntlUBUnpackPricer) Price(appCtx appcontext.AppContext, contractCode string, requestedPickupDate time.Time, weight unit.Pound, perUnitCents int) (unit.Cents, services.PricingDisplayParams, error) {
...
func (_m *IntlUBUnpackPricer) PriceUsingParams(appCtx appcontext.AppContext, params models.PaymentServiceItemParams) (unit.Cents, services.PricingDisplayParams, error) {
...
// NewIntlUBUnpackPricer creates a new instance of IntlUBUnpackPricer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIntlUBUnpackPricer(t interface {
	mock.TestingT
	Cleanup(func())
}) *IntlUBUnpackPricer {
	mock := &IntlUBUnpackPricer{}
	mock.Mock.Test(t)
