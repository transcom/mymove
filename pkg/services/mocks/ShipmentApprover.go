...
// ApproveShipment provides a mock function with given fields: shipmentID, eTag
func (_m *ShipmentApprover) ApproveShipment(shipmentID uuid.UUID, eTag string) (*models.MTOShipment, error) {
