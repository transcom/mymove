...
// IntlUBPackPricer is an autogenerated mock type for the IntlUBPackPricer type
...
func (_m *IntlUBPackPricer) Price(appCtx appcontext.AppContext, contractCode string, requestedPickupDate time.Time, weight unit.Pound, perUnitCents int) (unit.Cents, services.PricingDisplayParams, error) {
...
func (_m *IntlUBPackPricer) PriceUsingParams(appCtx appcontext.AppContext, params models.PaymentServiceItemParams) (unit.Cents, services.PricingDisplayParams, error) {
...
// NewIntlUBPackPricer creates a new instance of IntlUBPackPricer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIntlUBPackPricer(t interface {
	mock.TestingT
	Cleanup(func())
}) *IntlUBPackPricer {
	mock := &IntlUBPackPricer{}
	mock.Mock.Test(t)
