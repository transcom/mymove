...
// NewWebhookSubscriptionUpdater creates a new instance of WebhookSubscriptionUpdater. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewWebhookSubscriptionUpdater(t testing.TB) *WebhookSubscriptionUpdater {
