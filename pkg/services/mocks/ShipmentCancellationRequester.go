...
// RequestShipmentCancellation provides a mock function with given fields: shipmentID, eTag
func (_m *ShipmentCancellationRequester) RequestShipmentCancellation(shipmentID uuid.UUID, eTag string) (*models.MTOShipment, error) {
