...
// PrivilegeAssociator is an autogenerated mock type for the PrivilegeAssociator type
type PrivilegeAssociator struct {
	mock.Mock
}

// FetchPrivilegeTypes provides a mock function with given fields: appCtx
func (_m *PrivilegeAssociator) FetchPrivilegeTypes(appCtx appcontext.AppContext) ([]roles.PrivilegeType, error) {
...
func (_m *PrivilegeAssociator) FetchPrivilegesForUser(appCtx appcontext.AppContext, userID uuid.UUID) (roles.Privileges, error) {
...
// NewPrivilegeAssociator creates a new instance of PrivilegeAssociator. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPrivilegeAssociator(t interface {
	mock.TestingT
	Cleanup(func())
}) *PrivilegeAssociator {
	mock := &PrivilegeAssociator{}
	mock.Mock.Test(t)
