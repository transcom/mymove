...
type mockConstructorTestingTNewTransportationServiceProviderPerformanceListFetcher interface {
	mock.TestingT
	Cleanup(func())
}

// NewTransportationServiceProviderPerformanceListFetcher creates a new instance of TransportationServiceProviderPerformanceListFetcher. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewTransportationServiceProviderPerformanceListFetcher(t mockConstructorTestingTNewTransportationServiceProviderPerformanceListFetcher) *TransportationServiceProviderPerformanceListFetcher {
