...
// NewPaymentRequestStatusUpdater creates a new instance of PaymentRequestStatusUpdater. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewPaymentRequestStatusUpdater(t testing.TB) *PaymentRequestStatusUpdater {
