...
type mockConstructorTestingTNewDomesticNTSPackPricer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDomesticNTSPackPricer(t mockConstructorTestingTNewDomesticNTSPackPricer) *DomesticNTSPackPricer {
