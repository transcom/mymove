...
// IntlNTSHHGPackPricer is an autogenerated mock type for the IntlNTSHHGPackPricer type
type IntlNTSHHGPackPricer struct {
	mock.Mock
}

// Price provides a mock function with given fields: appCtx, contractCode, referenceDate, weight, perUnitCents
func (_m *IntlNTSHHGPackPricer) Price(appCtx appcontext.AppContext, contractCode string, referenceDate time.Time, weight unit.Pound, perUnitCents int) (unit.Cents, services.PricingDisplayParams, error) {
	ret := _m.Called(appCtx, contractCode, referenceDate, weight, perUnitCents)
	...
	if rf, ok := ret.Get(2).(func(appcontext.AppContext, string, time.Time, unit.Pound, int) error); ok {
		r2 = rf(appCtx, contractCode, referenceDate, weight, perUnitCents)
	} else {
		r2 = ret.Error(2)
	}
...
func (_m *IntlNTSHHGPackPricer) PriceUsingParams(appCtx appcontext.AppContext, params models.PaymentServiceItemParams) (unit.Cents, services.PricingDisplayParams, error) {
...
// NewIntlNTSHHGPackPricer creates a new instance of IntlNTSHHGPackPricer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIntlNTSHHGPackPricer(t interface {
	mock.TestingT
	Cleanup(func())
}) *IntlNTSHHGPackPricer {
	mock := &IntlNTSHHGPackPricer{}
	mock.Mock.Test(t)
