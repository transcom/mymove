...
type mockConstructorTestingTNewTransportationServiceProviderPerformanceFetcher interface {
	mock.TestingT
	Cleanup(func())
}

// NewTransportationServiceProviderPerformanceFetcher creates a new instance of TransportationServiceProviderPerformanceFetcher. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewTransportationServiceProviderPerformanceFetcher(t mockConstructorTestingTNewTransportationServiceProviderPerformanceFetcher) *TransportationServiceProviderPerformanceFetcher {
