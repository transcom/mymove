...
// IntlHHGPackPricer is an autogenerated mock type for the IntlHHGPackPricer type
...
func (_m *IntlHHGPackPricer) Price(appCtx appcontext.AppContext, contractCode string, requestedPickupDate time.Time, weight unit.Pound, perUnitCents int) (unit.Cents, services.PricingDisplayParams, error) {
...
func (_m *IntlHHGPackPricer) PriceUsingParams(appCtx appcontext.AppContext, params models.PaymentServiceItemParams) (unit.Cents, services.PricingDisplayParams, error) {
...
// NewIntlHHGPackPricer creates a new instance of IntlHHGPackPricer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIntlHHGPackPricer(t interface {
	mock.TestingT
	Cleanup(func())
}) *IntlHHGPackPricer {
	mock := &IntlHHGPackPricer{}
	mock.Mock.Test(t)
