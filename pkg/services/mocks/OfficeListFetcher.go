...
// NewOfficeListFetcher creates a new instance of OfficeListFetcher. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewOfficeListFetcher(t testing.TB) *OfficeListFetcher {
