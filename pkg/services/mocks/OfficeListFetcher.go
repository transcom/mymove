...
// FetchOfficeCount provides a mock function with given fields: appCfg, filters
func (_m *OfficeListFetcher) FetchOfficeCount(appCfg appconfig.AppConfig, filters []services.QueryFilter) (int, error) {
...
// FetchOfficeList provides a mock function with given fields: appCfg, filters, associations, pagination, ordering
func (_m *OfficeListFetcher) FetchOfficeList(appCfg appconfig.AppConfig, filters []services.QueryFilter, associations services.QueryAssociations, pagination services.Pagination, ordering services.QueryOrder) (models.TransportationOffices, error) {
	ret := _m.Called(appCfg, filters, associations, pagination, ordering)

	var r0 models.TransportationOffices
	if rf, ok := ret.Get(0).(func(appconfig.AppConfig, []services.QueryFilter, services.QueryAssociations, services.Pagination, services.QueryOrder) models.TransportationOffices); ok {
