...
// NewPaymentRequestCreator creates a new instance of PaymentRequestCreator. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewPaymentRequestCreator(t testing.TB) *PaymentRequestCreator {
