...
func (_m *ManagementServicesPricer) Price(contractCode string, mtoAvailableToPrimeAt time.Time) (unit.Cents, []services.PricingParam, error) {
...
func (_m *ManagementServicesPricer) PriceUsingParams(params models.PaymentServiceItemParams) (unit.Cents, []services.PricingParam, error) {
