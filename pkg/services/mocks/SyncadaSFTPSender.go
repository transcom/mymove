...
// NewSyncadaSFTPSender creates a new instance of SyncadaSFTPSender. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSyncadaSFTPSender(t testing.TB) *SyncadaSFTPSender {
