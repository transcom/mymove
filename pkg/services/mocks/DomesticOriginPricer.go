...
type mockConstructorTestingTNewDomesticOriginPricer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDomesticOriginPricer(t mockConstructorTestingTNewDomesticOriginPricer) *DomesticOriginPricer {
