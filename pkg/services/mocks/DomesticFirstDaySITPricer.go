...
type mockConstructorTestingTNewDomesticFirstDaySITPricer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDomesticFirstDaySITPricer(t mockConstructorTestingTNewDomesticFirstDaySITPricer) *DomesticFirstDaySITPricer {
