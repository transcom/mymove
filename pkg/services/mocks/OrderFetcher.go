...
// ListOriginRequestsOrders provides a mock function with given fields: appCtx, officeUserID, params
func (_m *OrderFetcher) ListOriginRequestsOrders(appCtx appcontext.AppContext, officeUserID uuid.UUID, params *services.ListOrderParams) ([]models.Move, int, error) {
	ret := _m.Called(appCtx, officeUserID, params)
