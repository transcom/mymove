...
// NewMoveHistoryFetcher creates a new instance of MoveHistoryFetcher. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMoveHistoryFetcher(t testing.TB) *MoveHistoryFetcher {
