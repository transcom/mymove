...
// IntlHHGUnpackPricer is an autogenerated mock type for the IntlHHGUnpackPricer type
...
func (_m *IntlHHGUnpackPricer) Price(appCtx appcontext.AppContext, contractCode string, requestedPickupDate time.Time, weight unit.Pound, perUnitCents int) (unit.Cents, services.PricingDisplayParams, error) {
...
func (_m *IntlHHGUnpackPricer) PriceUsingParams(appCtx appcontext.AppContext, params models.PaymentServiceItemParams) (unit.Cents, services.PricingDisplayParams, error) {
...
// NewIntlHHGUnpackPricer creates a new instance of IntlHHGUnpackPricer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIntlHHGUnpackPricer(t interface {
	mock.TestingT
	Cleanup(func())
}) *IntlHHGUnpackPricer {
	mock := &IntlHHGUnpackPricer{}
	mock.Mock.Test(t)
