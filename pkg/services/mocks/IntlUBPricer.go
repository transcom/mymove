...
// IntlUBPricer is an autogenerated mock type for the IntlUBPricer type
...
func (_m *IntlUBPricer) Price(appCtx appcontext.AppContext, contractCode string, requestedPickupDate time.Time, weight unit.Pound, perUnitCents int) (unit.Cents, services.PricingDisplayParams, error) {
...
func (_m *IntlUBPricer) PriceUsingParams(appCtx appcontext.AppContext, params models.PaymentServiceItemParams) (unit.Cents, services.PricingDisplayParams, error) {
...
// NewIntlUBPricer creates a new instance of IntlUBPricer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIntlUBPricer(t interface {
	mock.TestingT
	Cleanup(func())
}) *IntlUBPricer {
	mock := &IntlUBPricer{}
