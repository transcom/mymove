...
type mockConstructorTestingTNewPPMShipmentReviewDocuments interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewPPMShipmentReviewDocuments(t mockConstructorTestingTNewPPMShipmentReviewDocuments) *PPMShipmentReviewDocuments {
