...
// NewOfficeUserFetcher creates a new instance of OfficeUserFetcher. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewOfficeUserFetcher(t testing.TB) *OfficeUserFetcher {
