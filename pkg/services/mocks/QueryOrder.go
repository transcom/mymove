...
// NewQueryOrder creates a new instance of QueryOrder. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewQueryOrder(t testing.TB) *QueryOrder {
	mock := &QueryOrder{}
	mock.Mock.Test(t)
