...
// NewWebhookSubscriptionFetcher creates a new instance of WebhookSubscriptionFetcher. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewWebhookSubscriptionFetcher(t testing.TB) *WebhookSubscriptionFetcher {
