...
type mockConstructorTestingTNewCustomerSupportRemarksFetcher interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewCustomerSupportRemarksFetcher(t mockConstructorTestingTNewCustomerSupportRemarksFetcher) *CustomerSupportRemarksFetcher {
