...
// NewSFTPFiler creates a new instance of SFTPFiler. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSFTPFiler(t testing.TB) *SFTPFiler {
	mock := &SFTPFiler{}
	mock.Mock.Test(t)
