...
// NewMTOAgentUpdater creates a new instance of MTOAgentUpdater. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMTOAgentUpdater(t testing.TB) *MTOAgentUpdater {
