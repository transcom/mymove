...
// NewGHCPaymentRequestInvoiceGenerator creates a new instance of GHCPaymentRequestInvoiceGenerator. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewGHCPaymentRequestInvoiceGenerator(t testing.TB) *GHCPaymentRequestInvoiceGenerator {
