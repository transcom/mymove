...
func (_m *MTOShipmentUpdater) UpdateMTOShipment(appCtx appcontext.AppContext, mtoShipment *models.MTOShipmentUpdate, eTag string) (*models.MTOShipment, error) {
...
type mockConstructorTestingTNewMTOShipmentUpdater interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMTOShipmentUpdater(t mockConstructorTestingTNewMTOShipmentUpdater) *MTOShipmentUpdater {
