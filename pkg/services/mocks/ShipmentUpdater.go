...
// UpdateShipmentOffice provides a mock function with given fields: appCtx, shipment, eTag
func (_m *ShipmentUpdater) UpdateShipmentOffice(appCtx appcontext.AppContext, shipment *models.MTOShipment, eTag string) (*models.MTOShipment, error) {
	ret := _m.Called(appCtx, shipment, eTag)
