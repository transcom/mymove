...
type mockConstructorTestingTNewWeightTicketUpdater interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewWeightTicketUpdater(t mockConstructorTestingTNewWeightTicketUpdater) *WeightTicketUpdater {
