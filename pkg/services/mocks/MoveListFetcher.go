...
// NewMoveListFetcher creates a new instance of MoveListFetcher. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMoveListFetcher(t testing.TB) *MoveListFetcher {
