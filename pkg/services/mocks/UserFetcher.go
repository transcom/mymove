...
// NewUserFetcher creates a new instance of UserFetcher. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewUserFetcher(t testing.TB) *UserFetcher {
	mock := &UserFetcher{}
	mock.Mock.Test(t)
