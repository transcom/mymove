...
type mockConstructorTestingTNewDomesticOriginSITPickupPricer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDomesticOriginSITPickupPricer(t mockConstructorTestingTNewDomesticOriginSITPickupPricer) *DomesticOriginSITPickupPricer {
