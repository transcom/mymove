...
// NewSFTPClient creates a new instance of SFTPClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSFTPClient(t testing.TB) *SFTPClient {
	mock := &SFTPClient{}
	mock.Mock.Test(t)
