...
// FetchAndLockReviewedPaymentRequest provides a mock function with given fields:
func (_m *PaymentRequestReviewedFetcher) FetchAndLockReviewedPaymentRequest() (models.PaymentRequests, error) {
	ret := _m.Called()
