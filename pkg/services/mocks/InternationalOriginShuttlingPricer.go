...
// InternationalOriginShuttlingPricer is an autogenerated mock type for the InternationalOriginShuttlingPricer type
...
func (_m *InternationalOriginShuttlingPricer) PriceUsingParams(appCtx appcontext.AppContext, params models.PaymentServiceItemParams) (unit.Cents, services.PricingDisplayParams, error) {
...
// NewInternationalOriginShuttlingPricer creates a new instance of InternationalOriginShuttlingPricer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewInternationalOriginShuttlingPricer(t interface {
	mock.TestingT
	Cleanup(func())
}) *InternationalOriginShuttlingPricer {
	mock := &InternationalOriginShuttlingPricer{}
	mock.Mock.Test(t)
