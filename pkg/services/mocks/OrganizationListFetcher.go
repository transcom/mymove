...
// NewOrganizationListFetcher creates a new instance of OrganizationListFetcher. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewOrganizationListFetcher(t testing.TB) *OrganizationListFetcher {
