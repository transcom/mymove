...
type mockConstructorTestingTNewDomesticShorthaulPricer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDomesticShorthaulPricer(t mockConstructorTestingTNewDomesticShorthaulPricer) *DomesticShorthaulPricer {
