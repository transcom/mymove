...
// FetchMovesForPPTASReports provides a mock function with given fields: appCtx, params, clientCert
func (_m *MoveFetcher) FetchMovesForPPTASReports(appCtx appcontext.AppContext, params *services.MovesForPPTASFetcherParams, clientCert models.ClientCert) (models.Moves, error) {
