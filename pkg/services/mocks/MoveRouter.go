...
// NewMoveRouter creates a new instance of MoveRouter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMoveRouter(t testing.TB) *MoveRouter {
	mock := &MoveRouter{}
	mock.Mock.Test(t)
