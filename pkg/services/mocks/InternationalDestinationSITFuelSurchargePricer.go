...
// InternationalDestinationSITFuelSurchargePricer is an autogenerated mock type for the InternationalDestinationSITFuelSurchargePricer type
...
func (_m *InternationalDestinationSITFuelSurchargePricer) PriceUsingParams(appCtx appcontext.AppContext, params models.PaymentServiceItemParams) (unit.Cents, services.PricingDisplayParams, error) {
...
// NewInternationalDestinationSITFuelSurchargePricer creates a new instance of InternationalDestinationSITFuelSurchargePricer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewInternationalDestinationSITFuelSurchargePricer(t interface {
	mock.TestingT
	Cleanup(func())
}) *InternationalDestinationSITFuelSurchargePricer {
	mock := &InternationalDestinationSITFuelSurchargePricer{}
	mock.Mock.Test(t)
