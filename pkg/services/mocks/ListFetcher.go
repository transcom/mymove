...
// NewListFetcher creates a new instance of ListFetcher. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewListFetcher(t testing.TB) *ListFetcher {
	mock := &ListFetcher{}
	mock.Mock.Test(t)
