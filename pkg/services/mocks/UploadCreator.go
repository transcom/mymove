...
// NewUploadCreator creates a new instance of UploadCreator. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewUploadCreator(t testing.TB) *UploadCreator {
	mock := &UploadCreator{}
	mock.Mock.Test(t)
