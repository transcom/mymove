...
func (suite *GHCRateEngineImportSuite) helperCheckInternationalPriceValues() {
	...
	testCases := []struct {
		...
		// 3a: OCONUS to OCONUS
		{models.ReServiceCodeISLH, "GE", "US8101000", false, 1021},
		{models.ReServiceCodeUBP, "GE", "US8101000", false, 1717},
		{models.ReServiceCodeISLH, "GE", "US8101000", true, 1205},
		{models.ReServiceCodeUBP, "GE", "US8101000", true, 2026},
		// 3b: CONUS to OCONUS
		{models.ReServiceCodeISLH, "US47", "AS11", false, 3090},
		{models.ReServiceCodeUBP, "US47", "AS11", false, 3398},
		{models.ReServiceCodeISLH, "US47", "AS11", true, 3646},
		{models.ReServiceCodeUBP, "US47", "AS11", true, 4010},
		// 3c: OCONUS to CONUS
		{models.ReServiceCodeISLH, "US8101000", "US68", false, 1757},
		{models.ReServiceCodeUBP, "US8101000", "US68", false, 3445},
		{models.ReServiceCodeISLH, "US8101000", "US68", true, 2073},
		{models.ReServiceCodeUBP, "US8101000", "US68", true, 4065},
		// 3e: NSRA to NSRA
		{models.ReServiceCodeISLH, "NSRA2", "NSRA13", false, 4849},
		{models.ReServiceCodeUBP, "NSRA2", "NSRA13", false, 4793},
		{models.ReServiceCodeISLH, "NSRA2", "NSRA13", true, 5722},
		{models.ReServiceCodeUBP, "NSRA2", "NSRA13", true, 5656},
		// 3e: NSRA to OCONUS
		{models.ReServiceCodeISLH, "NSRA13", "AS11", false, 5172},
		{models.ReServiceCodeUBP, "NSRA13", "AS11", false, 1175},
		{models.ReServiceCodeISLH, "NSRA13", "AS11", true, 6103},
		{models.ReServiceCodeUBP, "NSRA13", "AS11", true, 1386},
		// 3e: OCONUS to NSRA
		{models.ReServiceCodeISLH, "GE", "NSRA2", false, 4872},
		{models.ReServiceCodeUBP, "GE", "NSRA2", false, 1050},
		{models.ReServiceCodeISLH, "GE", "NSRA2", true, 5749},
		{models.ReServiceCodeUBP, "GE", "NSRA2", true, 1239},
		// 3e: NSRA to CONUS
		{models.ReServiceCodeISLH, "NSRA2", "US4965500", false, 931},
		{models.ReServiceCodeUBP, "NSRA2", "US4965500", false, 1717},
		{models.ReServiceCodeISLH, "NSRA2", "US4965500", true, 1099},
		{models.ReServiceCodeUBP, "NSRA2", "US4965500", true, 2026},
		// 3e: CONUS to NSRA
		{models.ReServiceCodeISLH, "US68", "NSRA13", false, 1065},
		{models.ReServiceCodeUBP, "US68", "NSRA13", false, 1689},
		{models.ReServiceCodeISLH, "US68", "NSRA13", true, 1257},
		{models.ReServiceCodeUBP, "US68", "NSRA13", true, 1993},
	}
