...
type TransportationOfficesFetcher interface {
	GetTransportationOffice(appCtx appcontext.AppContext, transportatioOfficeID uuid.UUID, includeOnlyPPMCloseoutOffices bool) (*models.TransportationOffice, error)
