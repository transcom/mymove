...
func (SSWPPMComputer SSWPPMComputer) FormatValuesShipmentSummaryWorksheet(shipmentSummaryFormData models.ShipmentSummaryFormData, isPaymentPacket bool) (services.Page1Values, services.Page2Values) {
	page1 := SSWPPMComputer.FormatValuesShipmentSummaryWorksheetFormPage1(shipmentSummaryFormData, isPaymentPacket)
	page2 := SSWPPMComputer.FormatValuesShipmentSummaryWorksheetFormPage2(shipmentSummaryFormData, isPaymentPacket)
...
func (s SSWPPMComputer) FormatValuesShipmentSummaryWorksheetFormPage1(data models.ShipmentSummaryFormData, isPaymentPacket bool) services.Page1Values {
	...
	formattedShipments := s.FormatAllShipments(data)
	...
	if isPaymentPacket {
		...
		page1.ActualObligationGCC100 = formattedShipments.ShipmentWeightForObligation + " - Actual lbs; "
	}
...
func (s SSWPPMComputer) FormatValuesShipmentSummaryWorksheetFormPage2(data models.ShipmentSummaryFormData, isPaymentPacket bool) services.Page2Values {
...
func (s SSWPPMComputer) FormatAllShipments(data models.ShipmentSummaryFormData) models.WorkSheetShipments {
	totalShipments := len(data.PPMShipments)
	formattedShipments := models.WorkSheetShipments{}
	...
	for _, ppm := range data.PPMShipments {
		...
		// Calculate Shipment Total Weight
		formattedShipmentTotalWeights = s.calculateShipmentTotalWeight(ppm, data.WeightAllotment)
		shipmentNumber++
	}
