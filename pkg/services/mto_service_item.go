...
type MTOServiceItemUpdater interface {
	...
	ConvertItemToMembersExpense(appCtx appcontext.AppContext, mtoServiceItemID uuid.UUID, convertToMembersExpense bool, eTag string) (*models.MTOServiceItem, error)
}
