...
func NewShipmentDiversionApprover(db *pop.Connection, router services.ShipmentRouter) services.ShipmentDiversionApprover {
...
func (f *shipmentDiversionApprover) ApproveShipmentDiversion(shipmentID uuid.UUID, eTag string) (*models.MTOShipment, error) {
	...
	err = f.router.ApproveDiversion(shipment)
	if err != nil {
		return nil, err
	}
...
func (f *shipmentDiversionApprover) findShipment(shipmentID uuid.UUID) (*models.MTOShipment, error) {
