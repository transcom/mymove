...
func (f mtoShipmentCreator) CreateMTOShipment(appCtx appcontext.AppContext, shipment *models.MTOShipment) (*models.MTOShipment, error) {
	...
	if (shipment.ShipmentType == models.MTOShipmentTypeHHG || isBoatShipment || shipment.ShipmentType == models.MTOShipmentTypeUnaccompaniedBaggage) && shipment.DestinationAddress == nil {
