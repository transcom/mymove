...
func (f mtoShipmentFetcher) ListMTOShipments(appCtx appcontext.AppContext, moveID uuid.UUID) ([]models.MTOShipment, error) {
	...
	err = appCtx.DB().Scope(utilities.ExcludeDeletedScope()).
		EagerPreload(
			...
			"PPMShipment.PickupAddress.State",
			"PPMShipment.PickupAddress.Country",
			"PPMShipment.SecondaryPickupAddress.State",
			"PPMShipment.SecondaryPickupAddress.Country",
			"PPMShipment.TertiaryPickupAddress.State",
			"PPMShipment.TertiaryPickupAddress.Country",
			"PPMShipment.DestinationAddress.State",
			"PPMShipment.DestinationAddress.Country",
			"PPMShipment.SecondaryDestinationAddress.State",
			"PPMShipment.SecondaryDestinationAddress.Country",
			"PPMShipment.TertiaryDestinationAddress.State",
