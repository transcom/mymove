...
func (f mtoShipmentRateAreaFetcher) GetPrimeMoveShipmentRateAreas(appCtx appcontext.AppContext, moveTaskOrder models.Move) (*[]services.ShipmentPostalCodeRateArea, error) {
	...
	for _, shipment := range moveTaskOrder.MTOShipments {
		if shipment.PickupAddress != nil {
			if !slices.Contains(oconusPostalCodes, shipment.PickupAddress.PostalCode) && *shipment.PickupAddress.IsOconus {
		...
		if shipment.DestinationAddress != nil {
			if !slices.Contains(oconusPostalCodes, shipment.DestinationAddress.PostalCode) && *shipment.DestinationAddress.IsOconus {
		...
		if shipment.PPMShipment != nil {
			if shipment.PPMShipment.PickupAddress != nil {
				if !slices.Contains(oconusPostalCodes, shipment.PPMShipment.PickupAddress.PostalCode) && *shipment.PPMShipment.PickupAddress.IsOconus {
			...
			if shipment.PPMShipment.DestinationAddress != nil {
				if !slices.Contains(oconusPostalCodes, shipment.PPMShipment.DestinationAddress.PostalCode) && *shipment.PPMShipment.DestinationAddress.IsOconus {
