...
func (suite *PricingParserSuite) Test_parseShipmentManagementServicesPrices() {
	...
	suite.T().Run("parse sheet and check csv", func(t *testing.T) {
		slice, err := parseShipmentManagementServicesPrices(params, sheetIndex, suite.logger)
	...
	suite.T().Run("try parse wrong sheet index", func(t *testing.T) {
		_, err := parseShipmentManagementServicesPrices(params, sheetIndex-1, suite.logger)
...
func (suite *PricingParserSuite) Test_parseCounselServicesPrices() {
	...
	suite.T().Run("parse sheet and check csv", func(t *testing.T) {
		slice, err := parseCounselingServicesPrices(params, sheetIndex, suite.logger)
	...
	suite.T().Run("try parse wrong sheet index", func(t *testing.T) {
		_, err := parseCounselingServicesPrices(params, sheetIndex-1, suite.logger)
...
func (suite *PricingParserSuite) Test_parseTransitionPrices() {
	...
	suite.T().Run("parse sheet and check csv", func(t *testing.T) {
		slice, err := parseTransitionPrices(params, sheetIndex, suite.logger)
	...
	suite.T().Run("try parse wrong sheet index", func(t *testing.T) {
		_, err := parseTransitionPrices(params, sheetIndex-1, suite.logger)
