...
// ZipTransitDistance provides a mock function with given fields: appCtx, source, destination, isInternationalShipment
func (_m *Planner) ZipTransitDistance(appCtx appcontext.AppContext, source string, destination string, isInternationalShipment bool) (int, error) {
	ret := _m.Called(appCtx, source, destination, isInternationalShipment)
	...
	if rf, ok := ret.Get(0).(func(appcontext.AppContext, string, string, bool) (int, error)); ok {
		return rf(appCtx, source, destination, isInternationalShipment)
	}
	if rf, ok := ret.Get(0).(func(appcontext.AppContext, string, string, bool) int); ok {
		r0 = rf(appCtx, source, destination, isInternationalShipment)
	} else {
		r0 = ret.Get(0).(int)
	}

	if rf, ok := ret.Get(1).(func(appcontext.AppContext, string, string, bool) error); ok {
		r1 = rf(appCtx, source, destination, isInternationalShipment)
	} else {
		r1 = ret.Error(1)
	}
