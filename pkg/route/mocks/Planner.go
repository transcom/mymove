...
// ZipTransitDistance provides a mock function with given fields: appCtx, source, destination, useDTOD, isInternationalShipment
func (_m *Planner) ZipTransitDistance(appCtx appcontext.AppContext, source string, destination string, useDTOD bool, isInternationalShipment bool) (int, error) {
	ret := _m.Called(appCtx, source, destination, useDTOD, isInternationalShipment)
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(appcontext.AppContext, string, string, bool, bool) (int, error)); ok {
		return rf(appCtx, source, destination, useDTOD, isInternationalShipment)
	}
	if rf, ok := ret.Get(0).(func(appcontext.AppContext, string, string, bool, bool) int); ok {
		r0 = rf(appCtx, source, destination, useDTOD, isInternationalShipment)
	} else {
		r0 = ret.Get(0).(int)
	}

	if rf, ok := ret.Get(1).(func(appcontext.AppContext, string, string, bool, bool) error); ok {
		r1 = rf(appCtx, source, destination, useDTOD, isInternationalShipment)
	} else {
		r1 = ret.Error(1)
	}
