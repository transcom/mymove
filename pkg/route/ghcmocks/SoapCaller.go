...
// NewSoapCaller creates a new instance of SoapCaller. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSoapCaller(t testing.TB) *SoapCaller {
	mock := &SoapCaller{}
	mock.Mock.Test(t)
