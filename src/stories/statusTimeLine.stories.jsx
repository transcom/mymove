    ...
    statuses={[
      {
        ...
        dates: [date('StatusBlock1.Date1', dayjs('2020-02-02').subtract(8, 'days').toDate(), 'Block 1')],
      },
      {
        ...
        dates: [date('StatusBlock2.Date1', dayjs('2020-02-02').subtract(6, 'days').toDate(), 'Block 2')],
      },
      {
        ...
        dates: [date('StatusBlock3.Date1', dayjs('2020-02-02').subtract(5, 'days').toDate(), 'Block 3')],
      },
      {
        ...
        dates: [date('StatusBlock4.Date1', dayjs('2020-02-02').subtract(4, 'days').toDate(), 'Block 4')],
      },
      {
        ...
        dates: [date('StatusBlock5.Date1', dayjs('2020-02-02').subtract(2, 'days').toDate(), 'Block 5')],
      },
    ]}
  />
);
