...
const SERVICE_ITEM_PARAM_KEYS = {
  ...
  SITRateAreaDest: 'SITRateAreaDest',
  SITServiceAreaOrigin: 'SITServiceAreaOrigin',
  SITRateAreaOrigin: 'SITRateAreaOrigin',
...
const SERVICE_ITEM_CALCULATION_LABELS = {
  ...
  [SERVICE_ITEM_PARAM_KEYS.SITRateAreaDest]: 'SIT destination rate area',
  [SERVICE_ITEM_PARAM_KEYS.SITRateAreaOrigin]: 'SIT origin rate area',
