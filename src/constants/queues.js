...
export const SERVICE_COUNSELING_MOVE_SEARCH_QUEUE_STATUS_FILTER_OPTIONS = [
...
export const ROLE_TYPE_OPTIONS = {
  [roleTypes.SERVICES_COUNSELOR]: SERVICE_COUNSELING_MOVE_SEARCH_QUEUE_STATUS_FILTER_OPTIONS,
