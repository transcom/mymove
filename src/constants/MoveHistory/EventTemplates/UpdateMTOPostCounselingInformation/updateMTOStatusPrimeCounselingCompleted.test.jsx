...
import e from 'constants/MoveHistory/EventTemplates/UpdateMTOPostCounselingInformation/updateMTOStatusPrimeCounselingCompleted';
...
describe('When given a completed services counseling for a move', () => {
  ...
  it('displays the proper message in the details column', () => {
    ...
    expect(screen.getByText('Prime Counseling Completed')).toBeInTheDocument();
  });
