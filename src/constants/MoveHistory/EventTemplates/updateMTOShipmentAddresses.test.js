...
describe('when given an mto shipment update with address table history record', () => {
  ...
  it('correctly matches the Update mto shipment address event for secondary pickup addresses', () => {
    const result = getTemplate(item);
    expect(result).toMatchObject(e);
    // expect to have formatted the addresses correctly
    expect(
  ...
  it('correctly matches the Update mto shipment address event for secondary destination addresses', () => {
    const result = getTemplate(item);
    expect(result).toMatchObject(e);
    // expect to have formatted the addresses correctly
    expect(
