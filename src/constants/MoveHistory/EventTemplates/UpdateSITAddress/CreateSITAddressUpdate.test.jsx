...
describe('When given an update Destination SIT address history record', () => {
  const historyRecord = {
    action: a.INSERT,
    changedValues: {
      office_remarks: 'Customer would love to have their goods stored in Florence',
      status: 'APPROVED',
    },
    context: [
      {
  ...
  it('displays the contractor remarks', () => {
    ...
    expect(screen.getByText(': Customer would love to have their goods stored in Florence')).toBeInTheDocument();
  });
});
