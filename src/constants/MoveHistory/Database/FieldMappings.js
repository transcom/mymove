export default {
  ...
  has_gun_safe: 'Gun safe',
  gun_safe_weight: 'Gun safe weight',
  gun_safe_weight_allowance: 'Gun safe weight allowance',
  required_medical_equipment_weight: 'Required medical equipment',
  organizational_clothing_and_individual_equipment: 'OCIE',
  gun_safe: 'Gun safe',
  gun_safe_authorized: 'Gun safe authorized',
  admin_restricted_weight_location: 'Admin restricted weight location',
  admin_restricted_ub_weight_location: 'Admin restricted UB weight location',
  ...
  customer_expense: 'Converted to customer expense',
  customer_expense_reason: 'Reason',
  requested_days: 'Requested days',
  approved_days: 'Approved days',
  decision_date: 'Decision date',
  request_reason: 'Request reason',
  sit_days_allowance: 'SIT days allowance',
  ...
  estimated_incentive: 'Estimated incentive',
  max_incentive: 'Max incentive',
  ppm_type: 'PPM type',
  ...
  assigned_sc_counseling: 'Counselor assigned',
  assigned_sc_closeout: 'Closeout counselor assigned',
  assigned_too_task_order: 'Task ordering officer assigned',
  assigned_too_destination: 'Destination task ordering officer assigned',
  ...
  shipment_seq_num: 'Shipment count',
};
