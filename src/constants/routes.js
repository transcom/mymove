...
export const customerRoutes = {
  ...
  SHIPMENT_PPM_GUN_SAFE_PATH: `/moves/:moveId/shipments/:mtoShipmentId/gun-safe`,
  SHIPMENT_PPM_GUN_SAFE_EDIT_PATH: `/moves/:moveId/shipments/:mtoShipmentId/gun-safe/:gunSafeId`,
...
export const servicesCounselingRoutes = {
  ...
  BASE_SHIPMENT_PPM_GUN_SAFE_PATH: `${BASE_COUNSELING_MOVE_PATH}/shipments/:shipmentId/gun-safe`,
  SHIPMENT_PPM_GUN_SAFE_PATH: `shipments/:shipmentId/gun-safe`,
  BASE_SHIPMENT_PPM_GUN_SAFE_EDIT_PATH: `${BASE_COUNSELING_MOVE_PATH}/shipments/:shipmentId/gun-safe/:gunSafeId`,
  SHIPMENT_PPM_GUN_SAFE_EDIT_PATH: `/shipments/:shipmentId/gun-safe/:gunSafeId`,
