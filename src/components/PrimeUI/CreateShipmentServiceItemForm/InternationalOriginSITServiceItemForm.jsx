...
const InternationalOriginSITServiceItemForm = ({ shipment, submission, handleCancel }) => {
  const initialValues = {
  ...
  return (
    <Formik initialValues={initialValues} validationSchema={originSITValidationSchema} onSubmit={onSubmit}>
      {({ isValid, isSubmitting, handleSubmit, ...formikProps }) => {
        return (
          <Form data-testid="internationalOriginSITServiceItemForm" className={formStyles.form}>
