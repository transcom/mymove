...
describe('InternationalOriginSITServiceItemForm component', () => {
  it.each([
    ['Reason', 'reason'],
    ...
    renderWithProviders(<InternationalOriginSITServiceItemForm shipment={shipment} submission={jest.fn()} />);
