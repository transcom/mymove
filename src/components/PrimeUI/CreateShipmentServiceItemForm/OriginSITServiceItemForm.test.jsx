...
describe('OriginSITServiceItemForm component', () => {
  ...
  //   render(<OriginSITServiceItemForm shipment={shipment} submission={submissionMock} />);
  ...
  // it('submits values when create service item button is clicked for international origin SIT', async () => {
  //   const shipment = approvedMoveTaskOrder.moveTaskOrder.mtoShipments[0];
  //   const submissionMock = jest.fn();

  //   render(<OriginSITServiceItemForm shipment={shipment} submission={submissionMock} isDomestic={false} />);
