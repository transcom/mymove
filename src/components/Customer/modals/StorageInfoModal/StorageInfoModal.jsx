...
export const StorageInfoModal = ({ closeModal, enableNTS, enableNTSR }) => (
  <Modal onClose={closeModal}>
    ...
    {enableNTS && (
      <>
        ...
        <p>
          Put some or all of your things into storage as part of one move, and get it out of storage on a future move.
          Your move counselor can verify whether or not you qualify to put things into long-term storage on this move.
        </p>
        <ul>
        ...
        <p>
          NTS (short for “non-temp storage”) lasts 6 months or longer. Do not count on easy access to things in storage.
          You can retrieve them during a future move.
        </p>
      </>
    )}
    {enableNTSR && (
      <>
        ...
        <p>
          Retrieval of things you placed into long-term storage (NTS) during an earlier move. If you don’t have things
          in storage, you don’t need to request an NTS-release.
        </p>
