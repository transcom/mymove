...
import { NtsShipmentShape, WizardPageShape } from 'types/customerShapes';
...
class NTSDetailsForm extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Formik
        ...
        validateOnBlur
        validateOnChange
        validationSchema={NTSDetailsFormSchema}
      >
...
export { NTSDetailsForm as NTSDetailsFormComponent };
export default connect(mapStateToProps, mapDispatchToProps)(NTSDetailsForm);
