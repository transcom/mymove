...
import styles from './CancelMoveModal.module.scss';
...
function CancelMoveModal({ onClose, onSubmit, initialRemarks, initialSelection }) {
  return (
    <div>
      <Overlay />
      <ModalContainer>
        <Modal className={styles.CancelMoveModal}>
