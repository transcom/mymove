...
describe('RequestShipmentCancellationModal', () => {
  it('renders the component', () => {
    const wrapper = mount(<RequestShipmentCancellationModal onSubmit={jest.fn()} onClose={jest.fn()} />);
  ...
  it('closes the modal when close icon is clicked', () => {
    ...
    const wrapper = mount(<RequestShipmentCancellationModal onSubmit={jest.fn()} onClose={onClose} />);
  ...
  it('calls the submit function when submit putton is clicked', async () => {
    ...
    const wrapper = mount(<RequestShipmentCancellationModal onSubmit={onSubmit} onClose={jest.fn()} />);
