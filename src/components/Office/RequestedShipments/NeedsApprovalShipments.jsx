...
const NeedsApprovalShipments = ({ mtoShipments, ordersInfo, mtoServiceItems, moveCode, displayDestinationType }) => {
  const ordersLOA = {
      ...
      <div className={shipmentCardsStyles.shipmentCards}>
        {mtoShipments &&
          mtoShipments.map((shipment) => {
            const reviewUrl = generatePath(tooRoutes.SHIPMENT_REVIEW_PATH, {
              moveCode,
...
NeedsApprovalShipments.propTypes = {
...
NeedsApprovalShipments.defaultProps = {
  mtoServiceItems: [],
  displayDestinationType: false,
};

export default NeedsApprovalShipments;
