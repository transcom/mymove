...
import StickyOfficeHeader from './StickyOfficeHeader';
...
const displayChangeRoleMultiRole = true;
const displayChangeRole = false;
...
describe('StickyCustomerLoggedInHeader', () => {
  it('renders the customer logged in header', () => {
    render(
      <MockProviders>
        <StickyOfficeHeader displayChangeRole={displayChangeRoleMultiRole} />
      </MockProviders>,
    );
