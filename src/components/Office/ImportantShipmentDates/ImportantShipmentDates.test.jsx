...
describe('ImportantShipmentDates', () => {
  ...
  it('should render the shipment dates we pass in', () => {
    ...
    expect(wrapper.find('td').at(3).text()).toEqual(requestedDeliveryDate);
    expect(wrapper.find('td').at(4).text()).toEqual(scheduledDeliveryDate);
    expect(wrapper.find('td').at(5).text()).toEqual(actualDeliveryDate);
  });
