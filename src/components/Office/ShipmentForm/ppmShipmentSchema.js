...
function closeoutOfficeSchema(isArmyOrAirforce, isAdvancePage) {
  if (isArmyOrAirforce && !isAdvancePage) {
...
const ppmShipmentSchema = ({
  ...
  const formSchema = Yup.object().shape({
    ...
    closeoutOffice: closeoutOfficeSchema(isArmyOrAirforce, isAdvancePage),
