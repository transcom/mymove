...
const AboutForm = ({ mtoShipment, onBack, onSubmit, isSubmitted, appName }) => {
  ...
  const initialValues = {
    ...
    [formFieldsName]: {
      ...
      countryID: mtoShipment?.ppmShipment?.w2Address?.country.id || '',
      country: {
        id: mtoShipment?.ppmShipment?.w2Address?.country.id || '',
        name: mtoShipment?.ppmShipment?.w2Address?.country?.name || '',
        code: mtoShipment?.ppmShipment?.w2Address?.country?.code || '',
      },
    },
  };
