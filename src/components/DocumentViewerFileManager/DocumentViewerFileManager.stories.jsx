...
OrdersDocument.args = {
  ...
  files: [{ id: 'file-1', name: 'File 1', filename: 'file1.pdf', bytes: 1024, createdAt: '2024-06-10T12:59:30.000Z' }],
...
AmendedOrdersDocument.args = {
  orderId: 'order-id',
  documentId: 'document-id',
  files: [{ id: 'file-2', name: 'File 2', filename: 'file2.pdf', bytes: 2048, createdAt: '2024-06-10T12:59:30.000Z' }],
...
SupportingDocuments.args = {
  ...
  documentId: 'document-id',
  files: [
    { id: 'file-3', name: 'File 3', filename: 'file3.jpg', bytes: 512, createdAt: '2024-06-10T12:59:30.000Z' },
    { id: 'file-4', name: 'File 4', filename: 'file4.png', bytes: 1024, createdAt: '2024-06-10T12:59:30.000Z' },
  ],
