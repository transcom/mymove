...
describe('OktaNeedsLoggedOutBanner component', () => {
  it('renders without crashing', () => {
    ...
    expect(oktaLogoutBannerElement).toHaveTextContent(
      "ou can access your Okta dashboard by following this link. In the top-right corner, you can click the drop down where it displays your name and select 'Sign Out'. Once you sign out of Okta, you should be able to sign into MilMove.If you have issues logging in or authenticating with Okta, please refer to our troubleshooting page",
    );
