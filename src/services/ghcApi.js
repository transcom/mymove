...
export async function getBulkAssignmentPaymentRequestData(queueType) {
  return makeGHCRequest('queues.getBulkAssignmentPaymentRequestData', { queueType }, { normalize: false });
}
