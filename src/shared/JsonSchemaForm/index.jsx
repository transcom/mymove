...
export const recursivelyValidateRequiredFields = (values, spec) => {
    ...
    spec.required.forEach((requiredFieldName) => {
      if (values[requiredFieldName] === undefined || values[requiredFieldName] === '') {
        ...
        if (schemaForKey) {
          ...
          milmoveLogger.error('The schema should have all required fields in it.');
        }
      }
    });
  }
  ...
  Object.keys(values).forEach(function (key) {
    ...
    if (schemaForKey) {
      ...
      milmoveLogger.error(`The schema should have fields for all present values. Missing ${key}`);
    }
  });
