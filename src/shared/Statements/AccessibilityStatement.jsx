  ...
  return (
    <div className="usa-grid">
      <div className="usa-width-two-thirds statement-content">
        ...
        <p>
          If your issue involves log in access, password recovery, or other
          technical issues, contact the administrator for the website in
          question, please report it to your local Personal Property Office
          (PPPO).
        </p>
        <p>
          The U.S. Department of Defense is committed to making its electronic
          and information technologies accessible to individuals with
          disabilities in accordance with{' '}
          <a href="https://www.access-board.gov/the-board/laws/rehabilitation-act-of-1973#508%20">
        ...
        <p>
          ...
          content on a particular website, please use the{' '}
          <a href="http://dodcio.defense.gov/DoDSection508/Section508Form.aspx">
        ...
        <p>
          ...
          <a href="http://dodcio.defense.gov/DoDSection508.aspx">
            {' '}
