...
import { StorageInTransitTspEditForm } from './StorageInTransitTspEditForm';
...
describe('StorageInTransitTspEditForm tests', () => {
  describe('Empty form', () => {
    let wrapper;
    store = mockStore({});
    wrapper = mount(
    ...
    it('renders without crashing', () => {
      expect(wrapper.find('.storage-in-transit-tsp-edit-form').length).toEqual(1);
    });
  });
});
