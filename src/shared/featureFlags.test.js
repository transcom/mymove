...
describe('feature flags', () => {
  it('detects the environment correctly', () => {
    ...
    expect(detectEnvironment('production', 'tsp.move.mil')).toEqual('production');
    ...
    expect(detectEnvironment('production', 'tsp.staging.move.mil')).toEqual('staging');
    ...
    expect(detectEnvironment('production', 'tsp.experimental.move.mil')).toEqual('experimental');
    ...
    expect(detectEnvironment('production', 'tsplocal')).toEqual('development');
