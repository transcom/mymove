    ...
    describe('given a resource', () => {
      ...
      describe('when generateAsyncReducer is called', () => {
        ...
        it('random', () => {
          ...
          expect(newstate).toEqual({ isLoading: false, hasErrored: false });
        });
        it('start', () => {
          const initialState = {};
          Object.freeze(initialState);
        ...
        it('failure', () => {
          const initialState = {};
          Object.freeze(initialState);
          const newstate = reducer(initialState, actions.error('my payload'));
          expect(newstate).toEqual({ isLoading: false, hasErrored: true });
        });
      });
    });
  });
