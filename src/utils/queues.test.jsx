// import {
//   formatOfficeUser,
//   formatAvailableOfficeUsers,
//   formatAvailableOfficeUsersForRow,
//   isSelectEnabled,
// } from './queues';
...
// const assignedCounselingOfficeID = '858685';
// const unassignedCounselingOfficeID = '012808';
...
//         },
//         originGBLOC: 'LKNQ',
//         counselingOfficeID: assignedCounselingOfficeID,
//         assignedTo: {
//           officeUserId: '1234',
//           firstname: 'John',
//           lastname: 'Doe',
...
//   describe('non-supervisor', () => {
//     const isSupervisor = false;
//     it('should return false if move is already assigned', () => {
//       const assignedMove = needsCounselingMoves.queueResult.data[0];
//       const isDropdownEnabled = isSelectEnabled(assignedMove, assignedCounselingOfficeID, isSupervisor);

//       expect(isDropdownEnabled).toBe(false);
//     });
//     it('should return true if move is not assigned', () => {
//       const unassignedMove = needsCounselingMoves.queueResult.data[3];
//       const isDropdownEnabled = isSelectEnabled(unassignedMove, assignedCounselingOfficeID, isSupervisor);

//       expect(isDropdownEnabled).toBe(true);
//     });
//   });

//   describe('supervisor', () => {
//     const isSupervisor = true;
//     it('should return false if move is outside their transporation office and assigned', () => {
//       const assignedMove = needsCounselingMoves.queueResult.data[0];
//       const isDropdownEnabled = isSelectEnabled(assignedMove, unassignedCounselingOfficeID, isSupervisor);

//       expect(isDropdownEnabled).toBe(false);
//     });
//     it('should return true if move is not assigned', () => {
//       const unassignedMove = needsCounselingMoves.queueResult.data[3];
//       const isDropdownEnabled = isSelectEnabled(unassignedMove, unassignedCounselingOfficeID, isSupervisor);
