...
import shipmentEvaluationReportStyles from '../ShipmentEvaluationReport/ShipmentEvaluationReport.module.scss';
...
const CounselingEvaluationReport = ({ customerInfo, orders }) => {
...
CounselingEvaluationReport.propTypes = {
  customerInfo: CustomerShape.isRequired,
  orders: OrdersShape.isRequired,
};

export default CounselingEvaluationReport;
