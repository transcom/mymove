...
const PrimeUIUpdateInternationalOriginSITForm = ({ initialValues, onSubmit, serviceItem }) => {
        ...
        <Form className={classnames(formStyles.form)}>
          <FormGroup>
            <div className={styles.Sit}>
              <h2 className={styles.sitHeader}>Update International Origin SIT Service Item</h2>
...
export default PrimeUIUpdateInternationalOriginSITForm;
