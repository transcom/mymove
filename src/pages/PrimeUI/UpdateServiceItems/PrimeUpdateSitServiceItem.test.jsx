...
describe('PrimeUIUpdateSitServiceItems page', () => {
  ...
  it('renders the destination sit service item form - international', async () => {
    const routingParams = {
      moveCodeOrID: 'bf2fc98f-3cb5-40a0-a125-4c222096c35b',
      mtoServiceItemId: '45fe9475-d592-48f5-896a-45d4d6eb7e76',
    };
    ...
    expect(
      screen.getByRole('heading', { name: 'Update International Destination SIT Service Item', level: 2 }),
    ).toBeInTheDocument();
    expect(screen.getByRole('textbox', { name: 'SIT Departure Date' })).toBeInTheDocument();
    expect(screen.getByRole('textbox', { name: 'SIT Requested Delivery' })).toBeInTheDocument();
    expect(screen.getByRole('textbox', { name: 'SIT Customer Contacted' })).toBeInTheDocument();
  ...
  it('renders the origin sit service item form - international', async () => {
    const routingParams = {
      moveCodeOrID: 'bf2fc98f-3cb5-40a0-a125-4c222096c35b',
      mtoServiceItemId: '45fe9475-d592-48f5-896a-45d4d6eb7e76',
    };
    ...
    expect(
      screen.getByRole('heading', { name: 'Update International Origin SIT Service Item', level: 2 }),
    ).toBeInTheDocument();
    expect(screen.getByRole('textbox', { name: 'SIT Departure Date' })).toBeInTheDocument();
    expect(screen.getByRole('textbox', { name: 'SIT Requested Delivery' })).toBeInTheDocument();
    expect(screen.getByRole('textbox', { name: 'SIT Customer Contacted' })).toBeInTheDocument();
