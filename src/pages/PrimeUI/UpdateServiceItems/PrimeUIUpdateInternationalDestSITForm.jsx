...
const PrimeUIUpdateInternationalDestSITForm = ({ initialValues, onSubmit, serviceItem }) => {
        ...
        <Form className={classnames(formStyles.form)}>
          <FormGroup>
            <div className={styles.Sit}>
              <h2 className={styles.sitHeader}>Update International Destination SIT Service Item</h2>
              <SectionWrapper className={formStyles.formSection}>
                <div className={styles.sitHeader}>
                  Here you can update specific fields for an international destination SIT service item. <br />
