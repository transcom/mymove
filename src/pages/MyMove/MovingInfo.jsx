...
export class MovingInfo extends Component {
  ...
  render() {
    const { entitlementWeight } = this.props;
    return (
      <>
        ...
        <SectionWrapper>
          <CardGroup>
            ...
            <MilmoveCard>
              ...
              <CardBody>
                ...
                <p>
                  ...
                  example. But multiple shipments make it easier to go over weight and end up paying for part of your
                  move yourself.
                </p>
              </CardBody>
            </MilmoveCard>
            <MilmoveCard>
              ...
              <CardBody>
                <p>
                  A session with a move counselor is free. Counselors have a lot of experience with military moves and
                  can steer you through complicated situations.
                </p>
