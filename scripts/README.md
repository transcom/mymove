...
| `ds_for_gbloc`                  | Helper script to find duty stations with the same GBLOC as the given transportation office        |
...
| `to_for_gbloc`                  | Helper script to find transportation offices with the same GBLOC as the given duty station        |
