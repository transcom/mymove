...
test.describe('Prime simulator user', () => {
  ...
  test('is able to update estimated weight without updating actual weight', async ({ page, officePage }) => {
    const move = await officePage.testHarness.buildPrimeSimulatorMoveNeedsShipmentUpdate();
  ...
  test('is able to update actual weight without updating estimated weight', async ({ page, officePage }) => {
    const move = await officePage.testHarness.buildPrimeSimulatorMoveNeedsShipmentUpdate();
