...
## Update the table `tariff400ng_items`
...
## Add the new and/or updated item to the database table (`tariff400ng_items`)
...
This basically overkill since there was only really 1 column was truly used the value for.
