...
# Generate clients
./bin/swagger generate client -q -f swagger/api.yaml -t "${gendir}" --model-package apimessages --server-package restapi --api-package apioperations --client-package apiclient -A mymove
